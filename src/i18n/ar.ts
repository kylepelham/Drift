...
export const drift = {
  ...
  "drift.preview.mode.all": "الكل",
  "drift.preview.mode.none": "لا شيء",
  "drift.preview.mode.custom": "مخصص",
  "drift.preview.type.markdown": "ملفات Markdown",
  "drift.preview.type.pdf": "مستندات PDF",
  "drift.preview.type.image": "الصور",
  "drift.preview.type.text": "النصوص والشيفرات",
  "drift.preview.type.table": "الجداول (CSV/TSV)",
  "drift.preview.type.audio": "الصوت",
  "drift.preview.type.video": "الفيديو",
  "drift.preview.title": "معاينة الملف",
  "drift.preview.htmlRendered": "معاينة",
  "drift.preview.htmlSource": "مصدر HTML",
  "drift.preview.htmlStatic": "معاينة ثابتة. البرامج النصية والروابط والموارد الخارجية معطلة.",
  "drift.preview.loading": "جارٍ تحميل المعاينة...",
  "drift.preview.error": "تعذر تحميل المعاينة.",
  "drift.preview.openEditor": "فتح في المحرر",
  "drift.preview.retry": "إعادة المحاولة",
  "drift.preview.previous": "الصفحة السابقة",
  "drift.preview.next": "الصفحة التالية",
  "drift.preview.page": "الصفحة {{page}} من {{pages}}",
  "drift.preview.zoomIn": "تكبير",
  "drift.preview.zoomOut": "تصغير",
  "drift.preview.unsupported": "لا يمكن معاينة هذا النوع من الملفات.",
  "drift.preview.tooLarge": "هذا الملف كبير جدًا للمعاينة.",
  "drift.preview.unavailable": "معاينة الملف غير متاحة.",
  ...
  "drift.settings.shellTimeout.preset15": "15 دقيقة",
  "drift.settings.shellTimeout.preset30": "30 دقيقة",
  "drift.settings.shellTimeout.custom": "مخصص",
  "drift.settings.shellTimeout.customMinutes": "دقائق مخصصة",
  "drift.settings.shellTimeout.customDescription": "أدخل عددًا صحيحًا من 1 إلى 1,440 دقيقة.",
  "drift.settings.shellTimeout.invalid": "أدخل عددًا صحيحًا من 1 إلى 1,440.",
  "drift.shell.timeout.limit": "الحد {{duration}}",
  "drift.shell.timeout.expired": "انتهت المهلة بعد {{duration}}",
  "drift.agent.build": "بناء",
  "drift.agent.plan": "تخطيط",
  "drift.agent.general": "عام",
  ...
  "drift.settings.summaries.collapsible.description": "اطوِ ملخصات ضغط المحرك خلف فاصل قابل للتوسيع.",
  "drift.settings.summaries.collapsed.title": "طي الملخصات افتراضيًا",
  "drift.settings.summaries.collapsed.description": "ابدأ وملخصات الضغط مطوية.",
  "drift.settings.customPalette": "لوحة ألوان مخصصة",
  "drift.settings.typography": "الخطوط",
  "drift.settings.customCss": "CSS مخصص",
  "drift.settings.customCss.description": "يُطبّق محليًا بعد أنماط Drift المضمنة. الحد الأقصى 20 كيلوبايت.",
  "drift.sidebar.workspaces": "مساحات العمل",
  "drift.sidebar.archived": "العناصر المؤرشفة",
  "drift.sidebar.addWorkspace": "إضافة مساحة عمل",
  "drift.sidebar.empty": "أضف مساحة عمل للبدء.",
  "drift.sidebar.resize": "تغيير حجم الشريط الجانبي",
  "drift.workspace.showThreads": "إظهار المحادثات",
  ...
  "drift.composer.connecting": "جارٍ الاتصال بالمحرك...",
  "drift.composer.thinkingLevel": "مستوى التفكير",
  "drift.permissions.autoGlobal": "قبول الأذونات تلقائيًا بشكل عام",
  "drift.permissions.autoThread": "قبول الأذونات تلقائيًا لهذه المحادثة",
  "drift.prompt.steer": "توجيه",
  "drift.titlebar.minimize": "تصغير",
  ...
  "drift.about.starting": "(جارٍ البدء...)",
  "drift.about.group.build": "الإصدار",
  "drift.about.group.links": "روابط",
  ...
  "drift.about.updates.available": "متاحة",
  "drift.about.updates.unavailable": "بناء محلي",
  "drift.about.row.website.title": "الموقع",
  "drift.about.row.website.description": "التنزيلات وملاحظات الإصدار.",
  "drift.about.credits.engine": "يعمل Drift على OpenCode. المحرك هو من يقوم بالجزء الأصعب هنا، وهذا التطبيق موجود فقط بفضل ذلك العمل المذهل. احترام حقيقي لمطوري OpenCode ولكل من يساهم فيه.",
  "drift.archive.deletesInDays": "يُحذف خلال {{days}}d",
  ...
  "drift.attachment.image": "صورة",
  "drift.attachment.viewImage": "عرض الصورة",
  ...
  "drift.attachment.pages": "{{count}} صفحة",
  "drift.attachment.processing": "جارٍ القراءة...",
  "drift.attachment.table": "{{rows}} صفوف × {{columns}} أعمدة",
  "drift.chat.empty.noWorkspace": "أضف مساحة عمل أو اختر واحدة من اليسار للبدء.",
  "drift.chat.empty.promptHint": "ابدأ الكتابة أدناه. Enter للإرسال وShift+Enter لسطر جديد.",
  "drift.chat.empty.threadHint": "المحادثات على اليسار. لا علامات تبويب. أبدًا.",
  "drift.chat.retry.inSeconds": "إعادة المحاولة خلال {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - المحاولة رقم {{attempt}}",
  "drift.chat.retry.now": "جارٍ إعادة المحاولة",
  "drift.chat.retry.providerRejected": "لم يقبل الموفر الطلب",
  "drift.chat.thinking": "جارٍ التفكير",
  "drift.color.accent": "اللون المميز",
  "drift.color.background": "الخلفية",
  "drift.color.surface": "السطح",
  "drift.color.text": "النص",
  "drift.composer.anotherThread": "محادثة أخرى",
  "drift.composer.dropFiles": "أفلت الملفات لإرفاقها",
  "drift.composer.fileReadFailed": "تعذرت قراءة {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} ليس نص UTF-8 صالحًا",
  "drift.composer.fileTooLarge": "يتجاوز {{filename}} حد {{limit}} لملفات {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} أرشيف أو ملف ثنائي غير مدعوم",
  "drift.composer.folderUnsupported": "لا يمكن إرفاق المجلدات؛ أفلت ملفات فردية بدلاً من ذلك",
  "drift.composer.modelUnsupported": "لا يقبل {{model}} مرفقات {{kind}} ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} إدخالات",
  "drift.count.file.one": "{{count}} ملف",
  "drift.count.file.other": "{{count}} ملفات",
  "drift.count.line.one": "{{count}} سطر",
  "drift.count.line.other": "{{count}} أسطر",
  "drift.count.match.one": "{{count}} تطابق",
  "drift.count.match.other": "{{count}} تطابقات",
  "drift.count.result.one": "{{count}} نتيجة",
  "drift.count.result.other": "{{count}} نتائج",
  "drift.count.tool.one": "{{count}} أداة",
  "drift.count.tool.other": "{{count}} أدوات",
  "drift.debug.context": "السياق",
  "drift.file.created": "تم الإنشاء",
  "drift.file.deleted": "تم الحذف",
  "drift.file.moved": "تم النقل",
  ...
  "drift.message.copy": "نسخ الرسالة",
  "drift.message.copyResponse": "نسخ الاستجابة",
  ...
  "drift.provider.finishInBrowser": "أكمل تسجيل الدخول عبر المتصفح.",
  "drift.provider.savedUnavailable": "حُفظت بيانات الاعتماد، لكن {{provider}} لم يصبح متاحًا.",
  "drift.provider.signInStartFailed": "تعذر بدء عملية تسجيل الدخول.",
  "drift.provider.signInStartFailedFor": "تعذر بدء عملية تسجيل الدخول إلى {{provider}}.",
  "drift.provider.signInWith": "تسجيل الدخول باستخدام {{method}}",
  "drift.question.custom": "اكتب إجابتك الخاصة",
  "drift.question.answered": "تمت الإجابة",
  "drift.question.unanswered": "لا إجابة",
  "drift.question.answerLater": "الإجابة لاحقًا",
  "drift.question.answerNow": "الإجابة الآن",
  "drift.question.asyncHint": "يمكن متابعة العمل الذي لا يعتمد على إجابتك بينما تتخذ قرارك.",
  "drift.question.blocking": "بانتظار الإجابة",
  "drift.question.pending": "الطلبات المعلقة: {{count}}",
  "drift.question.sendFailed": "تعذر إرسال ردك. لا تزال إجاباتك هنا. حاول الإرسال مجددًا.",
  "drift.question.sending": "جارٍ الإرسال...",
  "drift.question.customHint": "أضف إجابة غير مدرجة أعلاه",
  "drift.question.customPlaceholder": "اكتب إجابتك الخاصة...",
  "drift.question.number": "السؤال {{number}}",
  "drift.question.selectMultiple": "حدد كل الإجابات المنطبقة",
  "drift.question.selectOne": "حدد إجابة واحدة",
  "drift.reasoning.thinking": "جارٍ التفكير",
  "drift.reasoning.thought": "فكرة",
  "drift.reasoning.level.none": "بلا",
  "drift.reasoning.level.minimal": "أدنى",
  "drift.reasoning.level.low": "منخفض",
  "drift.reasoning.level.medium": "متوسط",
  "drift.reasoning.level.high": "مرتفع",
  "drift.reasoning.level.xhigh": "مرتفع جدًا",
  "drift.reasoning.level.max": "أقصى",
  "drift.settings.customPalette.colorDescription": "عيّن اللون {{color}}.",
  "drift.settings.customPalette.hexValue": "قيمة {{color}} السداسية",
  "drift.settings.providers.notConnected": "غير متصل",
  ...
  "drift.shortcuts.zoomOut": "تصغير",
  "drift.shortcuts.zoomReset": "إعادة تعيين التكبير",
  "drift.sidebar.moveSessionFailed": "تعذر نقل الجلسة",
  "drift.sidebar.moveWorkspaceFailed": "تعذر نقل مساحة العمل",
  "drift.sidebar.movingSession": "جارٍ نقل الجلسة إلى {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "جارٍ نقل جلسات {{workspace}}...",
  "drift.sidebar.offline": "غير متصل",
  "drift.sidebar.pathAlreadySaved": "المسار {{path}} محفوظ بالفعل باسم {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "تعذر حفظ مسار مساحة العمل الجديد: {{error}}",
  "drift.sidebar.workspaceMovePartial": "تم تطبيق نقل مساحة العمل جزئيًا فقط: {{error}}",
  "drift.slash.mcp": "إدارة خوادم MCP",
  "drift.slash.workspaceCommand": "أمر مساحة العمل",
  "drift.sound.group.alerts": "تنبيهات",
  "drift.sound.group.failure": "فشل",
  "drift.sound.group.information": "معلومات",
  "drift.sound.group.mechanical": "ميكانيكية",
  "drift.sound.group.success": "نجاح",
  "drift.status.waitingForPermission": "في انتظار الإذن",
  "drift.theme.aubergine": "Drift باذنجاني",
  "drift.theme.custom": "مخصص",
  "drift.theme.dark": "Drift داكن",
  "drift.theme.forest": "Drift غابة",
  "drift.theme.graphite": "Drift غرافيت",
  "drift.theme.light": "Drift فاتح",
  "drift.theme.midnight": "Drift منتصف الليل",
  "drift.theme.paper": "Drift ورقي",
  "drift.theme.slate": "Drift أردوازي",
  "drift.thread.backToParent": "العودة إلى المحادثة التي انطلقت منها هذه المحادثة",
  "drift.thread.copyShareLink": "نسخ رابط المشاركة: {{url}}",
  "drift.thread.move": "نقل",
  "drift.thread.moveToWorkspace": "نقل إلى مساحة عمل",
  "drift.thread.noOtherWorkspaces": "لا توجد مساحات عمل أخرى",
  "drift.thread.openSpawned": "فتح المحادثة المنبثقة",
  "drift.thread.renameHint": "انقر نقرًا مزدوجًا لإعادة التسمية",
  "drift.thread.shared": "مُشارَكة",
  "drift.thread.waitingForAnswer": "في انتظار إجابة",
  "drift.thread.waitingForPermission": "في انتظار الإذن",
  "drift.thread.working": "جارٍ العمل",
  "drift.tool.called": "تم الاستدعاء",
  "drift.tool.fetch": "جلب",
  "drift.tool.asyncQuestion": "سؤال غير متزامن",
  "drift.tool.spawn": "إنشاء",
  "drift.tool.subtask": "مهمة فرعية",
  "drift.tool.task": "مهمة",
  "drift.voice.input.description": "اختر الميكروفون المستخدم لتسجيلات الإملاء الجديدة.",
  "drift.voice.input.missing": "الميكروفون المحفوظ غير متاح. يُستخدم افتراضي النظام حتى يُعاد توصيله.",
  "drift.voice.input.systemDefault": "افتراضي النظام",
  "drift.voice.input.title": "جهاز الإدخال",
  "drift.voice.input.unnamed": "الميكروفون {{index}}",
  "drift.workspace.changeImage": "تغيير الصورة...",
  "drift.workspace.confirmRemove": "انقر مرة أخرى للتأكيد",
  "drift.workspace.move": "نقل...",
  "drift.workspace.remove": "إزالة",
  "drift.workspace.removeHint": "تُحفظ المحادثات لمدة 7 أيام؛ أعد إضافة المجلد نفسه لاستعادتها.",
  "drift.workspace.useInitials": "استخدام الأحرف الأولى",
}
