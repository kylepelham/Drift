...
export const drift = {
  ...
  "drift.about.row.website.description": "التنزيلات وملاحظات الإصدار وقنديل البحر الذي ألهم هذا.",
  "drift.about.credits.engine": "يعمل Drift على OpenCode. المحرك هو من يقوم بالجزء الأصعب هنا، وهذا التطبيق موجود فقط لأن ذلك العمل جيد بما يكفي للبناء عليه. احترام حقيقي لمطوري OpenCode ولكل من يساهم فيه.",
  "drift.about.credits.ui": "Drift ليس انتقادًا للمحرك، بل مجرد اختلاف في الذوق: أنا فقط لا أحب الواجهة الجديدة، لذلك يحافظ Drift على غلاف أهدأ وأكثر كثافة حول المحرك نفسه.",
  ...
  "drift.composer.fileTooLarge": "يتجاوز {{filename}} حجم 10 MB",
