export const dict = {
  "drift.mcp.loading": "Carregando servidores MCP...",
  "drift.mcp.refreshing": "Atualizando servidores MCP...",
  "drift.mcp.retry": "Tentar novamente",
...
export const drift = {
  ...
  "drift.preview.mode.all": "Todos",
  "drift.preview.mode.none": "Nenhum",
  "drift.preview.mode.custom": "Personalizado",
  "drift.preview.type.markdown": "Arquivos Markdown",
  "drift.preview.type.pdf": "Documentos PDF",
  "drift.preview.type.image": "Imagens",
  "drift.preview.type.text": "Texto e código",
  "drift.preview.type.table": "Tabelas (CSV/TSV)",
  "drift.preview.type.audio": "Áudio",
  "drift.preview.type.video": "Vídeo",
  "drift.preview.title": "Pré-visualização do arquivo",
  "drift.preview.htmlRendered": "Pré-visualização",
  "drift.preview.htmlSource": "Código HTML",
  "drift.preview.htmlStatic": "Pré-visualização estática. Scripts, links e recursos externos estão desativados.",
  "drift.preview.loading": "Carregando pré-visualização...",
  "drift.preview.error": "Não foi possível carregar a pré-visualização.",
  "drift.preview.openEditor": "Abrir no editor",
  "drift.preview.retry": "Tentar novamente",
  "drift.preview.previous": "Página anterior",
  "drift.preview.next": "Próxima página",
  "drift.preview.page": "Página {{page}} de {{pages}}",
  "drift.preview.zoomIn": "Ampliar",
  "drift.preview.zoomOut": "Reduzir",
  "drift.preview.unsupported": "Não é possível pré-visualizar este tipo de arquivo.",
  "drift.preview.tooLarge": "Este arquivo é grande demais para a pré-visualização.",
  "drift.preview.unavailable": "A pré-visualização do arquivo não está disponível.",
  ...
  "drift.settings.shellTimeout.preset15": "15 minutos",
  "drift.settings.shellTimeout.preset30": "30 minutos",
  "drift.settings.shellTimeout.custom": "Personalizado",
  "drift.settings.shellTimeout.customMinutes": "Minutos personalizados",
  "drift.settings.shellTimeout.customDescription": "Digite um número inteiro de 1 a 1.440 minutos.",
  "drift.settings.shellTimeout.invalid": "Digite um número inteiro de 1 a 1.440.",
  "drift.shell.timeout.limit": "Limite {{duration}}",
  "drift.shell.timeout.expired": "Tempo esgotado após {{duration}}",
  "drift.agent.build": "Construção",
  "drift.agent.plan": "Planejamento",
  "drift.agent.general": "Geral",
  ...
  "drift.settings.typography": "Tipografia",
  "drift.settings.customCss": "CSS personalizado",
  "drift.settings.customCss.description": "Aplicado localmente após os estilos integrados do Drift. Limite de 20 KB.",
  "drift.sidebar.workspaces": "Espaços de trabalho",
  "drift.sidebar.archived": "Itens arquivados",
  "drift.sidebar.addWorkspace": "Adicionar espaço de trabalho",
  "drift.sidebar.empty": "Adicione um espaço de trabalho para começar.",
  "drift.sidebar.resize": "Redimensionar barra lateral",
  "drift.workspace.showThreads": "Mostrar conversas",
  ...
  "drift.composer.connecting": "Conectando ao mecanismo...",
  "drift.composer.thinkingLevel": "Nível de raciocínio",
  "drift.permissions.autoGlobal": "Aceitando permissões automaticamente em todo o app",
  "drift.permissions.autoThread": "Aceitando permissões automaticamente nesta conversa",
  "drift.prompt.steer": "Orientar",
  "drift.titlebar.minimize": "Minimizar",
  ...
  "drift.about.group.build": "Compilação",
  ...
  "drift.about.row.website.description": "Downloads e notas de versão.",
  "drift.about.credits.engine": "O Drift funciona com o OpenCode. O motor faz a parte difícil aqui, e este aplicativo só existe graças a esse trabalho incrível. Respeito de verdade aos desenvolvedores do OpenCode e a todos que contribuem com ele.",
  "drift.archive.deletesInDays": "Exclusão em {{days}}d",
  ...
  "drift.attachment.image": "imagem",
  "drift.attachment.viewImage": "Ver imagem",
  ...
  "drift.attachment.pages": "{{count}} páginas",
  "drift.attachment.processing": "Lendo...",
  "drift.attachment.table": "{{rows}} linhas x {{columns}} colunas",
  "drift.chat.empty.noWorkspace": "Adicione ou selecione um espaço de trabalho à esquerda para começar.",
  "drift.chat.empty.promptHint": "Comece a digitar abaixo. Enter envia, Shift+Enter quebra a linha.",
  "drift.chat.empty.threadHint": "As conversas ficam à esquerda. Sem abas. Nunca.",
  "drift.chat.retry.inSeconds": "Nova tentativa em {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - tentativa nº {{attempt}}",
  "drift.chat.retry.now": "Tentando novamente",
  "drift.chat.retry.providerRejected": "O provedor não aceitou a solicitação",
  "drift.chat.thinking": "Pensando",
  "drift.color.accent": "Destaque",
  "drift.color.background": "Fundo",
  "drift.color.surface": "Superfície",
  "drift.color.text": "Texto",
  "drift.composer.anotherThread": "outra conversa",
  "drift.composer.dropFiles": "Solte arquivos para anexar",
  "drift.composer.fileReadFailed": "Não foi possível ler {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} não é um texto UTF-8 válido",
  "drift.composer.fileTooLarge": "{{filename}} excede o limite de {{limit}} para arquivos {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} é um arquivo compactado ou binário não suportado",
  "drift.composer.folderUnsupported": "Não é possível anexar pastas; solte arquivos individuais",
  "drift.composer.modelUnsupported": "{{model}} não aceita anexos {{kind}} ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} entradas",
  "drift.count.file.one": "{{count}} arquivo",
  "drift.count.file.other": "{{count}} arquivos",
  "drift.count.line.one": "{{count}} linha",
  "drift.count.line.other": "{{count}} linhas",
  "drift.count.match.one": "{{count}} correspondência",
  "drift.count.match.other": "{{count}} correspondências",
  "drift.count.result.one": "{{count}} resultado",
  "drift.count.result.other": "{{count}} resultados",
  "drift.count.tool.one": "{{count}} ferramenta",
  "drift.count.tool.other": "{{count}} ferramentas",
  "drift.debug.context": "Contexto",
  "drift.file.created": "Criado",
  "drift.file.deleted": "Excluído",
  "drift.file.moved": "Movido",
  ...
  "drift.mcp.authenticate": "Autenticar",
  "drift.mcp.description": "Servidores globais do Drift e as definições efetivas exatas informadas pelo espaço de trabalho ativo.",
  ...
  "drift.message.copy": "Copiar mensagem",
  "drift.message.copyResponse": "Copiar resposta",
  ...
  "drift.provider.finishInBrowser": "Conclua o login pelo navegador.",
  "drift.provider.savedUnavailable": "Credencial salva, mas {{provider}} não ficou disponível.",
  "drift.provider.signInStartFailed": "Não foi possível iniciar o fluxo de login.",
  "drift.provider.signInStartFailedFor": "Não foi possível iniciar o fluxo de login de {{provider}}.",
  "drift.provider.signInWith": "Entrar com {{method}}",
  ...
  "drift.question.answerLater": "Responder depois",
  ...
  "drift.question.number": "Pergunta {{number}}",
  "drift.question.selectMultiple": "Selecione todas as respostas aplicáveis",
  "drift.question.selectOne": "Selecione uma resposta",
  "drift.reasoning.thinking": "Pensando",
  "drift.reasoning.thought": "Raciocínio",
  "drift.reasoning.level.none": "Nenhum",
  "drift.reasoning.level.minimal": "Mínimo",
  "drift.reasoning.level.low": "Baixo",
  "drift.reasoning.level.medium": "Médio",
  "drift.reasoning.level.high": "Alto",
  "drift.reasoning.level.xhigh": "Muito alto",
  "drift.reasoning.level.max": "Máximo",
  "drift.settings.customPalette.colorDescription": "Defina a cor {{color}}.",
  "drift.settings.customPalette.hexValue": "Valor hexadecimal de {{color}}",
  "drift.settings.providers.notConnected": "Não conectado",
  ...
  "drift.shortcuts.zoomOut": "Diminuir zoom",
  "drift.shortcuts.zoomReset": "Redefinir zoom",
  "drift.sidebar.moveSessionFailed": "Não foi possível mover a sessão",
  "drift.sidebar.moveWorkspaceFailed": "Não foi possível mover o espaço de trabalho",
  "drift.sidebar.movingSession": "Movendo sessão para {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Movendo sessões de {{workspace}}...",
  "drift.sidebar.offline": "offline",
  "drift.sidebar.pathAlreadySaved": "{{path}} já está salvo como {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Não foi possível salvar o novo caminho do espaço de trabalho: {{error}}",
  "drift.sidebar.workspaceMovePartial": "A mudança do espaço de trabalho foi aplicada apenas parcialmente: {{error}}",
  "drift.slash.mcp": "Gerenciar servidores MCP",
  "drift.slash.workspaceCommand": "comando do espaço de trabalho",
  "drift.sound.group.alerts": "Alertas",
  "drift.sound.group.failure": "Falha",
  "drift.sound.group.information": "Informação",
  "drift.sound.group.mechanical": "Mecânicos",
  "drift.sound.group.success": "Sucesso",
  "drift.status.waitingForPermission": "Aguardando permissão",
  "drift.theme.aubergine": "Drift Berinjela",
  "drift.theme.custom": "Personalizado",
  "drift.theme.dark": "Drift Escuro",
  "drift.theme.forest": "Drift Floresta",
  "drift.theme.graphite": "Drift Grafite",
  "drift.theme.light": "Drift Claro",
  "drift.theme.midnight": "Drift Meia-noite",
  "drift.theme.paper": "Drift Papel",
  "drift.theme.slate": "Drift Ardósia",
  "drift.thread.backToParent": "Voltar à conversa da qual esta foi criada",
  "drift.thread.copyShareLink": "Copiar link de compartilhamento: {{url}}",
  "drift.thread.move": "Mover",
  "drift.thread.moveToWorkspace": "Mover para o espaço de trabalho",
  "drift.thread.noOtherWorkspaces": "Nenhum outro espaço de trabalho",
  "drift.thread.openSpawned": "Abrir conversa criada",
  "drift.thread.renameHint": "Clique duas vezes para renomear",
  "drift.thread.shared": "Compartilhada",
  "drift.thread.waitingForAnswer": "Aguardando uma resposta",
  "drift.thread.waitingForPermission": "Aguardando permissão",
  "drift.thread.working": "Trabalhando",
  "drift.tool.called": "Chamado",
  "drift.tool.fetch": "Buscar",
  "drift.tool.asyncQuestion": "Pergunta assíncrona",
  "drift.tool.spawn": "Criar",
  ...
  "drift.workspace.changeImage": "Alterar imagem...",
