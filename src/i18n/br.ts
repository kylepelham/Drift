...
export const drift = {
  ...
  "drift.about.updates.enabled": "Disponíveis",
  "drift.about.updates.disabled": "Compilação local",
  "drift.about.row.website.title": "Site",
  "drift.about.row.website.description": "Downloads, notas de versão e a água-viva que inspirou esta aqui.",
  "drift.about.credits.engine": "O Drift funciona com o OpenCode. O motor faz a parte difícil aqui, e este aplicativo só existe porque esse trabalho é bom o suficiente para servir de base. Respeito de verdade aos desenvolvedores do OpenCode e a todos que contribuem com ele.",
  "drift.about.credits.ui": "O Drift não é uma crítica ao motor, apenas uma diferença de gosto: eu simplesmente não gosto da nova interface, então o Drift mantém uma casca mais silenciosa e densa em torno do mesmo motor.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} excede 10 MB",
