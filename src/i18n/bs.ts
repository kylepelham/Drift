...
export const drift = {
  ...
  "drift.about.row.website.description": "Preuzimanja, napomene o izdanju i meduza koja je inspirisala ovu.",
  "drift.about.credits.engine": "Drift radi na OpenCodeu. Motor ovdje obavlja teži dio posla, a ova aplikacija postoji samo zato što je taj rad dovoljno dobar da se na njemu gradi. Iskreno poštovanje razvijačima OpenCodea i svima koji mu doprinose.",
  "drift.about.credits.ui": "Drift nije kritika motora, samo razlika u ukusu: jednostavno mi se ne dopada novi interfejs, pa Drift zadržava tiši i gušći okvir oko istog motora.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} je veća od 10 MB",
