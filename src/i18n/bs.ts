...
export const drift = {
  "drift.slash.keyboardHint": "Tab dopunjava. Enter potvrđuje.",
  ...
  "drift.preview.mode.all": "Sve",
  "drift.preview.mode.none": "Nijedna",
  "drift.preview.mode.custom": "Prilagođeno",
  "drift.preview.type.markdown": "Markdown datoteke",
  "drift.preview.type.pdf": "PDF dokumenti",
  "drift.preview.type.image": "Slike",
  "drift.preview.type.text": "Tekst i kod",
  "drift.preview.type.table": "Tabele (CSV/TSV)",
  "drift.preview.type.audio": "Zvuk",
  "drift.preview.type.video": "Video",
  "drift.preview.title": "Pregled datoteke",
  "drift.preview.htmlRendered": "Pregled",
  "drift.preview.htmlSource": "HTML kod",
  "drift.preview.htmlStatic": "Statički pregled. Skripte, linkovi i vanjski resursi su onemogućeni.",
  "drift.preview.loading": "Učitavanje pregleda...",
  "drift.preview.error": "Pregled nije moguće učitati.",
  "drift.preview.openEditor": "Otvori u uređivaču",
  "drift.preview.retry": "Pokušaj ponovo",
  "drift.preview.previous": "Prethodna stranica",
  "drift.preview.next": "Sljedeća stranica",
  "drift.preview.page": "Stranica {{page}} od {{pages}}",
  "drift.preview.zoomIn": "Povećaj",
  "drift.preview.zoomOut": "Smanji",
  "drift.preview.unsupported": "Ovu vrstu datoteke nije moguće pregledati.",
  "drift.preview.tooLarge": "Ova datoteka je prevelika za pregled.",
  "drift.preview.unavailable": "Pregled datoteke nije dostupan.",
  ...
  "drift.settings.shellTimeout.preset15": "15 minuta",
  "drift.settings.shellTimeout.preset30": "30 minuta",
  "drift.settings.shellTimeout.custom": "Prilagođeno",
  "drift.settings.shellTimeout.customMinutes": "Prilagođene minute",
  "drift.settings.shellTimeout.customDescription": "Unesite cijeli broj od 1 do 1.440 minuta.",
  "drift.settings.shellTimeout.invalid": "Unesite cijeli broj od 1 do 1.440.",
  "drift.shell.timeout.limit": "Ograničenje {{duration}}",
  "drift.shell.timeout.expired": "Vrijeme isteklo nakon {{duration}}",
  "drift.agent.build": "Izrada",
  "drift.agent.plan": "Planiranje",
  "drift.agent.general": "Općenito",
  ...
  "drift.settings.summaries.collapsed.title": "Sklopi sažetke prema zadanim postavkama",
  "drift.settings.summaries.collapsed.description": "Prikaži sažetke sažimanja početno sklopljene.",
  "drift.settings.customPalette": "Prilagođena paleta",
  "drift.settings.typography": "Tipografija",
  "drift.settings.customCss": "Prilagođeni CSS",
  "drift.settings.customCss.description": "Primjenjuje se lokalno nakon ugrađenih Drift stilova. Ograničeno na 20 KB.",
  "drift.sidebar.workspaces": "Radni prostori",
  "drift.sidebar.archived": "Arhivirane stavke",
  "drift.sidebar.addWorkspace": "Dodaj radni prostor",
  "drift.sidebar.empty": "Dodajte radni prostor za početak.",
  "drift.sidebar.resize": "Promijeni veličinu bočne trake",
  "drift.workspace.showThreads": "Prikaži razgovore",
  ...
  "drift.composer.connecting": "Povezivanje s mehanizmom...",
  "drift.composer.thinkingLevel": "Nivo razmišljanja",
  "drift.permissions.autoGlobal": "Automatsko prihvatanje dozvola globalno",
  "drift.permissions.autoThread": "Automatsko prihvatanje dozvola za ovaj razgovor",
  "drift.prompt.steer": "Usmjeri",
  "drift.titlebar.minimize": "Minimiziraj",
  ...
  "drift.about.starting": "(pokretanje...)",
  "drift.about.group.build": "Build",
  "drift.about.group.links": "Linkovi",
  ...
  "drift.about.updates.available": "Dostupne",
  "drift.about.updates.unavailable": "Lokalni build",
  "drift.about.row.website.title": "Web stranica",
  "drift.about.row.website.description": "Preuzimanja i napomene o izdanju.",
  "drift.about.credits.engine": "Drift radi na OpenCodeu. Motor ovdje obavlja teži dio posla, a ova aplikacija postoji samo zahvaljujući tom sjajnom radu. Iskreno poštovanje razvijačima OpenCodea i svima koji mu doprinose.",
  "drift.archive.deletesInDays": "Briše se za {{days}}d",
  ...
  "drift.attachment.image": "slika",
  "drift.attachment.viewImage": "Prikaži sliku",
  ...
  "drift.attachment.pages": "{{count}} stranica",
  "drift.attachment.processing": "Čitanje...",
  "drift.attachment.table": "{{rows}} redova x {{columns}} kolona",
  "drift.chat.empty.noWorkspace": "Dodajte ili odaberite radni prostor lijevo za početak.",
  "drift.chat.empty.promptHint": "Počnite pisati ispod. Enter šalje, Shift+Enter prelazi u novi red.",
  "drift.chat.empty.threadHint": "Razgovori su lijevo. Bez kartica. Nikad.",
  "drift.chat.retry.inSeconds": "Ponovni pokušaj za {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - pokušaj #{{attempt}}",
  "drift.chat.retry.now": "Ponovni pokušaj",
  "drift.chat.retry.providerRejected": "Provajder nije prihvatio zahtjev",
  "drift.chat.thinking": "Razmišljanje",
  "drift.color.accent": "Naglasak",
  "drift.color.background": "Pozadina",
  "drift.color.surface": "Površina",
  "drift.color.text": "Tekst",
  "drift.composer.anotherThread": "drugi razgovor",
  "drift.composer.dropFiles": "Otpustite datoteke da ih priložite",
  "drift.composer.fileReadFailed": "Nije moguće pročitati {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} nije ispravan UTF-8 tekst",
  "drift.composer.fileTooLarge": "{{filename}} prelazi ograničenje od {{limit}} za {{kind}} datoteke",
  "drift.composer.fileUnsupported": "{{filename}} je nepodržana arhiva ili binarna datoteka",
  "drift.composer.folderUnsupported": "Foldere nije moguće priložiti; umjesto toga otpustite pojedinačne datoteke",
  "drift.composer.modelUnsupported": "{{model}} ne prihvata {{kind}} priloge ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} stavki",
  "drift.count.file.one": "{{count}} datoteka",
  "drift.count.file.other": "{{count}} datoteka",
  "drift.count.line.one": "{{count}} linija",
  "drift.count.line.other": "{{count}} linija",
  "drift.count.match.one": "{{count}} podudaranje",
  "drift.count.match.other": "{{count}} podudaranja",
  "drift.count.result.one": "{{count}} rezultat",
  "drift.count.result.other": "{{count}} rezultata",
  "drift.count.tool.one": "{{count}} alat",
  "drift.count.tool.other": "{{count}} alata",
  "drift.debug.context": "Kontekst",
  "drift.file.created": "Kreirano",
  "drift.file.deleted": "Izbrisano",
  "drift.file.moved": "Premješteno",
  ...
  "drift.mcp.authenticate": "Autentifikuj",
  ...
  "drift.message.copy": "Kopiraj poruku",
  "drift.message.copyResponse": "Kopiraj odgovor",
  ...
  "drift.provider.finishInBrowser": "Dovršite prijavu putem preglednika.",
  "drift.provider.savedUnavailable": "Pristupni podaci su sačuvani, ali {{provider}} nije postao dostupan.",
  "drift.provider.signInStartFailed": "Nije moguće pokrenuti postupak prijave.",
  "drift.provider.signInStartFailedFor": "Nije moguće pokrenuti postupak prijave za {{provider}}.",
  "drift.provider.signInWith": "Prijavi se putem {{method}}",
  "drift.question.custom": "Unesite vlastiti odgovor",
  "drift.question.answered": "Odgovoreno",
  "drift.question.unanswered": "Nema odgovora",
  "drift.question.answerLater": "Odgovori kasnije",
  ...
  "drift.question.number": "Pitanje {{number}}",
  "drift.question.selectMultiple": "Odaberite sve odgovarajuće odgovore",
  "drift.question.selectOne": "Odaberite jedan odgovor",
  "drift.reasoning.thinking": "Razmišljanje",
  "drift.reasoning.thought": "Misao",
  "drift.reasoning.level.none": "Nema",
  "drift.reasoning.level.minimal": "Minimalno",
  "drift.reasoning.level.low": "Nisko",
  "drift.reasoning.level.medium": "Srednje",
  "drift.reasoning.level.high": "Visoko",
  "drift.reasoning.level.xhigh": "Vrlo visoko",
  "drift.reasoning.level.max": "Maksimalno",
  "drift.settings.customPalette.colorDescription": "Postavite boju {{color}}.",
  "drift.settings.customPalette.hexValue": "Heksadecimalna vrijednost boje {{color}}",
  "drift.settings.providers.notConnected": "Nije povezano",
  ...
  "drift.shortcuts.zoomOut": "Umanji",
  "drift.shortcuts.zoomReset": "Vrati zumiranje",
  "drift.sidebar.moveSessionFailed": "Nije moguće premjestiti sesiju",
  "drift.sidebar.moveWorkspaceFailed": "Nije moguće premjestiti radni prostor",
  "drift.sidebar.movingSession": "Premještanje sesije u {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Premještanje sesija iz {{workspace}}...",
  "drift.sidebar.offline": "van mreže",
  "drift.sidebar.pathAlreadySaved": "{{path}} je već sačuvana kao {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Nije moguće sačuvati novu putanju radnog prostora: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Premještanje radnog prostora samo je djelimično primijenjeno: {{error}}",
  "drift.slash.mcp": "Upravljaj MCP serverima",
  "drift.slash.workspaceCommand": "naredba radnog prostora",
  "drift.sound.group.alerts": "Upozorenja",
  "drift.sound.group.failure": "Neuspjeh",
  "drift.sound.group.information": "Informacije",
  "drift.sound.group.mechanical": "Mehanički",
  "drift.sound.group.success": "Uspjeh",
  "drift.status.waitingForPermission": "Čekanje na dozvolu",
  "drift.theme.aubergine": "Drift Patlidžan",
  "drift.theme.custom": "Prilagođeno",
  "drift.theme.dark": "Drift Tamna",
  "drift.theme.forest": "Drift Šuma",
  "drift.theme.graphite": "Drift Grafit",
  "drift.theme.light": "Drift Svijetla",
  "drift.theme.midnight": "Drift Ponoć",
  "drift.theme.paper": "Drift Papir",
  "drift.theme.slate": "Drift Škriljevac",
  "drift.thread.backToParent": "Nazad na razgovor iz kojeg je ovaj pokrenut",
  "drift.thread.copyShareLink": "Kopiraj link za dijeljenje: {{url}}",
  "drift.thread.move": "Premjesti",
  "drift.thread.moveToWorkspace": "Premjesti u radni prostor",
  "drift.thread.noOtherWorkspaces": "Nema drugih radnih prostora",
  "drift.thread.openSpawned": "Otvori pokrenuti razgovor",
  "drift.thread.renameHint": "Dvaput kliknite za preimenovanje",
  "drift.thread.shared": "Podijeljeno",
  "drift.thread.waitingForAnswer": "Čekanje na odgovor",
  "drift.thread.waitingForPermission": "Čekanje na dozvolu",
  "drift.thread.working": "Radi",
  "drift.tool.called": "Pozvano",
  "drift.tool.fetch": "Dohvati",
  "drift.tool.asyncQuestion": "Asinhrono pitanje",
  "drift.tool.spawn": "Pokreni",
  "drift.tool.subtask": "Podzadatak",
  "drift.tool.task": "Zadatak",
  "drift.voice.input.description": "Odaberite mikrofon za nova snimanja diktata.",
  "drift.voice.input.missing": "Sačuvani mikrofon nije dostupan. Koristi se zadani sistemski dok se ponovo ne poveže.",
  "drift.voice.input.systemDefault": "Zadani sistemski",
  "drift.voice.input.title": "Ulazni uređaj",
  "drift.voice.input.unnamed": "Mikrofon {{index}}",
  "drift.workspace.changeImage": "Promijeni sliku...",
  "drift.workspace.confirmRemove": "Kliknite ponovo za potvrdu",
  "drift.workspace.move": "Premjesti...",
  "drift.workspace.remove": "Ukloni",
  "drift.workspace.removeHint": "Razgovori se čuvaju 7 dana; ponovo dodajte isti folder da ih vratite.",
  "drift.workspace.useInitials": "Koristi inicijale",
}
