...
export const drift = {
  ...
  "drift.about.row.website.description": "Downloads, udgivelsesnoter og den vandmand, der inspirerede denne.",
  "drift.about.credits.engine": "Drift kører på OpenCode. Motoren klarer den svære del her, og denne app findes kun, fordi det arbejde er godt nok at bygge videre på. Ægte respekt til OpenCode-udviklerne og alle, der bidrager til det.",
  "drift.about.credits.ui": "Drift er ikke en kritik af motoren, blot en forskel i smag: jeg er simpelthen ikke fan af den nye brugerflade, så Drift beholder en roligere og tættere skal om samme motor.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} er større end 10 MB",
