...
export const drift = {
  ...
  "drift.preview.type.image": "Billeder",
  ...
  "drift.preview.htmlStatic": "Statisk forhåndsvisning. Scripts, links og eksterne ressourcer er deaktiveret.",
  "drift.preview.loading": "Indlæser forhåndsvisning...",
  "drift.preview.error": "Forhåndsvisningen kunne ikke indlæses.",
  "drift.preview.openEditor": "Åbn i editor",
  "drift.preview.retry": "Prøv igen",
  "drift.preview.previous": "Forrige side",
  "drift.preview.next": "Næste side",
  "drift.preview.page": "Side {{page}} af {{pages}}",
  "drift.preview.zoomIn": "Zoom ind",
  "drift.preview.zoomOut": "Zoom ud",
  "drift.preview.unsupported": "Denne filtype kan ikke forhåndsvises.",
  "drift.preview.tooLarge": "Denne fil er for stor til forhåndsvisning.",
  "drift.preview.unavailable": "Filforhåndsvisning er ikke tilgængelig.",
  ...
  "drift.settings.shellTimeout.custom": "Brugerdefineret",
  "drift.settings.shellTimeout.customMinutes": "Brugerdefinerede minutter",
  "drift.settings.shellTimeout.customDescription": "Indtast et helt tal fra 1 til 1.440 minutter.",
  "drift.settings.shellTimeout.invalid": "Indtast et helt tal fra 1 til 1.440.",
  "drift.shell.timeout.limit": "Grænse {{duration}}",
  "drift.shell.timeout.expired": "Timeout efter {{duration}}",
  "drift.agent.build": "Byg",
  "drift.agent.plan": "Plan",
  "drift.agent.general": "Generel",
  "drift.agent.explore": "Udforsk",
  "drift.settings.notifications": "Notifikationer",
  ...
  "drift.settings.customCss": "Brugerdefineret CSS",
  "drift.settings.customCss.description": "Anvendes lokalt efter Drifts indbyggede stilarter. Begrænset til 20 KB.",
  "drift.sidebar.workspaces": "Arbejdsområder",
  "drift.sidebar.archived": "Arkiverede elementer",
  "drift.sidebar.addWorkspace": "Tilføj arbejdsområde",
  "drift.sidebar.empty": "Tilføj et arbejdsområde for at komme i gang.",
  "drift.sidebar.resize": "Tilpas sidebjælkens bredde",
  "drift.workspace.showThreads": "Vis tråde",
  ...
  "drift.composer.connecting": "Opretter forbindelse til motoren...",
  "drift.composer.thinkingLevel": "Tænkeniveau",
  "drift.permissions.autoGlobal": "Tilladelser accepteres automatisk globalt",
  "drift.permissions.autoThread": "Tilladelser accepteres automatisk for denne tråd",
  "drift.prompt.steer": "Styr",
  "drift.titlebar.minimize": "Minimer",
  "drift.titlebar.restore": "Gendan",
  "drift.titlebar.maximize": "Maksimer",
  "drift.about.description": "Drift, en desktopagent med indbygget OpenCode.",
  "drift.settings.sound.chooseCustom": "Vælg brugerdefineret lyd",
  "drift.about.engine": "OpenCode {{version}}",
  "drift.about.failed": "(mislykkedes)",
  ...
  "drift.about.updates.available": "Tilgængelige",
  "drift.about.updates.unavailable": "Lokalt build",
  "drift.about.row.website.title": "Websted",
  "drift.about.row.website.description": "Downloads og udgivelsesnoter.",
  "drift.about.credits.engine": "Drift kører på OpenCode. Motoren klarer den svære del her, og denne app findes kun takket være det fantastiske arbejde. Ægte respekt til OpenCode-udviklerne og alle, der bidrager til det.",
  ...
  "drift.attachment.image": "billede",
  "drift.attachment.viewImage": "Vis billede",
  "drift.attachment.kind.audio": "Lyd",
  "drift.attachment.kind.csv": "Tabel",
  "drift.attachment.kind.image": "Billede",
  ...
  "drift.attachment.processing": "Læser...",
  "drift.attachment.table": "{{rows}} rækker x {{columns}} kolonner",
  "drift.chat.empty.noWorkspace": "Tilføj eller vælg et arbejdsområde til venstre for at begynde.",
  "drift.chat.empty.promptHint": "Begynd at skrive nedenfor. Enter sender, Shift+Enter skifter linje.",
  "drift.chat.empty.threadHint": "Tråde findes til venstre. Ingen faner. Aldrig.",
  "drift.chat.retry.inSeconds": "Prøver igen om {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - forsøg #{{attempt}}",
  "drift.chat.retry.now": "Prøver igen",
  "drift.chat.retry.providerRejected": "Udbyderen afviste anmodningen",
  "drift.chat.thinking": "Tænker",
  "drift.color.accent": "Accent",
  "drift.color.background": "Baggrund",
  "drift.color.surface": "Flade",
  "drift.color.text": "Tekst",
  "drift.composer.anotherThread": "en anden tråd",
  "drift.composer.dropFiles": "Slip filer for at vedhæfte",
  "drift.composer.fileReadFailed": "Kunne ikke læse {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} er ikke gyldig UTF-8-tekst",
  "drift.composer.fileTooLarge": "{{filename}} overskrider grænsen på {{limit}} for {{kind}}-filer",
  "drift.composer.fileUnsupported": "{{filename}} er et ikke-understøttet arkiv eller en binær fil",
  "drift.composer.folderUnsupported": "Mapper kan ikke vedhæftes; slip enkelte filer i stedet",
  "drift.composer.modelUnsupported": "{{model}} accepterer ikke {{kind}}-vedhæftninger ({{filename}})",
  "drift.composer.openThread": "Åbn den tråd",
  "drift.composer.pendingInThread": "i {{thread}}",
  "drift.context.compacted": "Kontekst komprimeret",
  "drift.context.compacting": "Komprimerer kontekst",
  "drift.context.pending": "Forbrug vises efter det første svar.",
  "drift.context.untilCompaction": "Indtil komprimering",
  "drift.count.entry.one": "{{count}} post",
  "drift.count.entry.other": "{{count}} poster",
  ...
  "drift.count.match.other": "{{count}} match",
  "drift.count.result.one": "{{count}} resultat",
  "drift.count.result.other": "{{count}} resultater",
  "drift.count.tool.one": "{{count}} værktøj",
  "drift.count.tool.other": "{{count}} værktøjer",
  "drift.debug.context": "Kontekst",
  "drift.file.created": "Oprettet",
  ...
  "drift.mcp.authenticate": "Autentificer",
  ...
  "drift.message.copy": "Kopier besked",
  ...
  "drift.provider.signInStartFailed": "Kunne ikke starte loginforløbet.",
  "drift.provider.signInStartFailedFor": "Kunne ikke starte loginforløbet for {{provider}}.",
  "drift.provider.signInWith": "Log ind med {{method}}",
  ...
  "drift.question.answerNow": "Svar nu",
  "drift.question.asyncHint": "Arbejde, der ikke afhænger af dit svar, kan fortsætte, mens du beslutter dig.",
  "drift.question.blocking": "Venter på svar",
  "drift.question.pending": "Afventende anmodninger: {{count}}",
  "drift.question.sendFailed": "Kunne ikke sende dit svar. Dine svar er her stadig. Prøv at sende igen.",
  "drift.question.sending": "Sender...",
  "drift.question.customHint": "Tilføj et svar, der ikke er vist ovenfor",
  "drift.question.customPlaceholder": "Skriv dit eget svar...",
  "drift.question.number": "Spørgsmål {{number}}",
  "drift.question.selectMultiple": "Vælg alle relevante svar",
  "drift.question.selectOne": "Vælg ét svar",
  "drift.reasoning.thinking": "Tænker",
  ...
  "drift.reasoning.level.medium": "Mellem",
  "drift.reasoning.level.high": "Høj",
  "drift.reasoning.level.xhigh": "Meget høj",
  "drift.reasoning.level.max": "Maksimal",
  "drift.settings.customPalette.colorDescription": "Indstil farven {{color}}.",
  "drift.settings.customPalette.hexValue": "Hexværdi for {{color}}",
  "drift.settings.providers.notConnected": "Ikke forbundet",
  ...
  "drift.shortcuts.zoomOut": "Zoom ud",
  "drift.shortcuts.zoomReset": "Nulstil zoom",
  "drift.sidebar.moveSessionFailed": "Kunne ikke flytte sessionen",
  "drift.sidebar.moveWorkspaceFailed": "Kunne ikke flytte arbejdsområdet",
  "drift.sidebar.movingSession": "Flytter sessionen til {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Flytter sessioner fra {{workspace}}...",
  "drift.sidebar.offline": "offline",
  "drift.sidebar.pathAlreadySaved": "{{path}} er allerede gemt som {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Kunne ikke gemme den nye sti til arbejdsområdet: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Flytningen af arbejdsområdet blev kun delvist gennemført: {{error}}",
  "drift.slash.mcp": "Administrer MCP-servere",
  "drift.slash.workspaceCommand": "arbejdsområdekommando",
  "drift.sound.group.alerts": "Alarmer",
  "drift.sound.group.failure": "Fejl",
  "drift.sound.group.information": "Information",
  "drift.sound.group.mechanical": "Mekanisk",
  "drift.sound.group.success": "Succes",
  "drift.status.waitingForPermission": "Venter på tilladelse",
  "drift.theme.aubergine": "Drift Aubergine",
  "drift.theme.custom": "Brugerdefineret",
  "drift.theme.dark": "Drift Mørk",
  "drift.theme.forest": "Drift Skov",
  "drift.theme.graphite": "Drift Grafit",
  "drift.theme.light": "Drift Lys",
  "drift.theme.midnight": "Drift Midnat",
  "drift.theme.paper": "Drift Papir",
  "drift.theme.slate": "Drift Skifer",
  "drift.thread.backToParent": "Tilbage til tråden, som denne blev startet fra",
  "drift.thread.copyShareLink": "Kopier delingslink: {{url}}",
  "drift.thread.move": "Flyt",
  "drift.thread.moveToWorkspace": "Flyt til arbejdsområde",
  "drift.thread.noOtherWorkspaces": "Ingen andre arbejdsområder",
  "drift.thread.openSpawned": "Åbn startet tråd",
  "drift.thread.renameHint": "Dobbeltklik for at omdøbe",
  "drift.thread.shared": "Delt",
  "drift.thread.waitingForAnswer": "Venter på svar",
  "drift.thread.waitingForPermission": "Venter på tilladelse",
  "drift.thread.working": "Arbejder",
  "drift.tool.called": "Kaldte",
  "drift.tool.fetch": "Hent",
  "drift.tool.asyncQuestion": "Asynkront spørgsmål",
  "drift.tool.spawn": "Start",
  ...
  "drift.workspace.changeImage": "Skift billede...",
  "drift.workspace.confirmRemove": "Klik igen for at bekræfte",
  "drift.workspace.move": "Flyt...",
  "drift.workspace.remove": "Fjern",
  "drift.workspace.removeHint": "Tråde gemmes i 7 dage; tilføj den samme mappe igen for at gendanne dem.",
  "drift.workspace.useInitials": "Brug initialer",
}
