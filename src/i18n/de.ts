...
export const drift = {
  "drift.slash.keyboardHint": "Tab vervollständigt. Enter bestätigt.",
  ...
  "drift.preview.mode.none": "Keine",
  "drift.preview.mode.custom": "Benutzerdefiniert",
  "drift.preview.type.markdown": "Markdown-Dateien",
  "drift.preview.type.pdf": "PDF-Dokumente",
  "drift.preview.type.image": "Bilder",
  "drift.preview.type.text": "Text und Code",
  "drift.preview.type.table": "Tabellen (CSV/TSV)",
  "drift.preview.type.audio": "Audio",
  "drift.preview.type.video": "Video",
  "drift.preview.title": "Dateivorschau",
  "drift.preview.htmlRendered": "Vorschau",
  "drift.preview.htmlSource": "HTML-Quelltext",
  "drift.preview.htmlStatic": "Statische Vorschau. Skripte, Links und externe Ressourcen sind deaktiviert.",
  "drift.preview.loading": "Vorschau wird geladen...",
  "drift.preview.error": "Die Vorschau konnte nicht geladen werden.",
  "drift.preview.openEditor": "Im Editor öffnen",
  "drift.preview.retry": "Erneut versuchen",
  "drift.preview.previous": "Vorherige Seite",
  "drift.preview.next": "Nächste Seite",
  "drift.preview.page": "Seite {{page}} von {{pages}}",
  "drift.preview.zoomIn": "Vergrößern",
  "drift.preview.zoomOut": "Verkleinern",
  "drift.preview.unsupported": "Für diesen Dateityp ist keine Vorschau möglich.",
  "drift.preview.tooLarge": "Diese Datei ist zu groß für eine Vorschau.",
  "drift.preview.unavailable": "Die Dateivorschau ist nicht verfügbar.",
  ...
  "drift.settings.shellTimeout.preset15": "15 Minuten",
  "drift.settings.shellTimeout.preset30": "30 Minuten",
  "drift.settings.shellTimeout.custom": "Benutzerdefiniert",
  "drift.settings.shellTimeout.customMinutes": "Benutzerdefinierte Minuten",
  "drift.settings.shellTimeout.customDescription": "Gib eine ganze Zahl von 1 bis 1.440 Minuten ein.",
  "drift.settings.shellTimeout.invalid": "Gib eine ganze Zahl von 1 bis 1.440 ein.",
  "drift.shell.timeout.limit": "Limit {{duration}}",
  "drift.shell.timeout.expired": "Zeitlimit nach {{duration}} erreicht",
  "drift.agent.build": "Erstellen",
  "drift.agent.plan": "Planen",
  "drift.agent.general": "Allgemein",
  ...
  "drift.sidebar.empty": "Füge einen Arbeitsbereich hinzu, um loszulegen.",
  "drift.sidebar.resize": "Seitenleiste anpassen",
  "drift.workspace.showThreads": "Threads anzeigen",
  ...
  "drift.composer.connecting": "Verbindung zur Engine wird hergestellt...",
  "drift.composer.thinkingLevel": "Denkniveau",
  "drift.permissions.autoGlobal": "Berechtigungen werden global automatisch akzeptiert",
  "drift.permissions.autoThread": "Berechtigungen werden für diesen Thread automatisch akzeptiert",
  "drift.prompt.steer": "Steuern",
  "drift.titlebar.minimize": "Minimieren",
  ...
  "drift.about.starting": "(wird gestartet...)",
  ...
  "drift.about.row.website.description": "Downloads und Versionshinweise.",
  "drift.about.credits.engine": "Drift läuft auf OpenCode. Die Engine übernimmt hier den schwierigen Teil, und diese App existiert nur dank dieser großartigen Arbeit. Echter Respekt an die OpenCode-Entwickler und alle, die dazu beitragen.",
  "drift.archive.deletesInDays": "Wird in {{days}}d gelöscht",
  ...
  "drift.attachment.image": "Bild",
  "drift.attachment.viewImage": "Bild anzeigen",
  ...
  "drift.attachment.pages": "{{count}} Seiten",
  ...
  "drift.chat.retry.now": "Neuer Versuch",
  "drift.chat.retry.providerRejected": "Der Anbieter hat die Anfrage nicht akzeptiert",
  "drift.chat.thinking": "Denkt nach",
  "drift.color.accent": "Akzent",
  "drift.color.background": "Hintergrund",
  "drift.color.surface": "Oberfläche",
  "drift.color.text": "Text",
  "drift.composer.anotherThread": "ein anderer Thread",
  "drift.composer.dropFiles": "Dateien ablegen, um sie anzuhängen",
  "drift.composer.fileReadFailed": "{{filename}} konnte nicht gelesen werden",
  "drift.composer.fileInvalidUtf8": "{{filename}} ist kein gültiger UTF-8-Text",
  "drift.composer.fileTooLarge": "{{filename}} überschreitet das {{limit}}-Limit für {{kind}}-Dateien",
  "drift.composer.fileUnsupported": "{{filename}} ist ein nicht unterstütztes Archiv oder eine Binärdatei",
  "drift.composer.folderUnsupported": "Ordner können nicht angehängt werden; stattdessen einzelne Dateien ablegen",
  "drift.composer.modelUnsupported": "{{model}} akzeptiert keine {{kind}}-Anhänge ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} Einträge",
  "drift.count.file.one": "{{count}} Datei",
  "drift.count.file.other": "{{count}} Dateien",
  "drift.count.line.one": "{{count}} Zeile",
  "drift.count.line.other": "{{count}} Zeilen",
  "drift.count.match.one": "{{count}} Treffer",
  "drift.count.match.other": "{{count}} Treffer",
  "drift.count.result.one": "{{count}} Ergebnis",
  "drift.count.result.other": "{{count}} Ergebnisse",
  "drift.count.tool.one": "{{count}} Tool",
  "drift.count.tool.other": "{{count}} Tools",
  "drift.debug.context": "Kontext",
  "drift.file.created": "Erstellt",
  "drift.file.deleted": "Gelöscht",
  "drift.file.moved": "Verschoben",
  ...
  "drift.mcp.authenticate": "Authentifizieren",
  ...
  "drift.message.copy": "Nachricht kopieren",
  "drift.message.copyResponse": "Antwort kopieren",
  ...
  "drift.provider.finishInBrowser": "Anmeldung im Browser abschließen.",
  "drift.provider.savedUnavailable": "Anmeldedaten gespeichert, aber {{provider}} wurde nicht verfügbar.",
  "drift.provider.signInStartFailed": "Der Anmeldevorgang konnte nicht gestartet werden.",
  "drift.provider.signInStartFailedFor": "Der Anmeldevorgang für {{provider}} konnte nicht gestartet werden.",
  "drift.provider.signInWith": "Mit {{method}} anmelden",
  ...
  "drift.question.number": "Frage {{number}}",
  "drift.question.selectMultiple": "Alle zutreffenden Antworten auswählen",
  "drift.question.selectOne": "Eine Antwort auswählen",
  "drift.reasoning.thinking": "Denkt nach",
  "drift.reasoning.thought": "Gedanke",
  "drift.reasoning.level.none": "Keine",
  "drift.reasoning.level.minimal": "Minimal",
  "drift.reasoning.level.low": "Niedrig",
  "drift.reasoning.level.medium": "Mittel",
  "drift.reasoning.level.high": "Hoch",
  "drift.reasoning.level.xhigh": "Sehr hoch",
  "drift.reasoning.level.max": "Maximum",
  "drift.settings.customPalette.colorDescription": "Farbe {{color}} festlegen.",
  "drift.settings.customPalette.hexValue": "Hexadezimalwert für {{color}}",
  "drift.settings.providers.notConnected": "Nicht verbunden",
  ...
  "drift.shortcuts.zoomOut": "Verkleinern",
  "drift.shortcuts.zoomReset": "Zoom zurücksetzen",
  "drift.sidebar.moveSessionFailed": "Sitzung konnte nicht verschoben werden",
  "drift.sidebar.moveWorkspaceFailed": "Arbeitsbereich konnte nicht verschoben werden",
  "drift.sidebar.movingSession": "Sitzung wird nach {{workspace}} verschoben...",
  "drift.sidebar.movingWorkspaceSessions": "Sitzungen aus {{workspace}} werden verschoben...",
  ...
  "drift.sound.group.failure": "Fehler",
  "drift.sound.group.information": "Information",
  "drift.sound.group.mechanical": "Mechanisch",
  "drift.sound.group.success": "Erfolg",
  "drift.status.waitingForPermission": "Warten auf Berechtigung",
  "drift.theme.aubergine": "Drift Aubergine",
  "drift.theme.custom": "Benutzerdefiniert",
  "drift.theme.dark": "Drift Dunkel",
  "drift.theme.forest": "Drift Wald",
  "drift.theme.graphite": "Drift Graphit",
  "drift.theme.light": "Drift Hell",
  "drift.theme.midnight": "Drift Mitternacht",
  "drift.theme.paper": "Drift Papier",
  "drift.theme.slate": "Drift Schiefer",
  "drift.thread.backToParent": "Zurück zum Thread, aus dem dieser gestartet wurde",
  "drift.thread.copyShareLink": "Freigabelink kopieren: {{url}}",
  "drift.thread.move": "Verschieben",
  "drift.thread.moveToWorkspace": "In Arbeitsbereich verschieben",
  "drift.thread.noOtherWorkspaces": "Keine anderen Arbeitsbereiche",
  "drift.thread.openSpawned": "Gestarteten Thread öffnen",
  "drift.thread.renameHint": "Zum Umbenennen doppelklicken",
  "drift.thread.shared": "Geteilt",
  "drift.thread.waitingForAnswer": "Warten auf eine Antwort",
  "drift.thread.waitingForPermission": "Warten auf Berechtigung",
  "drift.thread.working": "Arbeitet",
  "drift.tool.called": "Aufgerufen",
  "drift.tool.fetch": "Abrufen",
  "drift.tool.asyncQuestion": "Asynchrone Frage",
  "drift.tool.spawn": "Starten",
  ...
  "drift.workspace.changeImage": "Bild ändern...",
