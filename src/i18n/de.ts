...
export const drift = {
  ...
  "drift.about.updates.enabled": "Verfügbar",
  "drift.about.updates.disabled": "Lokaler Build",
  "drift.about.row.website.title": "Website",
  "drift.about.row.website.description": "Downloads, Versionshinweise und die Qualle, die diese hier inspiriert hat.",
  "drift.about.credits.engine": "Drift läuft auf OpenCode. Die Engine übernimmt hier den schwierigen Teil, und diese App existiert nur, weil diese Arbeit gut genug ist, um darauf aufzubauen. Echter Respekt an die OpenCode-Entwickler und alle, die dazu beitragen.",
  "drift.about.credits.ui": "Drift ist keine Kritik an der Engine, sondern nur ein Unterschied im Geschmack: Ich mag die neue Benutzeroberfläche einfach nicht, deshalb behält Drift eine ruhigere, dichtere Hülle um dieselbe Engine.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} ist größer als 10 MB",
