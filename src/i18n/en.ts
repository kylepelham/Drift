...
export const drift = {
  ...
  "drift.settings.toolRouting.outcome.routed": "Last turn: hid {{count}} tools.",
  "drift.settings.toolRouting.outcome.no-key": "No OpenCode Zen or Go API key, so all tools stay available.",
  "drift.settings.toolRouting.outcome.unauthorized": "Jev needs an OpenCode workspace API key. Free Zen access is not enough.",
  "drift.settings.toolRouting.outcome.insufficient-funds": "Your OpenCode workspace has no Zen balance for Jev. Go plans do not include it.",
  "drift.settings.toolRouting.outcome.http-error": "Jev returned HTTP {{status}}, so all tools stayed available.",
  ...
  "drift.preview.mode.all": "All",
  "drift.preview.mode.none": "None",
  "drift.preview.mode.custom": "Custom",
  "drift.preview.type.markdown": "Markdown files",
  "drift.preview.type.pdf": "PDF documents",
  "drift.preview.type.image": "Images",
  "drift.preview.type.text": "Text and code",
  "drift.preview.type.table": "Tables (CSV/TSV)",
  "drift.preview.type.audio": "Audio",
  "drift.preview.type.video": "Video",
  "drift.preview.title": "File preview",
  "drift.preview.htmlRendered": "Preview",
  "drift.preview.htmlSource": "HTML source",
  "drift.preview.htmlStatic": "Static preview. Scripts, links, and external resources are disabled.",
  "drift.preview.loading": "Loading preview...",
  "drift.preview.error": "Could not load the preview.",
  "drift.preview.openEditor": "Open in editor",
  "drift.preview.retry": "Retry",
  "drift.preview.previous": "Previous page",
  "drift.preview.next": "Next page",
  "drift.preview.page": "Page {{page}} of {{pages}}",
  "drift.preview.zoomIn": "Zoom in",
  "drift.preview.zoomOut": "Zoom out",
  "drift.preview.unsupported": "This file type cannot be previewed.",
  "drift.preview.tooLarge": "This file is too large to preview.",
  "drift.preview.unavailable": "File preview is unavailable.",
  ...
  "drift.remote.enableDescription": "Use Drift from your phone, tablet, or another computer on this network.",
  ...
  "drift.remote.copy": "Copy address",
  "drift.remote.open.title": "Open on your device",
  "drift.remote.open.description": "Visit this address in a browser on the same network. The address holds no password, so it is safe to share.",
  "drift.remote.scan": "Scan with the device's camera to open the address.",
  "drift.remote.link.title": "Link a device",
  "drift.remote.link.description": "The device shows an 8-character code. Enter it here to let that device in.",
  "drift.remote.link.action": "Link",
  "drift.remote.link.linked": "Linked {{name}}. It opens Drift in a moment.",
  "drift.remote.link.waiting": "Waiting for a code: {{devices}}",
  "drift.remote.devices.title": "Linked devices",
  "drift.remote.devices.empty": "No devices are linked yet.",
  "drift.remote.devices.link": "Linked with a code",
  "drift.remote.devices.password": "Signed in with password",
  "drift.remote.devices.lastSeen": "last active {{time}}",
  ...
  "drift.remote.password.change": "Change",
  "drift.remote.password.turnOff": "Turn off",
  "drift.remote.password.username": "Username",
  "drift.remote.password.password": "Password",
  "drift.remote.password.confirm": "Confirm password",
  "drift.remote.password.mismatch": "The passwords do not match.",
  "drift.remote.password.save": "Save",
  "drift.remote.password.cancel": "Cancel",
  "drift.remote.password.note": "Changing or turning off the password signs out devices that used it.",
  "drift.remote.encryption.title": "Encryption",
  "drift.remote.encryption.https": "HTTPS",
  "drift.remote.encryption.description": "Devices connect over HTTPS with a certificate this computer created. Browsers warn on first connect until the certificate is installed from the sign-in page.",
  "drift.remote.encryption.fingerprint": "Certificate fingerprint (SHA-256)",
  "drift.remote.device.title": "This device",
  "drift.remote.device.signedIn": "Signed in as {{name}}",
  "drift.remote.device.signOut": "Sign out",
  "drift.remote.toast.title": "A device wants to connect",
  "drift.remote.toast.message": "{{name}} is waiting for its code to be entered.",
  "drift.remote.toast.open": "Enter code",
  "drift.remote.securityNote": "Only devices you link, or that know the password, can connect. Anyone connected can control Drift and read this computer's workspaces.",
  ...
  "drift.settings.prompts.saved": "Saved. Active sessions apply changes when they finish.",
  ...
  "drift.markdown.linkFailed": "Could not open this link.",
  ...
  "drift.question.answerLater": "Answer later",
  "drift.question.answerNow": "Answer now",
  "drift.question.asyncHint": "Independent work can continue while you decide.",
  "drift.question.blocking": "Waiting for answer",
  "drift.question.pending": "Pending requests: {{count}}",
  "drift.question.sendFailed": "Could not send your response. Your answers are still here. Try submitting again.",
  "drift.question.sending": "Sending...",
  ...
  "drift.settings.search.empty": "No matching settings",
  "drift.settings.search.placeholder": "Search settings",
  ...
  "drift.search.close": "Close search",
  "drift.search.empty": "No matching sessions",
  "drift.search.mode.content": "Content",
  "drift.search.mode.name": "Name",
  "drift.search.next": "Next match",
  "drift.search.previous": "Previous match",
  "drift.search.sessions.placeholder": "Search sessions",
  "drift.search.transcript": "Search this session",
  "drift.search.transcript.placeholder": "Find in session",
  "drift.shortcuts.autoAccept": "Toggle auto-accept permissions",
  "drift.shortcuts.findInSession": "Find in session",
