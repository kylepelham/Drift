...
export const drift = {
  ...
  "drift.about.updates.disabled": "Compilación local",
  "drift.about.row.website.title": "Sitio web",
  "drift.about.row.website.description": "Descargas, notas de versión y la medusa que inspiró a esta.",
  "drift.about.credits.engine": "Drift funciona con OpenCode. El motor hace la parte difícil aquí, y esta aplicación solo existe porque ese trabajo es lo bastante bueno para construir sobre él. Respeto real a los desarrolladores de OpenCode y a todos los que contribuyen.",
  "drift.about.credits.ui": "Drift no es una crítica al motor, solo una diferencia de gusto: simplemente no me gusta la nueva interfaz, así que Drift mantiene una carcasa más tranquila y densa alrededor del mismo motor.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} supera los 10 MB",
