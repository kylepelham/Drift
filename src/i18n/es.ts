...
export const drift = {
  ...
  "drift.preview.mode.none": "Ninguno",
  "drift.preview.mode.custom": "Personalizado",
  "drift.preview.type.markdown": "Archivos Markdown",
  "drift.preview.type.pdf": "Documentos PDF",
  "drift.preview.type.image": "Imágenes",
  "drift.preview.type.text": "Texto y código",
  "drift.preview.type.table": "Tablas (CSV/TSV)",
  "drift.preview.type.audio": "Audio",
  "drift.preview.type.video": "Vídeo",
  "drift.preview.title": "Vista previa del archivo",
  "drift.preview.htmlRendered": "Vista previa",
  "drift.preview.htmlSource": "Código HTML",
  "drift.preview.htmlStatic": "Vista previa estática. Los scripts, enlaces y recursos externos están desactivados.",
  "drift.preview.loading": "Cargando vista previa...",
  "drift.preview.error": "No se pudo cargar la vista previa.",
  "drift.preview.openEditor": "Abrir en el editor",
  "drift.preview.retry": "Reintentar",
  "drift.preview.previous": "Página anterior",
  "drift.preview.next": "Página siguiente",
  "drift.preview.page": "Página {{page}} de {{pages}}",
  "drift.preview.zoomIn": "Acercar",
  "drift.preview.zoomOut": "Alejar",
  "drift.preview.unsupported": "No se puede mostrar una vista previa de este tipo de archivo.",
  "drift.preview.tooLarge": "Este archivo es demasiado grande para mostrar una vista previa.",
  "drift.preview.unavailable": "La vista previa del archivo no está disponible.",
  ...
  "drift.settings.shellTimeout.customDescription": "Introduce un número entero entre 1 y 1.440 minutos.",
  "drift.settings.shellTimeout.invalid": "Introduce un número entero entre 1 y 1.440.",
  "drift.shell.timeout.limit": "Límite {{duration}}",
  "drift.shell.timeout.expired": "Tiempo agotado tras {{duration}}",
  ...
  "drift.sidebar.empty": "Añade un espacio de trabajo para empezar.",
  "drift.sidebar.resize": "Redimensionar barra lateral",
  "drift.workspace.showThreads": "Mostrar hilos",
  ...
  "drift.composer.connecting": "Conectando con el motor...",
  "drift.composer.thinkingLevel": "Nivel de razonamiento",
  "drift.permissions.autoGlobal": "Aceptando permisos automáticamente de forma global",
  "drift.permissions.autoThread": "Aceptando permisos automáticamente para este hilo",
  ...
  "drift.about.group.build": "Compilación",
  "drift.about.group.links": "Enlaces",
  ...
  "drift.about.row.website.description": "Descargas y notas de versión.",
  "drift.about.credits.engine": "Drift funciona con OpenCode. El motor hace la parte difícil aquí, y esta aplicación solo existe gracias a ese trabajo increíble. Respeto real a los desarrolladores de OpenCode y a todos los que contribuyen.",
  "drift.archive.deletesInDays": "Se elimina en {{days}}d",
  ...
  "drift.attachment.image": "imagen",
  "drift.attachment.viewImage": "Ver imagen",
  ...
  "drift.attachment.processing": "Leyendo...",
  "drift.attachment.table": "{{rows}} filas x {{columns}} columnas",
  "drift.chat.empty.noWorkspace": "Añade o selecciona un espacio de trabajo a la izquierda para empezar.",
  "drift.chat.empty.promptHint": "Empieza a escribir abajo. Intro envía y Mayús+Intro inserta un salto de línea.",
  "drift.chat.empty.threadHint": "Los hilos están a la izquierda. Sin pestañas. Nunca.",
  "drift.chat.retry.inSeconds": "Reintentando en {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - intento #{{attempt}}",
  "drift.chat.retry.now": "Reintentando",
  "drift.chat.retry.providerRejected": "El proveedor no aceptó la solicitud",
  "drift.chat.thinking": "Pensando",
  "drift.color.accent": "Acento",
  "drift.color.background": "Fondo",
  "drift.color.surface": "Superficie",
  "drift.color.text": "Texto",
  "drift.composer.anotherThread": "otro hilo",
  "drift.composer.dropFiles": "Suelta archivos para adjuntarlos",
  "drift.composer.fileReadFailed": "No se pudo leer {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} no es texto UTF-8 válido",
  "drift.composer.fileTooLarge": "{{filename}} supera el límite de {{limit}} para archivos {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} es un archivo comprimido o binario no compatible",
  "drift.composer.folderUnsupported": "No se pueden adjuntar carpetas; suelta archivos individuales",
  "drift.composer.modelUnsupported": "{{model}} no admite adjuntos {{kind}} ({{filename}})",
  "drift.composer.openThread": "Abrir ese hilo",
  "drift.composer.pendingInThread": "en {{thread}}",
  "drift.context.compacted": "Contexto compactado",
  "drift.context.compacting": "Compactando el contexto",
  "drift.context.pending": "El uso aparece después de la primera respuesta.",
  "drift.context.untilCompaction": "Hasta la compactación",
  "drift.count.entry.one": "{{count}} entrada",
  "drift.count.entry.other": "{{count}} entradas",
  "drift.count.file.one": "{{count}} archivo",
  "drift.count.file.other": "{{count}} archivos",
  "drift.count.line.one": "{{count}} línea",
  "drift.count.line.other": "{{count}} líneas",
  "drift.count.match.one": "{{count}} coincidencia",
  "drift.count.match.other": "{{count}} coincidencias",
  "drift.count.result.one": "{{count}} resultado",
  "drift.count.result.other": "{{count}} resultados",
  "drift.count.tool.one": "{{count}} herramienta",
  "drift.count.tool.other": "{{count}} herramientas",
  "drift.debug.context": "Contexto",
  "drift.file.created": "Creado",
  "drift.file.deleted": "Eliminado",
  ...
  "drift.mcp.description": "Servidores globales de Drift y definiciones efectivas exactas informadas por el espacio de trabajo activo.",
  ...
  "drift.message.copy": "Copiar mensaje",
  "drift.message.copyResponse": "Copiar respuesta",
  ...
  "drift.provider.finishInBrowser": "Termina de iniciar sesión en el navegador.",
  "drift.provider.savedUnavailable": "La credencial se guardó, pero {{provider}} no está disponible.",
  "drift.provider.signInStartFailed": "No se pudo iniciar el proceso de inicio de sesión.",
  "drift.provider.signInStartFailedFor": "No se pudo iniciar el proceso de inicio de sesión de {{provider}}.",
  "drift.provider.signInWith": "Iniciar sesión con {{method}}",
  ...
  "drift.question.answerLater": "Responder más tarde",
  ...
  "drift.question.number": "Pregunta {{number}}",
  "drift.question.selectMultiple": "Selecciona todas las respuestas aplicables",
  "drift.question.selectOne": "Selecciona una respuesta",
  "drift.reasoning.thinking": "Pensando",
  "drift.reasoning.thought": "Pensamiento",
  "drift.reasoning.level.none": "Ninguno",
  "drift.reasoning.level.minimal": "Mínimo",
  "drift.reasoning.level.low": "Bajo",
  "drift.reasoning.level.medium": "Medio",
  "drift.reasoning.level.high": "Alto",
  "drift.reasoning.level.xhigh": "Muy alto",
  "drift.reasoning.level.max": "Máximo",
  "drift.settings.customPalette.colorDescription": "Establece el color {{color}}.",
  "drift.settings.customPalette.hexValue": "Valor hexadecimal de {{color}}",
  "drift.settings.providers.notConnected": "No conectado",
  ...
  "drift.shortcuts.zoomOut": "Alejar",
  "drift.shortcuts.zoomReset": "Restablecer zoom",
  "drift.sidebar.moveSessionFailed": "No se pudo mover la sesión",
  "drift.sidebar.moveWorkspaceFailed": "No se pudo mover el espacio de trabajo",
  "drift.sidebar.movingSession": "Moviendo la sesión a {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Moviendo las sesiones de {{workspace}}...",
  "drift.sidebar.offline": "sin conexión",
  "drift.sidebar.pathAlreadySaved": "{{path}} ya está guardada como {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "No se pudo guardar la nueva ruta del espacio de trabajo: {{error}}",
  "drift.sidebar.workspaceMovePartial": "El traslado del espacio de trabajo solo se aplicó parcialmente: {{error}}",
  "drift.slash.mcp": "Gestionar servidores MCP",
  "drift.slash.workspaceCommand": "comando del espacio de trabajo",
  "drift.sound.group.alerts": "Alertas",
  "drift.sound.group.failure": "Fallo",
  "drift.sound.group.information": "Información",
  "drift.sound.group.mechanical": "Mecánicos",
  "drift.sound.group.success": "Éxito",
  "drift.status.waitingForPermission": "Esperando permiso",
  "drift.theme.aubergine": "Drift Berenjena",
  "drift.theme.custom": "Personalizado",
  "drift.theme.dark": "Drift Oscuro",
  "drift.theme.forest": "Drift Bosque",
  "drift.theme.graphite": "Drift Grafito",
  "drift.theme.light": "Drift Claro",
  "drift.theme.midnight": "Drift Medianoche",
  "drift.theme.paper": "Drift Papel",
  "drift.theme.slate": "Drift Pizarra",
  "drift.thread.backToParent": "Volver al hilo desde el que se creó este",
  "drift.thread.copyShareLink": "Copiar enlace para compartir: {{url}}",
  "drift.thread.move": "Mover",
  "drift.thread.moveToWorkspace": "Mover al espacio de trabajo",
  "drift.thread.noOtherWorkspaces": "No hay otros espacios de trabajo",
  "drift.thread.openSpawned": "Abrir hilo creado",
  "drift.thread.renameHint": "Haz doble clic para renombrar",
  "drift.thread.shared": "Compartido",
  "drift.thread.waitingForAnswer": "Esperando una respuesta",
  "drift.thread.waitingForPermission": "Esperando permiso",
  "drift.thread.working": "Trabajando",
  "drift.tool.called": "Llamada",
  "drift.tool.fetch": "Obtener",
  "drift.tool.asyncQuestion": "Pregunta asíncrona",
  "drift.tool.spawn": "Crear",
  ...
  "drift.workspace.changeImage": "Cambiar imagen...",
