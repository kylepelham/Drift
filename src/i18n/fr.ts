...
export const drift = {
  "drift.slash.keyboardHint": "Tab complète. Entrée confirme.",
  ...
  "drift.preview.mode.all": "Tous",
  "drift.preview.mode.none": "Aucun",
  "drift.preview.mode.custom": "Personnalisé",
  "drift.preview.type.markdown": "Fichiers Markdown",
  "drift.preview.type.pdf": "Documents PDF",
  "drift.preview.type.image": "Images",
  "drift.preview.type.text": "Texte et code",
  "drift.preview.type.table": "Tableaux (CSV/TSV)",
  "drift.preview.type.audio": "Audio",
  "drift.preview.type.video": "Vidéo",
  "drift.preview.title": "Aperçu du fichier",
  "drift.preview.htmlRendered": "Aperçu",
  "drift.preview.htmlSource": "Code HTML",
  "drift.preview.htmlStatic": "Aperçu statique. Les scripts, liens et ressources externes sont désactivés.",
  "drift.preview.loading": "Chargement de l'aperçu...",
  "drift.preview.error": "Impossible de charger l'aperçu.",
  "drift.preview.openEditor": "Ouvrir dans l'éditeur",
  "drift.preview.retry": "Réessayer",
  "drift.preview.previous": "Page précédente",
  "drift.preview.next": "Page suivante",
  "drift.preview.page": "Page {{page}} sur {{pages}}",
  "drift.preview.zoomIn": "Agrandir",
  "drift.preview.zoomOut": "Réduire",
  "drift.preview.unsupported": "Ce type de fichier ne peut pas être prévisualisé.",
  "drift.preview.tooLarge": "Ce fichier est trop volumineux pour être prévisualisé.",
  "drift.preview.unavailable": "L'aperçu du fichier est indisponible.",
  ...
  "drift.settings.shellTimeout.custom": "Personnalisé",
  "drift.settings.shellTimeout.customMinutes": "Minutes personnalisées",
  "drift.settings.shellTimeout.customDescription": "Saisissez un nombre entier de 1 à 1 440 minutes.",
  "drift.settings.shellTimeout.invalid": "Saisissez un nombre entier de 1 à 1 440.",
  "drift.shell.timeout.limit": "Limite {{duration}}",
  "drift.shell.timeout.expired": "Délai dépassé après {{duration}}",
  "drift.agent.build": "Construction",
  "drift.agent.plan": "Planification",
  "drift.agent.general": "Général",
  ...
  "drift.settings.summaries.collapsible.title": "Résumés de compactage repliables",
  "drift.settings.summaries.collapsible.description":
    "Masquez les résumés de compactage du moteur sous un séparateur dépliable.",
  "drift.settings.summaries.collapsed.title": "Replier les résumés par défaut",
  "drift.settings.summaries.collapsed.description": "Afficher d’abord les résumés de compactage repliés.",
  ...
  "drift.sidebar.empty": "Ajoutez un espace de travail pour commencer.",
  "drift.sidebar.resize": "Redimensionner la barre latérale",
  "drift.workspace.showThreads": "Afficher les discussions",
  ...
  "drift.composer.connecting": "Connexion au moteur...",
  "drift.composer.thinkingLevel": "Niveau de réflexion",
  "drift.permissions.autoGlobal": "Autorisations acceptées automatiquement partout",
  "drift.permissions.autoThread": "Autorisations acceptées automatiquement pour cette discussion",
  "drift.prompt.steer": "Orienter",
  "drift.titlebar.minimize": "Réduire",
  ...
  "drift.about.row.website.description": "Téléchargements et notes de version.",
  "drift.about.credits.engine": "Drift fonctionne avec OpenCode. Le moteur fait le plus dur ici, et cette application n'existe que grâce à ce travail remarquable. Un vrai respect aux développeurs d'OpenCode et à tous ceux qui y contribuent.",
  "drift.archive.deletesInDays": "Suppression dans {{days}}d",
  ...
  "drift.attachment.viewImage": "Afficher l'image",
  ...
  "drift.attachment.processing": "Lecture...",
  "drift.attachment.table": "{{rows}} lignes x {{columns}} colonnes",
  "drift.chat.empty.noWorkspace": "Ajoutez ou sélectionnez un espace de travail à gauche pour commencer.",
  "drift.chat.empty.promptHint": "Commencez à saisir ci-dessous. Entrée envoie, Maj+Entrée passe à la ligne.",
  "drift.chat.empty.threadHint": "Les discussions sont à gauche. Aucun onglet. Jamais.",
  "drift.chat.retry.inSeconds": "Nouvelle tentative dans {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - tentative #{{attempt}}",
  "drift.chat.retry.now": "Nouvelle tentative",
  "drift.chat.retry.providerRejected": "Le fournisseur n'a pas accepté la demande",
  "drift.chat.thinking": "Réflexion",
  "drift.color.accent": "Accentuation",
  "drift.color.background": "Arrière-plan",
  "drift.color.surface": "Surface",
  "drift.color.text": "Texte",
  "drift.composer.anotherThread": "une autre discussion",
  "drift.composer.dropFiles": "Déposez des fichiers pour les joindre",
  "drift.composer.fileReadFailed": "Impossible de lire {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} n'est pas un texte UTF-8 valide",
  "drift.composer.fileTooLarge": "{{filename}} dépasse la limite de {{limit}} pour les fichiers {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} est une archive ou un fichier binaire non pris en charge",
  "drift.composer.folderUnsupported": "Impossible de joindre des dossiers ; déposez plutôt des fichiers individuels",
  "drift.composer.modelUnsupported": "{{model}} n'accepte pas les pièces jointes {{kind}} ({{filename}})",
  "drift.composer.openThread": "Ouvrir cette discussion",
  "drift.composer.pendingInThread": "dans {{thread}}",
  "drift.context.compacted": "Contexte compacté",
  "drift.context.compacting": "Compactage du contexte",
  "drift.context.pending": "L'utilisation apparaît après la première réponse.",
  "drift.context.untilCompaction": "Avant compactage",
  "drift.count.entry.one": "{{count}} entrée",
  "drift.count.entry.other": "{{count}} entrées",
  "drift.count.file.one": "{{count}} fichier",
  "drift.count.file.other": "{{count}} fichiers",
  "drift.count.line.one": "{{count}} ligne",
  "drift.count.line.other": "{{count}} lignes",
  "drift.count.match.one": "{{count}} correspondance",
  "drift.count.match.other": "{{count}} correspondances",
  "drift.count.result.one": "{{count}} résultat",
  "drift.count.result.other": "{{count}} résultats",
  "drift.count.tool.one": "{{count}} outil",
  "drift.count.tool.other": "{{count}} outils",
  "drift.debug.context": "Contexte",
  "drift.file.created": "Créé",
  "drift.file.deleted": "Supprimé",
  "drift.file.moved": "Déplacé",
  ...
  "drift.mcp.authenticate": "Authentifier",
  "drift.mcp.description": "Serveurs Drift globaux et définitions effectives exactes signalées par l'espace de travail actif.",
  ...
  "drift.message.copy": "Copier le message",
  "drift.message.copyResponse": "Copier la réponse",
  ...
  "drift.provider.finishInBrowser": "Terminez la connexion dans le navigateur.",
  "drift.provider.savedUnavailable": "Identifiant enregistré, mais {{provider}} n'est pas devenu disponible.",
  "drift.provider.signInStartFailed": "Impossible de démarrer la procédure de connexion.",
  "drift.provider.signInStartFailedFor": "Impossible de démarrer la procédure de connexion à {{provider}}.",
  "drift.provider.signInWith": "Se connecter avec {{method}}",
  ...
  "drift.question.answerLater": "Répondre plus tard",
  "drift.question.answerNow": "Répondre maintenant",
  ...
  "drift.question.selectMultiple": "Sélectionnez toutes les réponses applicables",
  "drift.question.selectOne": "Sélectionnez une réponse",
  "drift.reasoning.thinking": "Réflexion",
  "drift.reasoning.thought": "Réflexion",
  "drift.reasoning.level.none": "Aucun",
  "drift.reasoning.level.minimal": "Minimal",
  "drift.reasoning.level.low": "Faible",
  "drift.reasoning.level.medium": "Moyen",
  "drift.reasoning.level.high": "Élevé",
  "drift.reasoning.level.xhigh": "Très élevé",
  "drift.reasoning.level.max": "Maximum",
  "drift.settings.customPalette.colorDescription": "Définissez la couleur {{color}}.",
  "drift.settings.customPalette.hexValue": "Valeur hexadécimale de {{color}}",
  "drift.settings.providers.notConnected": "Non connecté",
  ...
  "drift.shortcuts.zoomOut": "Zoom arrière",
  "drift.shortcuts.zoomReset": "Réinitialiser le zoom",
  "drift.sidebar.moveSessionFailed": "Impossible de déplacer la session",
  "drift.sidebar.moveWorkspaceFailed": "Impossible de déplacer l'espace de travail",
  "drift.sidebar.movingSession": "Déplacement de la session vers {{workspace}}...",
  ...
  "drift.sound.group.failure": "Échec",
  "drift.sound.group.information": "Informations",
  "drift.sound.group.mechanical": "Mécaniques",
  "drift.sound.group.success": "Réussite",
  "drift.status.waitingForPermission": "En attente d'une permission",
  "drift.theme.aubergine": "Drift Aubergine",
  "drift.theme.custom": "Personnalisé",
  "drift.theme.dark": "Drift Sombre",
  "drift.theme.forest": "Drift Forêt",
  "drift.theme.graphite": "Drift Graphite",
  "drift.theme.light": "Drift Clair",
  "drift.theme.midnight": "Drift Minuit",
  "drift.theme.paper": "Drift Papier",
  "drift.theme.slate": "Drift Ardoise",
  "drift.thread.backToParent": "Revenir à la discussion d'origine",
  "drift.thread.copyShareLink": "Copier le lien de partage : {{url}}",
  "drift.thread.move": "Déplacer",
  "drift.thread.moveToWorkspace": "Déplacer vers l'espace de travail",
  "drift.thread.noOtherWorkspaces": "Aucun autre espace de travail",
  "drift.thread.openSpawned": "Ouvrir la discussion créée",
  "drift.thread.renameHint": "Double-cliquez pour renommer",
  "drift.thread.shared": "Partagée",
  "drift.thread.waitingForAnswer": "En attente d'une réponse",
  "drift.thread.waitingForPermission": "En attente d'une permission",
  "drift.thread.working": "En cours",
  "drift.tool.called": "Appel",
  "drift.tool.fetch": "Récupérer",
  "drift.tool.asyncQuestion": "Question asynchrone",
  "drift.tool.spawn": "Créer",
  ...
  "drift.workspace.changeImage": "Changer l'image...",
