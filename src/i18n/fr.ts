...
export const drift = {
  ...
  "drift.about.updates.enabled": "Disponibles",
  "drift.about.updates.disabled": "Build local",
  "drift.about.row.website.title": "Site web",
  "drift.about.row.website.description": "Téléchargements, notes de version et la méduse qui a inspiré celle-ci.",
  "drift.about.credits.engine": "Drift fonctionne avec OpenCode. Le moteur fait le plus dur ici, et cette application n'existe que parce que ce travail est assez bon pour servir de base. Un vrai respect aux développeurs d'OpenCode et à tous ceux qui y contribuent.",
  "drift.about.credits.ui": "Drift n'est pas une critique du moteur, seulement une différence de goût : je n'aime tout simplement pas la nouvelle interface, alors Drift garde une enveloppe plus calme et plus dense autour du même moteur.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} dépasse 10 MB",
