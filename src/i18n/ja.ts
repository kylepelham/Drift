...
export const drift = {
  ...
  "drift.about.updates.enabled": "利用可能",
  "drift.about.updates.disabled": "ローカルビルド",
  "drift.about.row.website.title": "ウェブサイト",
  "drift.about.row.website.description": "ダウンロード、リリースノート、そしてこのクラゲの元になったクラゲ。",
  "drift.about.credits.engine": "Drift は OpenCode 上で動作します。難しい部分はエンジンが担っており、このアプリはその成果が土台にできるほど優れているからこそ存在します。OpenCode の開発者と貢献者すべてに心からの敬意を。",
  "drift.about.credits.ui": "Drift はエンジンへの批判ではなく、好みの違いにすぎません。新しい UI がどうも好きになれないので、Drift は同じエンジンの周りに、より静かで密度の高い外殻を保っています。",
  ...
  "drift.composer.fileTooLarge": "{{filename}}は10 MBを超えています",
