...
export const drift = {
  ...
  "drift.preview.mode.all": "すべて",
  "drift.preview.mode.none": "なし",
  "drift.preview.mode.custom": "カスタム",
  "drift.preview.type.markdown": "Markdownファイル",
  "drift.preview.type.pdf": "PDF文書",
  "drift.preview.type.image": "画像",
  "drift.preview.type.text": "テキストとコード",
  "drift.preview.type.table": "表（CSV/TSV）",
  "drift.preview.type.audio": "音声",
  "drift.preview.type.video": "動画",
  "drift.preview.title": "ファイルのプレビュー",
  "drift.preview.htmlRendered": "プレビュー",
  "drift.preview.htmlSource": "HTMLソース",
  "drift.preview.htmlStatic": "静的プレビューです。スクリプト、リンク、外部リソースは無効です。",
  "drift.preview.loading": "プレビューを読み込み中...",
  "drift.preview.error": "プレビューを読み込めませんでした。",
  "drift.preview.openEditor": "エディターで開く",
  "drift.preview.retry": "再試行",
  "drift.preview.previous": "前のページ",
  "drift.preview.next": "次のページ",
  "drift.preview.page": "{{pages}}ページ中{{page}}ページ",
  "drift.preview.zoomIn": "拡大",
  "drift.preview.zoomOut": "縮小",
  "drift.preview.unsupported": "この種類のファイルはプレビューできません。",
  "drift.preview.tooLarge": "ファイルが大きすぎるためプレビューできません。",
  "drift.preview.unavailable": "ファイルのプレビューを利用できません。",
  ...
  "drift.settings.shellTimeout.preset15": "15分",
  "drift.settings.shellTimeout.preset30": "30分",
  "drift.settings.shellTimeout.custom": "カスタム",
  "drift.settings.shellTimeout.customMinutes": "カスタム分数",
  "drift.settings.shellTimeout.customDescription": "1から1,440までの整数を入力してください。",
  "drift.settings.shellTimeout.invalid": "1から1,440までの整数を入力してください。",
  "drift.shell.timeout.limit": "制限 {{duration}}",
  "drift.shell.timeout.expired": "{{duration}}後にタイムアウト",
  "drift.agent.build": "ビルド",
  "drift.agent.plan": "計画",
  "drift.agent.general": "一般",
  ...
  "drift.sidebar.empty": "ワークスペースを追加して始めましょう。",
  "drift.sidebar.resize": "サイドバーのサイズを変更",
  "drift.workspace.showThreads": "スレッドを表示",
  ...
  "drift.composer.connecting": "エンジンに接続中...",
  "drift.composer.thinkingLevel": "思考レベル",
  "drift.permissions.autoGlobal": "権限をグローバルに自動承認中",
  "drift.permissions.autoThread": "このスレッドの権限を自動承認中",
  "drift.prompt.steer": "方向を修正",
  ...
  "drift.about.group.build": "ビルド",
  "drift.about.group.links": "リンク",
  ...
  "drift.about.row.website.description": "ダウンロードとリリースノート。",
  "drift.about.credits.engine": "Drift は OpenCode 上で動作します。難しい部分はエンジンが担っており、このアプリはその素晴らしい成果のおかげで存在しています。OpenCode の開発者と貢献者すべてに心からの敬意を。",
  "drift.archive.deletesInDays": "{{days}}d後に削除",
  ...
  "drift.attachment.image": "画像",
  "drift.attachment.viewImage": "画像を表示",
  ...
  "drift.attachment.pages": "{{count}} ページ",
  "drift.attachment.processing": "読み込み中...",
  "drift.attachment.table": "{{rows}} 行 x {{columns}} 列",
  "drift.chat.empty.noWorkspace": "開始するには、左側でワークスペースを追加または選択してください。",
  "drift.chat.empty.promptHint": "下に入力してください。Enterで送信、Shift+Enterで改行します。",
  "drift.chat.empty.threadHint": "スレッドは左側にあります。タブはありません。今後もずっと。",
  "drift.chat.retry.inSeconds": "{{seconds}}s後に再試行",
  "drift.chat.retry.info": "{{retry}} - 試行 #{{attempt}}",
  "drift.chat.retry.now": "再試行中",
  "drift.chat.retry.providerRejected": "プロバイダーがリクエストを受け付けませんでした",
  "drift.chat.thinking": "思考中",
  "drift.color.accent": "アクセント",
  "drift.color.background": "背景",
  "drift.color.surface": "サーフェス",
  "drift.color.text": "テキスト",
  "drift.composer.anotherThread": "別のスレッド",
  "drift.composer.dropFiles": "ファイルをドロップして添付",
  "drift.composer.fileReadFailed": "{{filename}}を読み取れませんでした",
  "drift.composer.fileInvalidUtf8": "{{filename}}は有効なUTF-8テキストではありません",
  "drift.composer.fileTooLarge": "{{filename}}は{{kind}}ファイルの上限{{limit}}を超えています",
  "drift.composer.fileUnsupported": "{{filename}}は未対応のアーカイブまたはバイナリファイルです",
  "drift.composer.folderUnsupported": "フォルダは添付できません。代わりに個別のファイルをドロップしてください",
  "drift.composer.modelUnsupported": "{{model}}は{{kind}}添付ファイルを受け付けません ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}}件のエントリ",
  "drift.count.file.one": "{{count}}件のファイル",
  "drift.count.file.other": "{{count}}件のファイル",
  "drift.count.line.one": "{{count}}行",
  "drift.count.line.other": "{{count}}行",
  "drift.count.match.one": "{{count}}件の一致",
  "drift.count.match.other": "{{count}}件の一致",
  "drift.count.result.one": "{{count}}件の結果",
  "drift.count.result.other": "{{count}}件の結果",
  "drift.count.tool.one": "{{count}}個のツール",
  "drift.count.tool.other": "{{count}}個のツール",
  "drift.debug.context": "コンテキスト",
  "drift.file.created": "作成",
  "drift.file.deleted": "削除",
  "drift.file.moved": "移動",
  ...
  "drift.message.copy": "メッセージをコピー",
  "drift.message.copyResponse": "応答をコピー",
  ...
  "drift.provider.finishInBrowser": "ブラウザーでサインインを完了してください。",
  "drift.provider.savedUnavailable": "認証情報を保存しましたが、{{provider}}は利用可能になりませんでした。",
  "drift.provider.signInStartFailed": "サインインを開始できませんでした。",
  "drift.provider.signInStartFailedFor": "{{provider}}へのサインインを開始できませんでした。",
  "drift.provider.signInWith": "{{method}}でサインイン",
  "drift.question.custom": "独自の回答を入力",
  "drift.question.answered": "回答済み",
  "drift.question.unanswered": "回答なし",
  "drift.question.answerLater": "後で回答",
  ...
  "drift.question.number": "質問 {{number}}",
  "drift.question.selectMultiple": "該当する回答をすべて選択",
  "drift.question.selectOne": "回答を1つ選択",
  "drift.reasoning.thinking": "思考中",
  "drift.reasoning.thought": "思考",
  "drift.reasoning.level.none": "なし",
  "drift.reasoning.level.minimal": "最小限",
  "drift.reasoning.level.low": "低",
  "drift.reasoning.level.medium": "中",
  "drift.reasoning.level.high": "高",
  "drift.reasoning.level.xhigh": "非常に高い",
  "drift.reasoning.level.max": "最大",
  "drift.settings.customPalette.colorDescription": "{{color}}の色を設定します。",
  "drift.settings.customPalette.hexValue": "{{color}}の16進数値",
  "drift.settings.providers.notConnected": "未接続",
  ...
  "drift.shortcuts.zoomReset": "ズームをリセット",
  "drift.sidebar.moveSessionFailed": "セッションを移動できませんでした",
  "drift.sidebar.moveWorkspaceFailed": "ワークスペースを移動できませんでした",
  "drift.sidebar.movingSession": "セッションを{{workspace}}に移動中...",
  "drift.sidebar.movingWorkspaceSessions": "{{workspace}}のセッションを移動中...",
  "drift.sidebar.offline": "オフライン",
  "drift.sidebar.pathAlreadySaved": "{{path}}はすでに{{workspace}}として保存されています",
  "drift.sidebar.saveWorkspacePathFailed": "新しいワークスペースのパスを保存できませんでした: {{error}}",
  "drift.sidebar.workspaceMovePartial": "ワークスペースの移動は一部のみ適用されました: {{error}}",
  "drift.slash.mcp": "MCPサーバーを管理",
  "drift.slash.workspaceCommand": "ワークスペースコマンド",
  "drift.sound.group.alerts": "アラート",
  "drift.sound.group.failure": "失敗",
  "drift.sound.group.information": "情報",
  "drift.sound.group.mechanical": "機械音",
  "drift.sound.group.success": "成功",
  "drift.status.waitingForPermission": "権限を待機中",
  "drift.theme.aubergine": "Drift オーベルジーヌ",
  "drift.theme.custom": "カスタム",
  "drift.theme.dark": "Drift ダーク",
  "drift.theme.forest": "Drift フォレスト",
  "drift.theme.graphite": "Drift グラファイト",
  "drift.theme.light": "Drift ライト",
  "drift.theme.midnight": "Drift ミッドナイト",
  "drift.theme.paper": "Drift ペーパー",
  "drift.theme.slate": "Drift スレート",
  "drift.thread.backToParent": "このスレッドの作成元に戻る",
  "drift.thread.copyShareLink": "共有リンクをコピー: {{url}}",
  "drift.thread.move": "移動",
  "drift.thread.moveToWorkspace": "ワークスペースに移動",
  "drift.thread.noOtherWorkspaces": "他のワークスペースはありません",
  "drift.thread.openSpawned": "作成されたスレッドを開く",
  "drift.thread.renameHint": "ダブルクリックして名前を変更",
  "drift.thread.shared": "共有済み",
  "drift.thread.waitingForAnswer": "回答を待機中",
  "drift.thread.waitingForPermission": "権限を待機中",
  "drift.thread.working": "処理中",
  "drift.tool.called": "呼び出し",
  "drift.tool.fetch": "取得",
  "drift.tool.asyncQuestion": "非同期の質問",
  "drift.tool.spawn": "作成",
  "drift.tool.subtask": "サブタスク",
  "drift.tool.task": "タスク",
  "drift.voice.input.description": "新しい音声入力の録音に使用するマイクを選択します。",
  "drift.voice.input.missing": "保存したマイクを使用できません。再接続されるまでシステムのデフォルトを使用します。",
  "drift.voice.input.systemDefault": "システムのデフォルト",
  "drift.voice.input.title": "入力デバイス",
  "drift.voice.input.unnamed": "マイク {{index}}",
  "drift.workspace.changeImage": "画像を変更...",
  "drift.workspace.confirmRemove": "もう一度クリックして確認",
  "drift.workspace.move": "移動...",
  "drift.workspace.remove": "削除",
  "drift.workspace.removeHint": "スレッドは7日間保持されます。同じフォルダーを再追加すると復元できます。",
  "drift.workspace.useInitials": "イニシャルを使用",
  "drift.settings.sound.chooseCustom": "カスタムサウンドを選択",
}
