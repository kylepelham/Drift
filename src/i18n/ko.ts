...
export const drift = {
  ...
  "drift.about.updates.enabled": "사용 가능",
  "drift.about.updates.disabled": "로컬 빌드",
  "drift.about.row.website.title": "웹사이트",
  "drift.about.row.website.description": "다운로드, 릴리스 노트, 그리고 이 해파리의 원본이 된 해파리.",
  "drift.about.credits.engine": "Drift는 OpenCode 위에서 실행됩니다. 어려운 부분은 엔진이 맡고 있으며, 이 앱은 그 작업이 기반으로 삼을 만큼 훌륭하기 때문에 존재합니다. OpenCode 개발자와 모든 기여자에게 진심으로 경의를 표합니다.",
  "drift.about.credits.ui": "Drift는 엔진에 대한 비판이 아니라 취향의 차이일 뿐입니다. 새 UI가 그저 마음에 들지 않아서, Drift는 같은 엔진 위에 더 조용하고 밀도 높은 껍데기를 유지합니다.",
  ...
  "drift.composer.fileTooLarge": "{{filename}}이(가) 10 MB를 초과합니다",
