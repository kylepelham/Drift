...
export const drift = {
  "drift.slash.keyboardHint": "Tab으로 자동 완성. Enter로 확인.",
  ...
  "drift.preview.mode.all": "모두",
  "drift.preview.mode.none": "없음",
  "drift.preview.mode.custom": "사용자 지정",
  "drift.preview.type.markdown": "Markdown 파일",
  "drift.preview.type.pdf": "PDF 문서",
  "drift.preview.type.image": "이미지",
  "drift.preview.type.text": "텍스트 및 코드",
  "drift.preview.type.table": "표 (CSV/TSV)",
  "drift.preview.type.audio": "오디오",
  "drift.preview.type.video": "동영상",
  "drift.preview.title": "파일 미리보기",
  "drift.preview.htmlRendered": "미리보기",
  "drift.preview.htmlSource": "HTML 소스",
  "drift.preview.htmlStatic": "정적 미리보기입니다. 스크립트, 링크 및 외부 리소스는 비활성화되어 있습니다.",
  "drift.preview.loading": "미리보기 불러오는 중...",
  "drift.preview.error": "미리보기를 불러오지 못했습니다.",
  "drift.preview.openEditor": "편집기에서 열기",
  "drift.preview.retry": "다시 시도",
  "drift.preview.previous": "이전 페이지",
  "drift.preview.next": "다음 페이지",
  "drift.preview.page": "{{pages}}페이지 중 {{page}}페이지",
  "drift.preview.zoomIn": "확대",
  "drift.preview.zoomOut": "축소",
  "drift.preview.unsupported": "이 파일 형식은 미리볼 수 없습니다.",
  "drift.preview.tooLarge": "파일이 너무 커서 미리볼 수 없습니다.",
  "drift.preview.unavailable": "파일 미리보기를 사용할 수 없습니다.",
  ...
  "drift.settings.shellTimeout.preset15": "15분",
  "drift.settings.shellTimeout.preset30": "30분",
  "drift.settings.shellTimeout.custom": "사용자 지정",
  "drift.settings.shellTimeout.customMinutes": "사용자 지정 분",
  "drift.settings.shellTimeout.customDescription": "1에서 1,440 사이의 정수를 입력하세요.",
  "drift.settings.shellTimeout.invalid": "1에서 1,440 사이의 정수를 입력하세요.",
  "drift.shell.timeout.limit": "제한 {{duration}}",
  "drift.shell.timeout.expired": "{{duration}} 후 시간 초과",
  ...
  "drift.settings.summaries.collapsible.description": "엔진의 압축 요약을 펼칠 수 있는 구분선 아래에 접어 둡니다.",
  "drift.settings.summaries.collapsed.title": "기본적으로 요약 접기",
  "drift.settings.summaries.collapsed.description": "압축 요약을 접힌 상태로 시작합니다.",
  "drift.settings.customPalette": "사용자 지정 팔레트",
  "drift.settings.typography": "타이포그래피",
  "drift.settings.customCss": "사용자 지정 CSS",
  "drift.settings.customCss.description": "Drift 기본 스타일 뒤에 로컬로 적용됩니다. 최대 20 KB입니다.",
  "drift.sidebar.workspaces": "작업 공간",
  "drift.sidebar.archived": "보관된 항목",
  "drift.sidebar.addWorkspace": "작업 공간 추가",
  "drift.sidebar.empty": "작업 공간을 추가하여 시작하세요.",
  "drift.sidebar.resize": "사이드바 크기 조절",
  "drift.workspace.showThreads": "스레드 표시",
  ...
  "drift.composer.connecting": "엔진에 연결 중...",
  "drift.composer.thinkingLevel": "사고 수준",
  "drift.permissions.autoGlobal": "모든 곳에서 권한 자동 승인 중",
  "drift.permissions.autoThread": "이 스레드의 권한 자동 승인 중",
  "drift.prompt.steer": "방향 조정",
  "drift.titlebar.minimize": "최소화",
  ...
  "drift.about.starting": "(시작 중...)",
  "drift.about.group.build": "빌드",
  "drift.about.group.links": "링크",
  ...
  "drift.about.updates.available": "사용 가능",
  "drift.about.updates.unavailable": "로컬 빌드",
  "drift.about.row.website.title": "웹사이트",
  "drift.about.row.website.description": "다운로드 및 릴리스 노트.",
  "drift.about.credits.engine": "Drift는 OpenCode 위에서 실행됩니다. 어려운 부분은 엔진이 맡고 있으며, 이 앱은 그 훌륭한 작업 덕분에 존재합니다. OpenCode 개발자와 모든 기여자에게 진심으로 경의를 표합니다.",
  "drift.archive.deletesInDays": "{{days}}일 후 삭제",
  ...
  "drift.attachment.image": "이미지",
  "drift.attachment.viewImage": "이미지 보기",
  ...
  "drift.attachment.pages": "{{count}}페이지",
  "drift.attachment.processing": "읽는 중...",
  "drift.attachment.table": "{{rows}}행 x {{columns}}열",
  "drift.chat.empty.noWorkspace": "시작하려면 왼쪽에서 작업 공간을 추가하거나 선택하세요.",
  "drift.chat.empty.promptHint": "아래에 입력하세요. Enter로 전송하고 Shift+Enter로 줄을 바꿉니다.",
  "drift.chat.empty.threadHint": "스레드는 왼쪽에 있습니다. 탭은 없습니다. 절대로요.",
  "drift.chat.retry.inSeconds": "{{seconds}}초 후 재시도",
  "drift.chat.retry.info": "{{retry}} - 시도 #{{attempt}}",
  "drift.chat.retry.now": "재시도 중",
  "drift.chat.retry.providerRejected": "공급자가 요청을 수락하지 않았습니다",
  "drift.chat.thinking": "생각 중",
  "drift.color.accent": "강조색",
  "drift.color.background": "배경",
  "drift.color.surface": "표면",
  "drift.color.text": "텍스트",
  "drift.composer.anotherThread": "다른 스레드",
  "drift.composer.dropFiles": "파일을 드롭하여 첨부",
  "drift.composer.fileReadFailed": "{{filename}}을(를) 읽을 수 없습니다",
  "drift.composer.fileInvalidUtf8": "{{filename}}은(는) 올바른 UTF-8 텍스트가 아닙니다",
  "drift.composer.fileTooLarge": "{{filename}}이(가) {{kind}} 파일의 {{limit}} 제한을 초과합니다",
  "drift.composer.fileUnsupported": "{{filename}}은(는) 지원되지 않는 압축 또는 바이너리 파일입니다",
  "drift.composer.folderUnsupported": "폴더는 첨부할 수 없습니다. 대신 개별 파일을 드롭하세요",
  "drift.composer.modelUnsupported": "{{model}}은(는) {{kind}} 첨부 파일을 지원하지 않습니다 ({{filename}})",
  ...
  "drift.count.entry.other": "항목 {{count}}개",
  "drift.count.file.one": "파일 {{count}}개",
  "drift.count.file.other": "파일 {{count}}개",
  "drift.count.line.one": "줄 {{count}}개",
  "drift.count.line.other": "줄 {{count}}개",
  "drift.count.match.one": "일치 {{count}}개",
  "drift.count.match.other": "일치 {{count}}개",
  "drift.count.result.one": "결과 {{count}}개",
  "drift.count.result.other": "결과 {{count}}개",
  "drift.count.tool.one": "도구 {{count}}개",
  "drift.count.tool.other": "도구 {{count}}개",
  "drift.debug.context": "컨텍스트",
  "drift.file.created": "생성됨",
  "drift.file.deleted": "삭제됨",
  "drift.file.moved": "이동됨",
  ...
  "drift.message.copy": "메시지 복사",
  "drift.message.copyResponse": "응답 복사",
  "drift.message.duration.hours": "{{hours}}시간 {{minutes}}분",
  ...
  "drift.provider.finishInBrowser": "브라우저에서 로그인을 완료하세요.",
  "drift.provider.savedUnavailable": "자격 증명은 저장되었지만 {{provider}}을(를) 사용할 수 없습니다.",
  "drift.provider.signInStartFailed": "로그인 절차를 시작할 수 없습니다.",
  "drift.provider.signInStartFailedFor": "{{provider}} 로그인 절차를 시작할 수 없습니다.",
  "drift.provider.signInWith": "{{method}}로 로그인",
  "drift.question.custom": "직접 답변 입력",
  "drift.question.answered": "답변 완료",
  "drift.question.unanswered": "답변 없음",
  "drift.question.answerLater": "나중에 답변",
  "drift.question.answerNow": "지금 답변",
  "drift.question.asyncHint": "결정하는 동안 답변에 의존하지 않는 작업은 계속 진행할 수 있습니다.",
  "drift.question.blocking": "답변 대기 중",
  "drift.question.pending": "대기 중인 요청: {{count}}개",
  "drift.question.sendFailed": "답변을 보낼 수 없습니다. 입력한 답변은 그대로 남아 있습니다. 다시 제출하세요.",
  "drift.question.sending": "전송 중...",
  "drift.question.customHint": "위 목록에 없는 답변 추가",
  "drift.question.customPlaceholder": "직접 답변을 입력하세요...",
  "drift.question.number": "질문 {{number}}",
  "drift.question.selectMultiple": "해당하는 답변을 모두 선택하세요",
  "drift.question.selectOne": "답변 하나를 선택하세요",
  "drift.reasoning.thinking": "생각 중",
  "drift.reasoning.thought": "생각",
  "drift.reasoning.level.none": "없음",
  "drift.reasoning.level.minimal": "최소",
  "drift.reasoning.level.low": "낮음",
  "drift.reasoning.level.medium": "보통",
  "drift.reasoning.level.high": "높음",
  "drift.reasoning.level.xhigh": "매우 높음",
  "drift.reasoning.level.max": "최대",
  "drift.settings.customPalette.colorDescription": "{{color}} 색상을 설정합니다.",
  "drift.settings.customPalette.hexValue": "{{color}} 16진수 값",
  "drift.settings.providers.notConnected": "연결되지 않음",
  ...
  "drift.shortcuts.zoomOut": "축소",
  "drift.shortcuts.zoomReset": "확대/축소 초기화",
  "drift.sidebar.moveSessionFailed": "세션을 이동할 수 없습니다",
  "drift.sidebar.moveWorkspaceFailed": "작업 공간을 이동할 수 없습니다",
  "drift.sidebar.movingSession": "세션을 {{workspace}}(으)로 이동 중...",
  "drift.sidebar.movingWorkspaceSessions": "{{workspace}} 세션 이동 중...",
  "drift.sidebar.offline": "오프라인",
  "drift.sidebar.pathAlreadySaved": "{{path}}은(는) 이미 {{workspace}}(으)로 저장되어 있습니다",
  "drift.sidebar.saveWorkspacePathFailed": "새 작업 공간 경로를 저장할 수 없습니다: {{error}}",
  "drift.sidebar.workspaceMovePartial": "작업 공간 이동이 일부만 적용되었습니다: {{error}}",
  "drift.slash.mcp": "MCP 서버 관리",
  "drift.slash.workspaceCommand": "작업 공간 명령",
  "drift.sound.group.alerts": "알림",
  "drift.sound.group.failure": "실패",
  "drift.sound.group.information": "정보",
  "drift.sound.group.mechanical": "기계음",
  "drift.sound.group.success": "성공",
  "drift.status.waitingForPermission": "권한 대기 중",
  "drift.theme.aubergine": "Drift 오베르진",
  "drift.theme.custom": "사용자 지정",
  "drift.theme.dark": "Drift 다크",
  "drift.theme.forest": "Drift 포레스트",
  "drift.theme.graphite": "Drift 그래파이트",
  "drift.theme.light": "Drift 라이트",
  "drift.theme.midnight": "Drift 미드나이트",
  "drift.theme.paper": "Drift 페이퍼",
  "drift.theme.slate": "Drift 슬레이트",
  "drift.thread.backToParent": "이 스레드를 생성한 스레드로 돌아가기",
  "drift.thread.copyShareLink": "공유 링크 복사: {{url}}",
  "drift.thread.move": "이동",
  "drift.thread.moveToWorkspace": "작업 공간으로 이동",
  "drift.thread.noOtherWorkspaces": "다른 작업 공간 없음",
  "drift.thread.openSpawned": "생성된 스레드 열기",
  "drift.thread.renameHint": "두 번 클릭하여 이름 바꾸기",
  "drift.thread.shared": "공유됨",
  "drift.thread.waitingForAnswer": "답변 대기 중",
  "drift.thread.waitingForPermission": "권한 대기 중",
  "drift.thread.working": "작업 중",
  "drift.tool.called": "호출됨",
  "drift.tool.fetch": "가져오기",
  "drift.tool.asyncQuestion": "비동기 질문",
  "drift.tool.spawn": "생성",
  "drift.tool.subtask": "하위 작업",
  "drift.tool.task": "작업",
  "drift.voice.input.description": "새 받아쓰기 녹음에 사용할 마이크를 선택하세요.",
  "drift.voice.input.missing": "저장된 마이크를 사용할 수 없습니다. 다시 연결될 때까지 시스템 기본값을 사용합니다.",
  "drift.voice.input.systemDefault": "시스템 기본값",
  "drift.voice.input.title": "입력 장치",
  "drift.voice.input.unnamed": "마이크 {{index}}",
  "drift.workspace.changeImage": "이미지 변경...",
  "drift.workspace.confirmRemove": "확인하려면 다시 클릭",
  "drift.workspace.move": "이동...",
  "drift.workspace.remove": "제거",
  "drift.workspace.removeHint": "스레드는 7일간 보관됩니다. 같은 폴더를 다시 추가하면 복원됩니다.",
  "drift.workspace.useInitials": "이니셜 사용",
}
