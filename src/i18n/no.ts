...
export const drift = {
  ...
  "drift.preview.mode.all": "Alle",
  "drift.preview.mode.none": "Ingen",
  "drift.preview.mode.custom": "Tilpasset",
  "drift.preview.type.markdown": "Markdown-filer",
  "drift.preview.type.pdf": "PDF-dokumenter",
  "drift.preview.type.image": "Bilder",
  "drift.preview.type.text": "Tekst og kode",
  "drift.preview.type.table": "Tabeller (CSV/TSV)",
  "drift.preview.type.audio": "Lyd",
  "drift.preview.type.video": "Video",
  "drift.preview.title": "Filforhåndsvisning",
  "drift.preview.htmlRendered": "Forhåndsvisning",
  "drift.preview.htmlSource": "HTML-kilde",
  "drift.preview.htmlStatic": "Statisk forhåndsvisning. Skript, lenker og eksterne ressurser er deaktivert.",
  "drift.preview.loading": "Laster forhåndsvisning...",
  "drift.preview.error": "Kunne ikke laste forhåndsvisningen.",
  "drift.preview.openEditor": "Åpne i redigeringsprogram",
  "drift.preview.retry": "Prøv igjen",
  "drift.preview.previous": "Forrige side",
  "drift.preview.next": "Neste side",
  "drift.preview.page": "Side {{page}} av {{pages}}",
  "drift.preview.zoomIn": "Zoom inn",
  "drift.preview.zoomOut": "Zoom ut",
  "drift.preview.unsupported": "Denne filtypen kan ikke forhåndsvises.",
  "drift.preview.tooLarge": "Denne filen er for stor til forhåndsvisning.",
  "drift.preview.unavailable": "Filforhåndsvisning er ikke tilgjengelig.",
  ...
  "drift.settings.shellTimeout.preset15": "15 minutter",
  "drift.settings.shellTimeout.preset30": "30 minutter",
  "drift.settings.shellTimeout.custom": "Egendefinert",
  "drift.settings.shellTimeout.customMinutes": "Egendefinerte minutter",
  "drift.settings.shellTimeout.customDescription": "Skriv inn et heltall fra 1 til 1 440 minutter.",
  "drift.settings.shellTimeout.invalid": "Skriv inn et heltall fra 1 til 1 440.",
  "drift.shell.timeout.limit": "Grense {{duration}}",
  "drift.shell.timeout.expired": "Tidsavbrudd etter {{duration}}",
  "drift.agent.build": "Bygg",
  "drift.agent.plan": "Plan",
  "drift.agent.general": "Generell",
  ...
  "drift.settings.summaries.collapsible.description":
    "Legg motorens komprimeringssammendrag bak en skillelinje som kan utvides.",
  "drift.settings.summaries.collapsed.title": "Skjul sammendrag som standard",
  "drift.settings.summaries.collapsed.description": "Start med komprimeringssammendrag skjult.",
  "drift.settings.customPalette": "Egendefinert palett",
  "drift.settings.typography": "Typografi",
  "drift.settings.customCss": "Egendefinert CSS",
  "drift.settings.customCss.description": "Brukes lokalt etter Drifts innebygde stiler. Begrenset til 20 kB.",
  "drift.sidebar.workspaces": "Arbeidsområder",
  "drift.sidebar.archived": "Arkiverte elementer",
  "drift.sidebar.addWorkspace": "Legg til arbeidsområde",
  "drift.sidebar.empty": "Legg til et arbeidsområde for å komme i gang.",
  "drift.sidebar.resize": "Endre størrelsen på sidepanelet",
  "drift.workspace.showThreads": "Vis tråder",
  ...
  "drift.composer.connecting": "Kobler til motoren...",
  "drift.composer.thinkingLevel": "Resonneringsnivå",
  "drift.permissions.autoGlobal": "Godtar tillatelser automatisk globalt",
  "drift.permissions.autoThread": "Godtar tillatelser automatisk for denne tråden",
  "drift.prompt.steer": "Styr",
  "drift.titlebar.minimize": "Minimer",
  ...
  "drift.about.starting": "(starter...)",
  "drift.about.group.build": "Bygg",
  "drift.about.group.links": "Lenker",
  ...
  "drift.about.updates.available": "Tilgjengelige",
  "drift.about.updates.unavailable": "Lokalt build",
  "drift.about.row.website.title": "Nettsted",
  "drift.about.row.website.description": "Nedlastinger og utgivelsesnotater.",
  "drift.about.credits.engine": "Drift kjører på OpenCode. Motoren gjør den vanskelige delen her, og denne appen finnes bare takket være det fantastiske arbeidet. Ekte respekt til OpenCode-utviklerne og alle som bidrar til det.",
  "drift.archive.deletesInDays": "Slettes om {{days}} d",
  ...
  "drift.attachment.image": "bilde",
  "drift.attachment.viewImage": "Vis bilde",
  ...
  "drift.attachment.pages": "{{count}} sider",
  "drift.attachment.processing": "Leser...",
  "drift.attachment.table": "{{rows}} rader x {{columns}} kolonner",
  "drift.chat.empty.noWorkspace": "Legg til eller velg et arbeidsområde til venstre for å starte.",
  "drift.chat.empty.promptHint": "Begynn å skrive nedenfor. Enter sender, Shift+Enter gir linjeskift.",
  "drift.chat.empty.threadHint": "Trådene ligger til venstre. Ingen faner. Aldri.",
  "drift.chat.retry.inSeconds": "Prøver på nytt om {{seconds}} s",
  "drift.chat.retry.info": "{{retry}} - forsøk #{{attempt}}",
  "drift.chat.retry.now": "Prøver på nytt",
  "drift.chat.retry.providerRejected": "Leverandøren godtok ikke forespørselen",
  "drift.chat.thinking": "Tenker",
  "drift.color.accent": "Aksent",
  "drift.color.background": "Bakgrunn",
  "drift.color.surface": "Overflate",
  "drift.color.text": "Tekst",
  "drift.composer.anotherThread": "en annen tråd",
  "drift.composer.dropFiles": "Slipp filer for å legge ved",
  "drift.composer.fileReadFailed": "Kunne ikke lese {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} er ikke gyldig UTF-8-tekst",
  "drift.composer.fileTooLarge": "{{filename}} overskrider grensen på {{limit}} for {{kind}}-filer",
  "drift.composer.fileUnsupported": "{{filename}} er et arkiv eller en binærfil som ikke støttes",
  "drift.composer.folderUnsupported": "Mapper kan ikke legges ved; slipp enkeltfiler i stedet",
  "drift.composer.modelUnsupported": "{{model}} godtar ikke {{kind}}-vedlegg ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} oppføringer",
  "drift.count.file.one": "{{count}} fil",
  "drift.count.file.other": "{{count}} filer",
  "drift.count.line.one": "{{count}} linje",
  "drift.count.line.other": "{{count}} linjer",
  "drift.count.match.one": "{{count}} treff",
  "drift.count.match.other": "{{count}} treff",
  "drift.count.result.one": "{{count}} resultat",
  "drift.count.result.other": "{{count}} resultater",
  "drift.count.tool.one": "{{count}} verktøy",
  "drift.count.tool.other": "{{count}} verktøy",
  "drift.debug.context": "Kontekst",
  "drift.file.created": "Opprettet",
  "drift.file.deleted": "Slettet",
  "drift.file.moved": "Flyttet",
  ...
  "drift.mcp.authenticate": "Autentiser",
  ...
  "drift.message.copy": "Kopier melding",
  "drift.message.copyResponse": "Kopier svar",
  "drift.message.duration.hours": "{{hours}} t {{minutes}} min",
  ...
  "drift.provider.finishInBrowser": "Fullfør innloggingen i nettleseren.",
  "drift.provider.savedUnavailable": "Legitimasjonen ble lagret, men {{provider}} ble ikke tilgjengelig.",
  "drift.provider.signInStartFailed": "Kunne ikke starte innloggingen.",
  "drift.provider.signInStartFailedFor": "Kunne ikke starte innloggingen for {{provider}}.",
  "drift.provider.signInWith": "Logg inn med {{method}}",
  "drift.question.custom": "Skriv ditt eget svar",
  "drift.question.answered": "Besvart",
  "drift.question.unanswered": "Ingen svar",
  "drift.question.answerLater": "Svar senere",
  "drift.question.answerNow": "Svar nå",
  "drift.question.asyncHint": "Arbeid som ikke avhenger av svaret ditt, kan fortsette mens du bestemmer deg.",
  "drift.question.blocking": "Venter på svar",
  "drift.question.pending": "Ventende forespørsler: {{count}}",
  "drift.question.sendFailed": "Kunne ikke sende svaret ditt. Svarene dine er fortsatt her. Prøv å sende på nytt.",
  "drift.question.sending": "Sender...",
  "drift.question.customHint": "Legg til et svar som ikke er oppført ovenfor",
  "drift.question.customPlaceholder": "Skriv ditt eget svar...",
  "drift.question.number": "Spørsmål {{number}}",
  "drift.question.selectMultiple": "Velg alle svar som passer",
  "drift.question.selectOne": "Velg ett svar",
  "drift.reasoning.thinking": "Tenker",
  "drift.reasoning.thought": "Tanke",
  "drift.reasoning.level.none": "Ingen",
  "drift.reasoning.level.minimal": "Minimal",
  "drift.reasoning.level.low": "Lav",
  "drift.reasoning.level.medium": "Middels",
  "drift.reasoning.level.high": "Høy",
  "drift.reasoning.level.xhigh": "Svært høy",
  "drift.reasoning.level.max": "Maksimal",
  "drift.settings.customPalette.colorDescription": "Angi fargen {{color}}.",
  "drift.settings.customPalette.hexValue": "Heksadesimal verdi for {{color}}",
  "drift.settings.providers.notConnected": "Ikke tilkoblet",
  ...
  "drift.shortcuts.zoomOut": "Zoom ut",
  "drift.shortcuts.zoomReset": "Tilbakestill zoom",
  "drift.sidebar.moveSessionFailed": "Kunne ikke flytte sesjonen",
  "drift.sidebar.moveWorkspaceFailed": "Kunne ikke flytte arbeidsområdet",
  "drift.sidebar.movingSession": "Flytter sesjonen til {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Flytter sesjoner fra {{workspace}}...",
  "drift.sidebar.offline": "frakoblet",
  "drift.sidebar.pathAlreadySaved": "{{path}} er allerede lagret som {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Kunne ikke lagre den nye banen til arbeidsområdet: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Flyttingen av arbeidsområdet ble bare delvis utført: {{error}}",
  "drift.slash.mcp": "Administrer MCP-servere",
  "drift.slash.workspaceCommand": "arbeidsområdekommando",
  "drift.sound.group.alerts": "Varsler",
  "drift.sound.group.failure": "Feil",
  "drift.sound.group.information": "Informasjon",
  "drift.sound.group.mechanical": "Mekanisk",
  "drift.sound.group.success": "Vellykket",
  "drift.status.waitingForPermission": "Venter på tillatelse",
  "drift.theme.aubergine": "Drift Aubergine",
  "drift.theme.custom": "Egendefinert",
  "drift.theme.dark": "Drift Mørk",
  "drift.theme.forest": "Drift Skog",
  "drift.theme.graphite": "Drift Grafitt",
  "drift.theme.light": "Drift Lys",
  "drift.theme.midnight": "Drift Midnatt",
  "drift.theme.paper": "Drift Papir",
  "drift.theme.slate": "Drift Skifer",
  "drift.thread.backToParent": "Tilbake til tråden denne ble opprettet fra",
  "drift.thread.copyShareLink": "Kopier delingslenke: {{url}}",
  "drift.thread.move": "Flytt",
  "drift.thread.moveToWorkspace": "Flytt til arbeidsområde",
  "drift.thread.noOtherWorkspaces": "Ingen andre arbeidsområder",
  "drift.thread.openSpawned": "Åpne opprettet tråd",
  "drift.thread.renameHint": "Dobbeltklikk for å gi nytt navn",
  "drift.thread.shared": "Delt",
  "drift.thread.waitingForAnswer": "Venter på svar",
  "drift.thread.waitingForPermission": "Venter på tillatelse",
  "drift.thread.working": "Arbeider",
  "drift.tool.called": "Kalt",
  "drift.tool.fetch": "Hent",
  "drift.tool.asyncQuestion": "Asynkront spørsmål",
  "drift.tool.spawn": "Opprett",
  ...
  "drift.workspace.changeImage": "Endre bilde...",
  "drift.workspace.confirmRemove": "Klikk igjen for å bekrefte",
  "drift.workspace.move": "Flytt...",
  "drift.workspace.remove": "Fjern",
  "drift.workspace.removeHint": "Tråder beholdes i 7 dager. Legg til samme mappe igjen for å gjenopprette dem.",
  "drift.workspace.useInitials": "Bruk initialer",
}
