...
export const drift = {
  ...
  "drift.about.row.website.description": "Nedlastinger, utgivelsesnotater og maneten som inspirerte denne.",
  "drift.about.credits.engine": "Drift kjører på OpenCode. Motoren gjør den vanskelige delen her, og denne appen finnes bare fordi det arbeidet er godt nok å bygge på. Ekte respekt til OpenCode-utviklerne og alle som bidrar til det.",
  "drift.about.credits.ui": "Drift er ingen kritikk av motoren, bare en forskjell i smak: jeg liker rett og slett ikke det nye grensesnittet, så Drift beholder et roligere og tettere skall rundt samme motor.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} er større enn 10 MB",
