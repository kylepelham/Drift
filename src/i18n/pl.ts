...
export const drift = {
  ...
  "drift.about.row.website.description": "Pliki do pobrania, informacje o wydaniach i meduza, która zainspirowała tę tutaj.",
  "drift.about.credits.engine": "Drift działa na OpenCode. Silnik wykonuje tu najtrudniejszą część, a ta aplikacja istnieje tylko dlatego, że ta praca jest wystarczająco dobra, by na niej budować. Prawdziwy szacunek dla twórców OpenCode i wszystkich, którzy go współtworzą.",
  "drift.about.credits.ui": "Drift nie jest krytyką silnika, tylko różnicą gustu: po prostu nie przekonuje mnie nowy interfejs, więc Drift zachowuje spokojniejszą i gęstszą powłokę wokół tego samego silnika.",
  ...
  "drift.composer.fileTooLarge": "Plik {{filename}} przekracza 10 MB",
