...
export const drift = {
  "drift.slash.keyboardHint": "Tab uzupełnia. Enter potwierdza.",
  ...
  "drift.preview.mode.all": "Wszystkie",
  "drift.preview.mode.none": "Żadne",
  "drift.preview.mode.custom": "Niestandardowe",
  "drift.preview.type.markdown": "Pliki Markdown",
  "drift.preview.type.pdf": "Dokumenty PDF",
  "drift.preview.type.image": "Obrazy",
  "drift.preview.type.text": "Tekst i kod",
  "drift.preview.type.table": "Tabele (CSV/TSV)",
  "drift.preview.type.audio": "Dźwięk",
  "drift.preview.type.video": "Wideo",
  "drift.preview.title": "Podgląd pliku",
  "drift.preview.htmlRendered": "Podgląd",
  "drift.preview.htmlSource": "Źródło HTML",
  "drift.preview.htmlStatic": "Podgląd statyczny. Skrypty, odnośniki i zasoby zewnętrzne są wyłączone.",
  "drift.preview.loading": "Ładowanie podglądu...",
  "drift.preview.error": "Nie udało się załadować podglądu.",
  "drift.preview.openEditor": "Otwórz w edytorze",
  "drift.preview.retry": "Spróbuj ponownie",
  "drift.preview.previous": "Poprzednia strona",
  "drift.preview.next": "Następna strona",
  "drift.preview.page": "Strona {{page}} z {{pages}}",
  "drift.preview.zoomIn": "Powiększ",
  "drift.preview.zoomOut": "Pomniejsz",
  "drift.preview.unsupported": "Nie można wyświetlić podglądu tego typu pliku.",
  "drift.preview.tooLarge": "Ten plik jest zbyt duży, aby wyświetlić podgląd.",
  "drift.preview.unavailable": "Podgląd pliku jest niedostępny.",
  ...
  "drift.settings.shellTimeout.preset15": "15 minut",
  "drift.settings.shellTimeout.preset30": "30 minut",
  "drift.settings.shellTimeout.custom": "Niestandardowy",
  "drift.settings.shellTimeout.customMinutes": "Niestandardowa liczba minut",
  "drift.settings.shellTimeout.customDescription": "Wpisz liczbę całkowitą od 1 do 1440 minut.",
  "drift.settings.shellTimeout.invalid": "Wpisz liczbę całkowitą od 1 do 1440.",
  "drift.shell.timeout.limit": "Limit {{duration}}",
  "drift.shell.timeout.expired": "Przekroczono czas po {{duration}}",
  "drift.agent.build": "Budowanie",
  "drift.agent.plan": "Planowanie",
  "drift.agent.general": "Ogólny",
  ...
  "drift.settings.summaries.collapsible.title": "Zwijane podsumowania kompresji",
  "drift.settings.summaries.collapsible.description":
    "Ukrywaj podsumowania kompresji silnika za rozwijanym separatorem.",
  "drift.settings.summaries.collapsed.title": "Domyślnie zwijaj podsumowania",
  "drift.settings.summaries.collapsed.description": "Podsumowania kompresji są początkowo zwinięte.",
  "drift.settings.customPalette": "Niestandardowa paleta",
  "drift.settings.typography": "Typografia",
  "drift.settings.customCss": "Niestandardowy CSS",
  "drift.settings.customCss.description": "Stosowany lokalnie po wbudowanych stylach Drift. Limit: 20 KB.",
  "drift.sidebar.workspaces": "Obszary robocze",
  "drift.sidebar.archived": "Zarchiwizowane elementy",
  "drift.sidebar.addWorkspace": "Dodaj obszar roboczy",
  "drift.sidebar.empty": "Dodaj obszar roboczy, aby rozpocząć.",
  "drift.sidebar.resize": "Zmień szerokość paska bocznego",
  "drift.workspace.showThreads": "Pokaż wątki",
  ...
  "drift.composer.connecting": "Łączenie z silnikiem...",
  "drift.composer.thinkingLevel": "Poziom rozumowania",
  "drift.permissions.autoGlobal": "Automatyczne akceptowanie uprawnień globalnie",
  "drift.permissions.autoThread": "Automatyczne akceptowanie uprawnień w tym wątku",
  "drift.prompt.steer": "Pokieruj",
  "drift.titlebar.minimize": "Minimalizuj",
  ...
  "drift.about.starting": "(uruchamianie...)",
  "drift.about.group.build": "Kompilacja",
  "drift.about.group.links": "Linki",
  ...
  "drift.about.updates.available": "Dostępne",
  "drift.about.updates.unavailable": "Kompilacja lokalna",
  "drift.about.row.website.title": "Witryna",
  "drift.about.row.website.description": "Pliki do pobrania i informacje o wydaniach.",
  "drift.about.credits.engine": "Drift działa na OpenCode. Silnik wykonuje tu najtrudniejszą część, a ta aplikacja istnieje tylko dzięki tej znakomitej pracy. Prawdziwy szacunek dla twórców OpenCode i wszystkich, którzy go współtworzą.",
  "drift.archive.deletesInDays": "Usunięcie za {{days}} d",
  ...
  "drift.attachment.image": "obraz",
  "drift.attachment.viewImage": "Pokaż obraz",
  ...
  "drift.attachment.pages": "{{count}} stron",
  "drift.attachment.processing": "Odczytywanie...",
  "drift.attachment.table": "{{rows}} wierszy x {{columns}} kolumn",
  "drift.chat.empty.noWorkspace": "Aby rozpocząć, dodaj lub wybierz obszar roboczy po lewej.",
  "drift.chat.empty.promptHint": "Zacznij pisać poniżej. Enter wysyła, Shift+Enter wstawia nowy wiersz.",
  "drift.chat.empty.threadHint": "Wątki są po lewej. Bez kart. Nigdy.",
  "drift.chat.retry.inSeconds": "Ponowienie za {{seconds}} s",
  "drift.chat.retry.info": "{{retry}} - próba #{{attempt}}",
  "drift.chat.retry.now": "Ponawianie",
  "drift.chat.retry.providerRejected": "Dostawca nie zaakceptował żądania",
  "drift.chat.thinking": "Myślenie",
  "drift.color.accent": "Akcent",
  "drift.color.background": "Tło",
  "drift.color.surface": "Powierzchnia",
  "drift.color.text": "Tekst",
  "drift.composer.anotherThread": "inny wątek",
  "drift.composer.dropFiles": "Upuść pliki, aby je załączyć",
  "drift.composer.fileReadFailed": "Nie można odczytać pliku {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} nie jest prawidłowym tekstem UTF-8",
  "drift.composer.fileTooLarge": "{{filename}} przekracza limit {{limit}} dla plików {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} jest nieobsługiwanym archiwum lub plikiem binarnym",
  "drift.composer.folderUnsupported": "Nie można załączać folderów; zamiast tego upuść pojedyncze pliki",
  "drift.composer.modelUnsupported": "{{model}} nie obsługuje załączników {{kind}} ({{filename}})",
  "drift.composer.openThread": "Otwórz ten wątek",
  "drift.composer.pendingInThread": "w {{thread}}",
  "drift.context.compacted": "Kontekst skompaktowany",
  "drift.context.compacting": "Kompaktowanie kontekstu",
  "drift.context.pending": "Użycie pojawi się po pierwszej odpowiedzi.",
  "drift.context.untilCompaction": "Do kompaktowania",
  "drift.count.entry.one": "{{count}} wpis",
  "drift.count.entry.other": "{{count}} wpisów",
  "drift.count.file.one": "{{count}} plik",
  "drift.count.file.other": "{{count}} plików",
  "drift.count.line.one": "{{count}} wiersz",
  "drift.count.line.other": "{{count}} wierszy",
  "drift.count.match.one": "{{count}} dopasowanie",
  "drift.count.match.other": "{{count}} dopasowań",
  "drift.count.result.one": "{{count}} wynik",
  "drift.count.result.other": "{{count}} wyników",
  "drift.count.tool.one": "{{count}} narzędzie",
  "drift.count.tool.other": "{{count}} narzędzi",
  "drift.debug.context": "Kontekst",
  "drift.file.created": "Utworzono",
  "drift.file.deleted": "Usunięto",
  "drift.file.moved": "Przeniesiono",
  ...
  "drift.mcp.authenticate": "Uwierzytelnij",
  ...
  "drift.message.copy": "Kopiuj wiadomość",
  "drift.message.copyResponse": "Kopiuj odpowiedź",
  "drift.message.duration.hours": "{{hours}} godz. {{minutes}} min",
  ...
  "drift.provider.finishInBrowser": "Dokończ logowanie w przeglądarce.",
  "drift.provider.savedUnavailable": "Dane logowania zapisano, ale {{provider}} nie jest dostępny.",
  "drift.provider.signInStartFailed": "Nie można rozpocząć logowania.",
  "drift.provider.signInStartFailedFor": "Nie można rozpocząć logowania do {{provider}}.",
  "drift.provider.signInWith": "Zaloguj się przez {{method}}",
  ...
  "drift.question.number": "Pytanie {{number}}",
  "drift.question.selectMultiple": "Wybierz wszystkie pasujące odpowiedzi",
  "drift.question.selectOne": "Wybierz jedną odpowiedź",
  "drift.reasoning.thinking": "Myślenie",
  "drift.reasoning.thought": "Myśl",
  "drift.reasoning.level.none": "Brak",
  "drift.reasoning.level.minimal": "Minimalny",
  "drift.reasoning.level.low": "Niski",
  "drift.reasoning.level.medium": "Średni",
  "drift.reasoning.level.high": "Wysoki",
  "drift.reasoning.level.xhigh": "Bardzo wysoki",
  "drift.reasoning.level.max": "Maksymalny",
  "drift.settings.customPalette.colorDescription": "Ustaw kolor {{color}}.",
  "drift.settings.customPalette.hexValue": "Wartość szesnastkowa koloru {{color}}",
  "drift.settings.providers.notConnected": "Nie połączono",
  ...
  "drift.shortcuts.zoomOut": "Pomniejsz",
  "drift.shortcuts.zoomReset": "Resetuj powiększenie",
  "drift.sidebar.moveSessionFailed": "Nie można przenieść sesji",
  "drift.sidebar.moveWorkspaceFailed": "Nie można przenieść obszaru roboczego",
  "drift.sidebar.movingSession": "Przenoszenie sesji do {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Przenoszenie sesji z {{workspace}}...",
  "drift.sidebar.offline": "offline",
  "drift.sidebar.pathAlreadySaved": "Ścieżka {{path}} jest już zapisana jako {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Nie można zapisać nowej ścieżki obszaru roboczego: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Przenoszenie obszaru roboczego wykonano tylko częściowo: {{error}}",
  "drift.slash.mcp": "Zarządzaj serwerami MCP",
  "drift.slash.workspaceCommand": "polecenie obszaru roboczego",
  "drift.sound.group.alerts": "Alerty",
  "drift.sound.group.failure": "Niepowodzenie",
  "drift.sound.group.information": "Informacje",
  "drift.sound.group.mechanical": "Mechaniczne",
  "drift.sound.group.success": "Sukces",
  "drift.status.waitingForPermission": "Oczekiwanie na uprawnienie",
  "drift.theme.aubergine": "Drift Bakłażanowy",
  "drift.theme.custom": "Niestandardowy",
  "drift.theme.dark": "Drift Ciemny",
  "drift.theme.forest": "Drift Leśny",
  "drift.theme.graphite": "Drift Grafitowy",
  "drift.theme.light": "Drift Jasny",
  "drift.theme.midnight": "Drift Północny",
  "drift.theme.paper": "Drift Papierowy",
  "drift.theme.slate": "Drift Łupkowy",
  "drift.thread.backToParent": "Wróć do wątku, z którego utworzono ten wątek",
  "drift.thread.copyShareLink": "Kopiuj link udostępniania: {{url}}",
  "drift.thread.move": "Przenieś",
  "drift.thread.moveToWorkspace": "Przenieś do obszaru roboczego",
  "drift.thread.noOtherWorkspaces": "Brak innych obszarów roboczych",
  "drift.thread.openSpawned": "Otwórz utworzony wątek",
  "drift.thread.renameHint": "Kliknij dwukrotnie, aby zmienić nazwę",
  "drift.thread.shared": "Udostępniony",
  "drift.thread.waitingForAnswer": "Oczekiwanie na odpowiedź",
  "drift.thread.waitingForPermission": "Oczekiwanie na uprawnienie",
  "drift.thread.working": "Pracuje",
  "drift.tool.called": "Wywołano",
  "drift.tool.fetch": "Pobierz",
  "drift.tool.asyncQuestion": "Pytanie asynchroniczne",
  "drift.tool.spawn": "Utwórz",
  ...
  "drift.workspace.changeImage": "Zmień obraz...",
  "drift.workspace.confirmRemove": "Kliknij ponownie, aby potwierdzić",
  "drift.workspace.move": "Przenieś...",
  "drift.workspace.remove": "Usuń",
  "drift.workspace.removeHint": "Wątki są przechowywane przez 7 dni; dodaj ponownie ten sam folder, aby je przywrócić.",
  "drift.workspace.useInitials": "Użyj inicjałów",
}
