...
export const drift = {
  ...
  "drift.about.row.website.description": "Загрузки, заметки о выпусках и медуза, вдохновившая эту.",
  "drift.about.credits.engine": "Drift работает на OpenCode. Самую сложную часть здесь берёт на себя движок, и это приложение существует только потому, что та работа достаточно хороша, чтобы на ней строить. Искреннее уважение разработчикам OpenCode и всем, кто ему помогает.",
  "drift.about.credits.ui": "Drift не критика движка, а лишь разница во вкусе: мне просто не нравится новый интерфейс, поэтому Drift сохраняет более тихую и плотную оболочку вокруг того же движка.",
  ...
  "drift.composer.fileTooLarge": "Размер {{filename}} превышает 10 MB",
