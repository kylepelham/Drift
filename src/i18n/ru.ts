...
export const drift = {
  "drift.slash.keyboardHint": "Tab дополняет. Enter подтверждает.",
  ...
  "drift.preview.mode.all": "Все",
  "drift.preview.mode.none": "Никакие",
  "drift.preview.mode.custom": "Выборочно",
  "drift.preview.type.markdown": "Файлы Markdown",
  "drift.preview.type.pdf": "Документы PDF",
  "drift.preview.type.image": "Изображения",
  "drift.preview.type.text": "Текст и код",
  "drift.preview.type.table": "Таблицы (CSV/TSV)",
  "drift.preview.type.audio": "Аудио",
  "drift.preview.type.video": "Видео",
  "drift.preview.title": "Предпросмотр файла",
  "drift.preview.htmlRendered": "Предпросмотр",
  "drift.preview.htmlSource": "Исходный HTML",
  "drift.preview.htmlStatic": "Статический предпросмотр. Скрипты, ссылки и внешние ресурсы отключены.",
  "drift.preview.loading": "Загрузка предпросмотра...",
  "drift.preview.error": "Не удалось загрузить предпросмотр.",
  "drift.preview.openEditor": "Открыть в редакторе",
  "drift.preview.retry": "Повторить",
  "drift.preview.previous": "Предыдущая страница",
  "drift.preview.next": "Следующая страница",
  "drift.preview.page": "Страница {{page}} из {{pages}}",
  "drift.preview.zoomIn": "Увеличить",
  "drift.preview.zoomOut": "Уменьшить",
  "drift.preview.unsupported": "Предпросмотр этого типа файлов не поддерживается.",
  "drift.preview.tooLarge": "Этот файл слишком большой для предпросмотра.",
  "drift.preview.unavailable": "Предпросмотр файла недоступен.",
  ...
  "drift.settings.shellTimeout.preset15": "15 минут",
  "drift.settings.shellTimeout.preset30": "30 минут",
  "drift.settings.shellTimeout.custom": "Свой вариант",
  "drift.settings.shellTimeout.customMinutes": "Свое число минут",
  "drift.settings.shellTimeout.customDescription": "Введите целое число от 1 до 1440 минут.",
  "drift.settings.shellTimeout.invalid": "Введите целое число от 1 до 1440.",
  "drift.shell.timeout.limit": "Лимит {{duration}}",
  "drift.shell.timeout.expired": "Тайм-аут через {{duration}}",
  ...
  "drift.sidebar.empty": "Добавьте рабочее пространство, чтобы начать.",
  "drift.sidebar.resize": "Изменить ширину боковой панели",
  "drift.workspace.showThreads": "Показать ветки",
  ...
  "drift.composer.connecting": "Подключение к движку...",
  "drift.composer.thinkingLevel": "Уровень рассуждений",
  "drift.permissions.autoGlobal": "Разрешения автоматически принимаются глобально",
  "drift.permissions.autoThread": "Разрешения автоматически принимаются в этой ветке",
  "drift.prompt.steer": "Направить",
  "drift.titlebar.minimize": "Свернуть",
  ...
  "drift.about.group.build": "Сборка",
  "drift.about.group.links": "Ссылки",
  ...
  "drift.about.updates.available": "Доступны",
  "drift.about.updates.unavailable": "Локальная сборка",
  "drift.about.row.website.title": "Сайт",
  "drift.about.row.website.description": "Загрузки и заметки о выпусках.",
  "drift.about.credits.engine": "Drift работает на OpenCode. Самую сложную часть здесь берёт на себя движок, и это приложение существует только благодаря этой великолепной работе. Искреннее уважение разработчикам OpenCode и всем, кто ему помогает.",
  "drift.archive.deletesInDays": "Удаление через {{days}} дн.",
  ...
  "drift.attachment.image": "изображение",
  "drift.attachment.viewImage": "Просмотреть изображение",
  ...
  "drift.attachment.pages": "{{count}} страниц",
  "drift.attachment.processing": "Чтение...",
  "drift.attachment.table": "{{rows}} строк x {{columns}} столбцов",
  "drift.chat.empty.noWorkspace": "Добавьте или выберите рабочее пространство слева, чтобы начать.",
  "drift.chat.empty.promptHint": "Начните вводить текст ниже. Enter отправляет, Shift+Enter переносит строку.",
  "drift.chat.empty.threadHint": "Ветки находятся слева. Никаких вкладок. Никогда.",
  "drift.chat.retry.inSeconds": "Повтор через {{seconds}} с",
  "drift.chat.retry.info": "{{retry}} - попытка №{{attempt}}",
  "drift.chat.retry.now": "Повторная попытка",
  "drift.chat.retry.providerRejected": "Провайдер отклонил запрос",
  "drift.chat.thinking": "Размышление",
  "drift.color.accent": "Акцент",
  "drift.color.background": "Фон",
  "drift.color.surface": "Поверхность",
  "drift.color.text": "Текст",
  "drift.composer.anotherThread": "другая ветка",
  "drift.composer.dropFiles": "Перетащите файлы, чтобы прикрепить их",
  "drift.composer.fileReadFailed": "Не удалось прочитать {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} не является корректным текстом UTF-8",
  "drift.composer.fileTooLarge": "{{filename}} превышает лимит {{limit}} для файлов {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} — неподдерживаемый архив или двоичный файл",
  "drift.composer.folderUnsupported": "Папки нельзя прикрепить; перетащите отдельные файлы",
  "drift.composer.modelUnsupported": "{{model}} не принимает вложения {{kind}} ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} записей",
  "drift.count.file.one": "{{count}} файл",
  "drift.count.file.other": "{{count}} файлов",
  "drift.count.line.one": "{{count}} строка",
  "drift.count.line.other": "{{count}} строк",
  "drift.count.match.one": "{{count}} совпадение",
  "drift.count.match.other": "{{count}} совпадений",
  "drift.count.result.one": "{{count}} результат",
  "drift.count.result.other": "{{count}} результатов",
  "drift.count.tool.one": "{{count}} инструмент",
  "drift.count.tool.other": "{{count}} инструментов",
  "drift.debug.context": "Контекст",
  "drift.file.created": "Создан",
  "drift.file.deleted": "Удалён",
  "drift.file.moved": "Перемещён",
  ...
  "drift.mcp.authenticate": "Аутентификация",
  "drift.mcp.description": "Глобальные серверы Drift и точные действующие определения, о которых сообщает активное рабочее пространство.",
  ...
  "drift.message.copy": "Копировать сообщение",
  "drift.message.copyResponse": "Копировать ответ",
  ...
  "drift.provider.finishInBrowser": "Завершите вход в браузере.",
  "drift.provider.savedUnavailable": "Учётные данные сохранены, но {{provider}} недоступен.",
  "drift.provider.signInStartFailed": "Не удалось начать вход.",
  "drift.provider.signInStartFailedFor": "Не удалось начать вход в {{provider}}.",
  "drift.provider.signInWith": "Войти с помощью {{method}}",
  "drift.question.custom": "Введите свой ответ",
  "drift.question.answered": "Ответ дан",
  "drift.question.unanswered": "Нет ответа",
  "drift.question.answerLater": "Ответить позже",
  "drift.question.answerNow": "Ответить сейчас",
  ...
  "drift.question.number": "Вопрос {{number}}",
  "drift.question.selectMultiple": "Выберите все подходящие ответы",
  "drift.question.selectOne": "Выберите один ответ",
  "drift.reasoning.thinking": "Размышление",
  "drift.reasoning.thought": "Мысль",
  "drift.reasoning.level.none": "Нет",
  "drift.reasoning.level.minimal": "Минимальный",
  "drift.reasoning.level.low": "Низкий",
  "drift.reasoning.level.medium": "Средний",
  "drift.reasoning.level.high": "Высокий",
  "drift.reasoning.level.xhigh": "Очень высокий",
  "drift.reasoning.level.max": "Максимальный",
  "drift.settings.customPalette.colorDescription": "Задайте цвет {{color}}.",
  "drift.settings.customPalette.hexValue": "HEX-значение цвета {{color}}",
  "drift.settings.providers.notConnected": "Не подключён",
  ...
  "drift.shortcuts.zoomOut": "Уменьшить масштаб",
  "drift.shortcuts.zoomReset": "Сбросить масштаб",
  "drift.sidebar.moveSessionFailed": "Не удалось переместить сессию",
  "drift.sidebar.moveWorkspaceFailed": "Не удалось переместить рабочее пространство",
  "drift.sidebar.movingSession": "Перемещение сессии в {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Перемещение сессий из {{workspace}}...",
  "drift.sidebar.offline": "не в сети",
  "drift.sidebar.pathAlreadySaved": "{{path}} уже сохранён как {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Не удалось сохранить новый путь рабочего пространства: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Рабочее пространство перемещено только частично: {{error}}",
  "drift.slash.mcp": "Управление серверами MCP",
  "drift.slash.workspaceCommand": "команда рабочего пространства",
  "drift.sound.group.alerts": "Оповещения",
  "drift.sound.group.failure": "Ошибка",
  "drift.sound.group.information": "Информация",
  "drift.sound.group.mechanical": "Механические",
  "drift.sound.group.success": "Успех",
  "drift.status.waitingForPermission": "Ожидание разрешения",
  "drift.theme.aubergine": "Drift Баклажан",
  "drift.theme.custom": "Пользовательская",
  "drift.theme.dark": "Drift Тёмная",
  "drift.theme.forest": "Drift Лес",
  "drift.theme.graphite": "Drift Графит",
  "drift.theme.light": "Drift Светлая",
  "drift.theme.midnight": "Drift Полночь",
  "drift.theme.paper": "Drift Бумага",
  "drift.theme.slate": "Drift Сланец",
  "drift.thread.backToParent": "Вернуться к исходной ветке",
  "drift.thread.copyShareLink": "Копировать ссылку: {{url}}",
  "drift.thread.move": "Переместить",
  "drift.thread.moveToWorkspace": "Переместить в рабочее пространство",
  "drift.thread.noOtherWorkspaces": "Других рабочих пространств нет",
  "drift.thread.openSpawned": "Открыть созданную ветку",
  "drift.thread.renameHint": "Дважды щёлкните, чтобы переименовать",
  "drift.thread.shared": "Опубликована",
  "drift.thread.waitingForAnswer": "Ожидание ответа",
  "drift.thread.waitingForPermission": "Ожидание разрешения",
  "drift.thread.working": "В работе",
  "drift.tool.called": "Вызван",
  "drift.tool.fetch": "Получение",
  "drift.tool.asyncQuestion": "Асинхронный вопрос",
  "drift.tool.spawn": "Создание",
  ...
  "drift.workspace.changeImage": "Изменить изображение...",
  "drift.workspace.confirmRemove": "Нажмите ещё раз для подтверждения",
  "drift.workspace.move": "Переместить...",
  "drift.workspace.remove": "Удалить",
  "drift.workspace.removeHint": "Ветки хранятся 7 дней; повторно добавьте ту же папку, чтобы восстановить их.",
  "drift.workspace.useInitials": "Использовать инициалы",
}
