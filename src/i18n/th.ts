...
export const drift = {
  ...
  "drift.about.row.website.description": "ดาวน์โหลด บันทึกการเปลี่ยนแปลง และแมงกะพรุนที่เป็นแรงบันดาลใจให้ตัวนี้",
  "drift.about.credits.engine": "Drift ทำงานบน OpenCode เอนจินรับหน้าที่ส่วนที่ยากที่สุด และแอปนี้มีอยู่ได้เพราะงานนั้นดีพอที่จะต่อยอด ขอแสดงความเคารพอย่างจริงใจต่อนักพัฒนา OpenCode และทุกคนที่ร่วมสนับสนุน",
  "drift.about.credits.ui": "Drift ไม่ใช่การวิจารณ์เอนจิน เป็นเพียงความชอบที่ต่างกัน ผมไม่ถูกใจ UI ใหม่เท่านั้น ดังนั้น Drift จึงคงเปลือกที่เงียบกว่าและแน่นกว่าไว้รอบเอนจินเดียวกัน",
  ...
  "drift.composer.fileTooLarge": "{{filename}} มีขนาดเกิน 10 MB",
