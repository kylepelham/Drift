...
export const drift = {
  "drift.slash.keyboardHint": "Tab เติมคำอัตโนมัติ Enter ยืนยัน",
  ...
  "drift.preview.mode.all": "ทั้งหมด",
  "drift.preview.mode.none": "ไม่มี",
  "drift.preview.mode.custom": "กำหนดเอง",
  "drift.preview.type.markdown": "ไฟล์ Markdown",
  "drift.preview.type.pdf": "เอกสาร PDF",
  "drift.preview.type.image": "รูปภาพ",
  "drift.preview.type.text": "ข้อความและโค้ด",
  "drift.preview.type.table": "ตาราง (CSV/TSV)",
  "drift.preview.type.audio": "เสียง",
  "drift.preview.type.video": "วิดีโอ",
  "drift.preview.title": "ตัวอย่างไฟล์",
  "drift.preview.htmlRendered": "ตัวอย่าง",
  "drift.preview.htmlSource": "ซอร์ส HTML",
  "drift.preview.htmlStatic": "ตัวอย่างแบบคงที่ ปิดใช้งานสคริปต์ ลิงก์ และทรัพยากรภายนอก",
  "drift.preview.loading": "กำลังโหลดตัวอย่าง...",
  "drift.preview.error": "ไม่สามารถโหลดตัวอย่างได้",
  "drift.preview.openEditor": "เปิดในตัวแก้ไข",
  "drift.preview.retry": "ลองอีกครั้ง",
  "drift.preview.previous": "หน้าก่อนหน้า",
  "drift.preview.next": "หน้าถัดไป",
  "drift.preview.page": "หน้า {{page}} จาก {{pages}}",
  "drift.preview.zoomIn": "ขยาย",
  "drift.preview.zoomOut": "ย่อ",
  "drift.preview.unsupported": "ไม่สามารถแสดงตัวอย่างไฟล์ประเภทนี้ได้",
  "drift.preview.tooLarge": "ไฟล์นี้ใหญ่เกินกว่าจะแสดงตัวอย่างได้",
  "drift.preview.unavailable": "ไม่สามารถใช้การแสดงตัวอย่างไฟล์ได้",
  ...
  "drift.settings.shellTimeout.preset15": "15 นาที",
  "drift.settings.shellTimeout.preset30": "30 นาที",
  "drift.settings.shellTimeout.custom": "กำหนดเอง",
  "drift.settings.shellTimeout.customMinutes": "จำนวนนาทีที่กำหนดเอง",
  "drift.settings.shellTimeout.customDescription": "ป้อนจำนวนเต็มตั้งแต่ 1 ถึง 1,440 นาที",
  "drift.settings.shellTimeout.invalid": "ป้อนจำนวนเต็มตั้งแต่ 1 ถึง 1,440",
  "drift.shell.timeout.limit": "ขีดจำกัด {{duration}}",
  "drift.shell.timeout.expired": "หมดเวลาหลัง {{duration}}",
  "drift.agent.build": "สร้าง",
  "drift.agent.plan": "วางแผน",
  "drift.agent.general": "ทั่วไป",
  ...
  "drift.settings.summaries.collapsible.description": "ซ่อนสรุปการย่อบริบทของเอนจินไว้หลังตัวแบ่งที่ขยายได้",
  "drift.settings.summaries.collapsed.title": "พับสรุปโดยค่าเริ่มต้น",
  "drift.settings.summaries.collapsed.description": "เริ่มต้นโดยพับสรุปการย่อบริบทไว้",
  "drift.settings.customPalette": "ชุดสีที่กำหนดเอง",
  "drift.settings.typography": "รูปแบบตัวอักษร",
  "drift.settings.customCss": "CSS ที่กำหนดเอง",
  "drift.settings.customCss.description": "ใช้เฉพาะในเครื่องต่อจากสไตล์ในตัวของ Drift จำกัดไว้ที่ 20 KB",
  "drift.sidebar.workspaces": "พื้นที่ทำงาน",
  "drift.sidebar.archived": "รายการที่เก็บถาวร",
  "drift.sidebar.addWorkspace": "เพิ่มพื้นที่ทำงาน",
  "drift.sidebar.empty": "เพิ่มพื้นที่ทำงานเพื่อเริ่มต้น",
  "drift.sidebar.resize": "ปรับขนาดแถบด้านข้าง",
  "drift.workspace.showThreads": "แสดงเธรด",
  ...
  "drift.composer.connecting": "กำลังเชื่อมต่อเอนจิน...",
  "drift.composer.thinkingLevel": "ระดับการคิด",
  "drift.permissions.autoGlobal": "ยอมรับสิทธิ์ทั่วทั้งระบบโดยอัตโนมัติ",
  "drift.permissions.autoThread": "ยอมรับสิทธิ์สำหรับเธรดนี้โดยอัตโนมัติ",
  "drift.prompt.steer": "ชี้นำ",
  "drift.titlebar.minimize": "ย่อ",
  ...
  "drift.about.starting": "(กำลังเริ่ม...)",
  "drift.about.group.build": "บิลด์",
  "drift.about.group.links": "ลิงก์",
  ...
  "drift.about.updates.available": "พร้อมใช้งาน",
  "drift.about.updates.unavailable": "บิลด์ในเครื่อง",
  "drift.about.row.website.title": "เว็บไซต์",
  "drift.about.row.website.description": "ดาวน์โหลดและบันทึกการเปลี่ยนแปลง",
  "drift.about.credits.engine": "Drift ทำงานบน OpenCode เอนจินรับหน้าที่ส่วนที่ยากที่สุด และแอปนี้มีอยู่ได้ก็เพราะผลงานอันยอดเยี่ยมนั้น ขอแสดงความเคารพอย่างจริงใจต่อนักพัฒนา OpenCode และทุกคนที่ร่วมสนับสนุน",
  "drift.archive.deletesInDays": "ลบใน {{days}} วัน",
  ...
  "drift.attachment.image": "รูปภาพ",
  "drift.attachment.viewImage": "ดูรูปภาพ",
  ...
  "drift.attachment.pages": "{{count}} หน้า",
  "drift.attachment.processing": "กำลังอ่าน...",
  "drift.attachment.table": "{{rows}} แถว x {{columns}} คอลัมน์",
  "drift.chat.empty.noWorkspace": "เพิ่มหรือเลือกพื้นที่ทำงานทางซ้ายเพื่อเริ่มต้น",
  "drift.chat.empty.promptHint": "เริ่มพิมพ์ด้านล่าง กด Enter เพื่อส่ง และ Shift+Enter เพื่อขึ้นบรรทัดใหม่",
  "drift.chat.empty.threadHint": "เธรดอยู่ทางซ้าย ไม่มีแท็บ โดยเด็ดขาด",
  "drift.chat.retry.inSeconds": "ลองใหม่ใน {{seconds}} วินาที",
  "drift.chat.retry.info": "{{retry}} - ครั้งที่ #{{attempt}}",
  "drift.chat.retry.now": "กำลังลองใหม่",
  "drift.chat.retry.providerRejected": "ผู้ให้บริการไม่ยอมรับคำขอ",
  "drift.chat.thinking": "กำลังคิด",
  "drift.color.accent": "สีเน้น",
  "drift.color.background": "พื้นหลัง",
  "drift.color.surface": "พื้นผิว",
  "drift.color.text": "ข้อความ",
  "drift.composer.anotherThread": "เธรดอื่น",
  "drift.composer.dropFiles": "วางไฟล์เพื่อแนบ",
  "drift.composer.fileReadFailed": "ไม่สามารถอ่าน {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} ไม่ใช่ข้อความ UTF-8 ที่ถูกต้อง",
  "drift.composer.fileTooLarge": "{{filename}} เกินขีดจำกัด {{limit}} สำหรับไฟล์ {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} เป็นไฟล์บีบอัดหรือไบนารีที่ไม่รองรับ",
  "drift.composer.folderUnsupported": "ไม่สามารถแนบโฟลเดอร์ได้ โปรดวางไฟล์แต่ละไฟล์แทน",
  "drift.composer.modelUnsupported": "{{model}} ไม่รองรับไฟล์แนบ {{kind}} ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} รายการ",
  "drift.count.file.one": "{{count}} ไฟล์",
  "drift.count.file.other": "{{count}} ไฟล์",
  "drift.count.line.one": "{{count}} บรรทัด",
  "drift.count.line.other": "{{count}} บรรทัด",
  "drift.count.match.one": "{{count}} รายการที่ตรงกัน",
  "drift.count.match.other": "{{count}} รายการที่ตรงกัน",
  "drift.count.result.one": "{{count}} ผลลัพธ์",
  "drift.count.result.other": "{{count}} ผลลัพธ์",
  "drift.count.tool.one": "{{count}} เครื่องมือ",
  "drift.count.tool.other": "{{count}} เครื่องมือ",
  "drift.debug.context": "บริบท",
  "drift.file.created": "สร้างแล้ว",
  "drift.file.deleted": "ลบแล้ว",
  "drift.file.moved": "ย้ายแล้ว",
  ...
  "drift.mcp.authenticate": "ยืนยันตัวตน",
  ...
  "drift.message.copy": "คัดลอกข้อความ",
  "drift.message.copyResponse": "คัดลอกคำตอบ",
  ...
  "drift.provider.finishInBrowser": "ลงชื่อเข้าใช้ให้เสร็จในเบราว์เซอร์",
  "drift.provider.savedUnavailable": "บันทึกข้อมูลรับรองแล้ว แต่ {{provider}} ยังไม่พร้อมใช้งาน",
  "drift.provider.signInStartFailed": "ไม่สามารถเริ่มขั้นตอนการลงชื่อเข้าใช้",
  "drift.provider.signInStartFailedFor": "ไม่สามารถเริ่มขั้นตอนการลงชื่อเข้าใช้ {{provider}}",
  "drift.provider.signInWith": "ลงชื่อเข้าใช้ด้วย {{method}}",
  "drift.question.custom": "พิมพ์คำตอบของคุณเอง",
  "drift.question.answered": "ตอบแล้ว",
  "drift.question.unanswered": "ไม่มีคำตอบ",
  "drift.question.answerLater": "ตอบภายหลัง",
  "drift.question.answerNow": "ตอบตอนนี้",
  "drift.question.asyncHint": "งานที่ไม่ขึ้นอยู่กับคำตอบของคุณสามารถดำเนินต่อได้ในระหว่างที่คุณตัดสินใจ",
  "drift.question.blocking": "กำลังรอคำตอบ",
  "drift.question.pending": "คำขอที่รอดำเนินการ: {{count}}",
  "drift.question.sendFailed": "ไม่สามารถส่งคำตอบของคุณได้ คำตอบของคุณยังอยู่ที่นี่ ลองส่งอีกครั้ง",
  "drift.question.sending": "กำลังส่ง...",
  "drift.question.customHint": "เพิ่มคำตอบที่ไม่มีในรายการด้านบน",
  "drift.question.customPlaceholder": "พิมพ์คำตอบของคุณเอง...",
  "drift.question.number": "คำถาม {{number}}",
  "drift.question.selectMultiple": "เลือกคำตอบทั้งหมดที่เกี่ยวข้อง",
  "drift.question.selectOne": "เลือกหนึ่งคำตอบ",
  "drift.reasoning.thinking": "กำลังคิด",
  "drift.reasoning.thought": "ความคิด",
  "drift.reasoning.level.none": "ไม่มี",
  "drift.reasoning.level.minimal": "น้อยที่สุด",
  "drift.reasoning.level.low": "ต่ำ",
  "drift.reasoning.level.medium": "ปานกลาง",
  "drift.reasoning.level.high": "สูง",
  "drift.reasoning.level.xhigh": "สูงมาก",
  "drift.reasoning.level.max": "สูงสุด",
  "drift.settings.customPalette.colorDescription": "ตั้งค่าสี {{color}}",
  "drift.settings.customPalette.hexValue": "ค่าเลขฐานสิบหกของสี {{color}}",
  "drift.settings.providers.notConnected": "ยังไม่ได้เชื่อมต่อ",
  ...
  "drift.shortcuts.zoomOut": "ซูมออก",
  "drift.shortcuts.zoomReset": "รีเซ็ตการซูม",
  "drift.sidebar.moveSessionFailed": "ไม่สามารถย้ายเซสชัน",
  "drift.sidebar.moveWorkspaceFailed": "ไม่สามารถย้ายพื้นที่ทำงาน",
  "drift.sidebar.movingSession": "กำลังย้ายเซสชันไปยัง {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "กำลังย้ายเซสชันของ {{workspace}}...",
  "drift.sidebar.offline": "ออฟไลน์",
  "drift.sidebar.pathAlreadySaved": "บันทึก {{path}} เป็น {{workspace}} ไว้แล้ว",
  "drift.sidebar.saveWorkspacePathFailed": "ไม่สามารถบันทึกเส้นทางพื้นที่ทำงานใหม่: {{error}}",
  "drift.sidebar.workspaceMovePartial": "ย้ายพื้นที่ทำงานสำเร็จเพียงบางส่วน: {{error}}",
  "drift.slash.mcp": "จัดการเซิร์ฟเวอร์ MCP",
  "drift.slash.workspaceCommand": "คำสั่งพื้นที่ทำงาน",
  "drift.sound.group.alerts": "การแจ้งเตือน",
  "drift.sound.group.failure": "ล้มเหลว",
  "drift.sound.group.information": "ข้อมูล",
  "drift.sound.group.mechanical": "กลไก",
  "drift.sound.group.success": "สำเร็จ",
  "drift.status.waitingForPermission": "กำลังรอสิทธิ์",
  "drift.theme.aubergine": "Drift มะเขือม่วง",
  "drift.theme.custom": "กำหนดเอง",
  "drift.theme.dark": "Drift มืด",
  "drift.theme.forest": "Drift ป่า",
  "drift.theme.graphite": "Drift แกรไฟต์",
  "drift.theme.light": "Drift สว่าง",
  "drift.theme.midnight": "Drift เที่ยงคืน",
  "drift.theme.paper": "Drift กระดาษ",
  "drift.theme.slate": "Drift หินชนวน",
  "drift.thread.backToParent": "กลับไปยังเธรดต้นทาง",
  "drift.thread.copyShareLink": "คัดลอกลิงก์แชร์: {{url}}",
  "drift.thread.move": "ย้าย",
  "drift.thread.moveToWorkspace": "ย้ายไปยังพื้นที่ทำงาน",
  "drift.thread.noOtherWorkspaces": "ไม่มีพื้นที่ทำงานอื่น",
  "drift.thread.openSpawned": "เปิดเธรดที่สร้างขึ้น",
  "drift.thread.renameHint": "ดับเบิลคลิกเพื่อเปลี่ยนชื่อ",
  "drift.thread.shared": "แชร์แล้ว",
  "drift.thread.waitingForAnswer": "กำลังรอคำตอบ",
  "drift.thread.waitingForPermission": "กำลังรอสิทธิ์",
  "drift.thread.working": "กำลังทำงาน",
  "drift.tool.called": "เรียกใช้",
  "drift.tool.fetch": "ดึงข้อมูล",
  "drift.tool.asyncQuestion": "คำถามแบบอะซิงโครนัส",
  "drift.tool.spawn": "สร้าง",
  "drift.tool.subtask": "งานย่อย",
  "drift.tool.task": "งาน",
  "drift.voice.input.description": "เลือกไมโครโฟนสำหรับการบันทึกตามคำบอกใหม่",
  "drift.voice.input.missing": "ไมโครโฟนที่บันทึกไว้ไม่พร้อมใช้งาน กำลังใช้ค่าเริ่มต้นของระบบจนกว่าจะเชื่อมต่ออีกครั้ง",
  "drift.voice.input.systemDefault": "ค่าเริ่มต้นของระบบ",
  "drift.voice.input.title": "อุปกรณ์อินพุต",
  "drift.voice.input.unnamed": "ไมโครโฟน {{index}}",
  "drift.workspace.changeImage": "เปลี่ยนรูปภาพ...",
  "drift.workspace.confirmRemove": "คลิกอีกครั้งเพื่อยืนยัน",
  "drift.workspace.move": "ย้าย...",
  "drift.workspace.remove": "เอาออก",
  "drift.workspace.removeHint": "เธรดจะถูกเก็บไว้ 7 วัน เพิ่มโฟลเดอร์เดิมอีกครั้งเพื่อกู้คืน",
  "drift.workspace.useInitials": "ใช้ชื่อย่อ",
}
