...
export const drift = {
  ...
  "drift.about.row.website.description": "İndirmeler, sürüm notları ve buradakine ilham veren denizanası.",
  "drift.about.credits.engine": "Drift, OpenCode üzerinde çalışır. Zor kısmı burada motor yapıyor ve bu uygulama yalnızca o çalışma üzerine inşa edilmeye yetecek kadar iyi olduğu için var. OpenCode geliştiricilerine ve katkı veren herkese gerçek saygı.",
  "drift.about.credits.ui": "Drift, motora yönelik bir eleştiri değil, yalnızca bir zevk farkı: yeni arayüzü açıkça sevmiyorum, bu yüzden Drift aynı motorun çevresinde daha sakin ve daha yoğun bir kabuk tutuyor.",
  ...
  "drift.composer.fileTooLarge": "{{filename}} 10 MB sınırını aşıyor",
