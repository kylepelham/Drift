...
export const drift = {
  "drift.slash.keyboardHint": "Tab tamamlar. Enter onaylar.",
  ...
  "drift.preview.mode.all": "Tümü",
  "drift.preview.mode.none": "Hiçbiri",
  "drift.preview.mode.custom": "Özel",
  "drift.preview.type.markdown": "Markdown dosyaları",
  "drift.preview.type.pdf": "PDF belgeleri",
  "drift.preview.type.image": "Görseller",
  "drift.preview.type.text": "Metin ve kod",
  "drift.preview.type.table": "Tablolar (CSV/TSV)",
  "drift.preview.type.audio": "Ses",
  "drift.preview.type.video": "Video",
  "drift.preview.title": "Dosya önizlemesi",
  "drift.preview.htmlRendered": "Önizleme",
  "drift.preview.htmlSource": "HTML kaynağı",
  "drift.preview.htmlStatic": "Statik önizleme. Betikler, bağlantılar ve harici kaynaklar devre dışıdır.",
  "drift.preview.loading": "Önizleme yükleniyor...",
  "drift.preview.error": "Önizleme yüklenemedi.",
  "drift.preview.openEditor": "Düzenleyicide aç",
  "drift.preview.retry": "Yeniden dene",
  "drift.preview.previous": "Önceki sayfa",
  "drift.preview.next": "Sonraki sayfa",
  "drift.preview.page": "Sayfa {{page}} / {{pages}}",
  "drift.preview.zoomIn": "Yakınlaştır",
  "drift.preview.zoomOut": "Uzaklaştır",
  "drift.preview.unsupported": "Bu dosya türü önizlenemiyor.",
  "drift.preview.tooLarge": "Bu dosya önizleme için çok büyük.",
  "drift.preview.unavailable": "Dosya önizlemesi kullanılamıyor.",
  ...
  "drift.settings.shellTimeout.preset15": "15 dakika",
  "drift.settings.shellTimeout.preset30": "30 dakika",
  "drift.settings.shellTimeout.custom": "Özel",
  "drift.settings.shellTimeout.customMinutes": "Özel dakika",
  "drift.settings.shellTimeout.customDescription": "1 ile 1.440 arasında bir tam sayı girin.",
  "drift.settings.shellTimeout.invalid": "1 ile 1.440 arasında bir tam sayı girin.",
  "drift.shell.timeout.limit": "Sınır {{duration}}",
  "drift.shell.timeout.expired": "{{duration}} sonra zaman aşımı",
  "drift.agent.build": "Derleme",
  "drift.agent.plan": "Planlama",
  "drift.agent.general": "Genel",
  ...
  "drift.sidebar.empty": "Başlamak için bir çalışma alanı ekleyin.",
  "drift.sidebar.resize": "Kenar çubuğunu yeniden boyutlandır",
  "drift.workspace.showThreads": "Konuları göster",
  ...
  "drift.composer.connecting": "Motora bağlanıyor...",
  "drift.composer.thinkingLevel": "Düşünme düzeyi",
  "drift.permissions.autoGlobal": "İzinler genel olarak otomatik kabul ediliyor",
  "drift.permissions.autoThread": "Bu konu için izinler otomatik kabul ediliyor",
  "drift.prompt.steer": "Yönlendir",
  "drift.titlebar.minimize": "Küçült",
  ...
  "drift.about.starting": "(başlatılıyor...)",
  "drift.about.group.build": "Derleme",
  "drift.about.group.links": "Bağlantılar",
  ...
  "drift.about.updates.available": "Kullanılabilir",
  "drift.about.updates.unavailable": "Yerel derleme",
  "drift.about.row.website.title": "Web sitesi",
  "drift.about.row.website.description": "İndirmeler ve sürüm notları.",
  "drift.about.credits.engine": "Drift, OpenCode üzerinde çalışır. Zor kısmı burada motor yapıyor ve bu uygulama yalnızca o muhteşem çalışma sayesinde var. OpenCode geliştiricilerine ve katkı veren herkese gerçek saygı.",
  "drift.archive.deletesInDays": "{{days}} gün içinde silinir",
  ...
  "drift.attachment.image": "görsel",
  "drift.attachment.viewImage": "Görseli görüntüle",
  ...
  "drift.attachment.pages": "{{count}} sayfa",
  "drift.attachment.processing": "Okunuyor...",
  "drift.attachment.table": "{{rows}} satır x {{columns}} sütun",
  "drift.chat.empty.noWorkspace": "Başlamak için soldan bir çalışma alanı ekleyin veya seçin.",
  "drift.chat.empty.promptHint": "Aşağıya yazmaya başlayın. Enter gönderir, Shift+Enter yeni satıra geçer.",
  "drift.chat.empty.threadHint": "Konular solda yer alır. Sekme yok. Asla.",
  "drift.chat.retry.inSeconds": "{{seconds}} saniye içinde yeniden denenecek",
  "drift.chat.retry.info": "{{retry}} - deneme #{{attempt}}",
  "drift.chat.retry.now": "Yeniden deneniyor",
  "drift.chat.retry.providerRejected": "Sağlayıcı isteği kabul etmedi",
  "drift.chat.thinking": "Düşünüyor",
  "drift.color.accent": "Vurgu",
  "drift.color.background": "Arka plan",
  "drift.color.surface": "Yüzey",
  "drift.color.text": "Metin",
  "drift.composer.anotherThread": "başka bir konu",
  "drift.composer.dropFiles": "Eklemek için dosyaları bırakın",
  "drift.composer.fileReadFailed": "{{filename}} okunamadı",
  "drift.composer.fileInvalidUtf8": "{{filename}} geçerli UTF-8 metni değil",
  "drift.composer.fileTooLarge": "{{filename}}, {{kind}} dosyaları için {{limit}} sınırını aşıyor",
  "drift.composer.fileUnsupported": "{{filename}} desteklenmeyen bir arşiv veya ikili dosya",
  "drift.composer.folderUnsupported": "Klasörler eklenemez; bunun yerine dosyaları tek tek bırakın",
  "drift.composer.modelUnsupported": "{{model}}, {{kind}} eklerini kabul etmiyor ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} kayıt",
  "drift.count.file.one": "{{count}} dosya",
  "drift.count.file.other": "{{count}} dosya",
  "drift.count.line.one": "{{count}} satır",
  "drift.count.line.other": "{{count}} satır",
  "drift.count.match.one": "{{count}} eşleşme",
  "drift.count.match.other": "{{count}} eşleşme",
  "drift.count.result.one": "{{count}} sonuç",
  "drift.count.result.other": "{{count}} sonuç",
  "drift.count.tool.one": "{{count}} araç",
  "drift.count.tool.other": "{{count}} araç",
  "drift.debug.context": "Bağlam",
  "drift.file.created": "Oluşturuldu",
  "drift.file.deleted": "Silindi",
  "drift.file.moved": "Taşındı",
  ...
  "drift.mcp.authenticate": "Kimlik doğrula",
  ...
  "drift.message.copy": "Mesajı kopyala",
  "drift.message.copyResponse": "Yanıtı kopyala",
  ...
  "drift.provider.finishInBrowser": "Tarayıcıda oturum açmayı tamamlayın.",
  "drift.provider.savedUnavailable": "Kimlik bilgisi kaydedildi ancak {{provider}} kullanıma hazır olmadı.",
  "drift.provider.signInStartFailed": "Oturum açma işlemi başlatılamadı.",
  "drift.provider.signInStartFailedFor": "{{provider}} oturum açma işlemi başlatılamadı.",
  "drift.provider.signInWith": "{{method}} ile oturum aç",
  "drift.question.custom": "Kendi yanıtınızı yazın",
  "drift.question.answered": "Yanıtlandı",
  "drift.question.unanswered": "Yanıt yok",
  "drift.question.answerLater": "Daha sonra yanıtla",
  "drift.question.answerNow": "Şimdi yanıtla",
  "drift.question.asyncHint": "Siz karar verirken yanıtınıza bağlı olmayan çalışmalar devam edebilir.",
  "drift.question.blocking": "Yanıt bekleniyor",
  "drift.question.pending": "Bekleyen istekler: {{count}}",
  "drift.question.sendFailed": "Yanıtınız gönderilemedi. Yanıtlarınız hâlâ burada. Yeniden göndermeyi deneyin.",
  "drift.question.sending": "Gönderiliyor...",
  "drift.question.customHint": "Yukarıda listelenmeyen bir yanıt ekleyin",
  "drift.question.customPlaceholder": "Kendi yanıtınızı yazın...",
  "drift.question.number": "Soru {{number}}",
  "drift.question.selectMultiple": "Geçerli tüm yanıtları seçin",
  "drift.question.selectOne": "Bir yanıt seçin",
  "drift.reasoning.thinking": "Düşünüyor",
  "drift.reasoning.thought": "Düşünce",
  "drift.reasoning.level.none": "Yok",
  "drift.reasoning.level.minimal": "En az",
  "drift.reasoning.level.low": "Düşük",
  "drift.reasoning.level.medium": "Orta",
  "drift.reasoning.level.high": "Yüksek",
  "drift.reasoning.level.xhigh": "Çok yüksek",
  "drift.reasoning.level.max": "En yüksek",
  "drift.settings.customPalette.colorDescription": "{{color}} rengini ayarlayın.",
  "drift.settings.customPalette.hexValue": "{{color}} onaltılık değeri",
  "drift.settings.providers.notConnected": "Bağlı değil",
  ...
  "drift.shortcuts.zoomOut": "Uzaklaştır",
  "drift.shortcuts.zoomReset": "Yakınlaştırmayı sıfırla",
  "drift.sidebar.moveSessionFailed": "Oturum taşınamadı",
  "drift.sidebar.moveWorkspaceFailed": "Çalışma alanı taşınamadı",
  "drift.sidebar.movingSession": "Oturum {{workspace}} alanına taşınıyor...",
  "drift.sidebar.movingWorkspaceSessions": "{{workspace}} oturumları taşınıyor...",
  "drift.sidebar.offline": "çevrimdışı",
  "drift.sidebar.pathAlreadySaved": "{{path}} zaten {{workspace}} olarak kayıtlı",
  "drift.sidebar.saveWorkspacePathFailed": "Yeni çalışma alanı yolu kaydedilemedi: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Çalışma alanı taşıma işlemi yalnızca kısmen uygulandı: {{error}}",
  "drift.slash.mcp": "MCP sunucularını yönet",
  "drift.slash.workspaceCommand": "çalışma alanı komutu",
  "drift.sound.group.alerts": "Uyarılar",
  "drift.sound.group.failure": "Başarısızlık",
  "drift.sound.group.information": "Bilgi",
  "drift.sound.group.mechanical": "Mekanik",
  "drift.sound.group.success": "Başarı",
  "drift.status.waitingForPermission": "İzin bekleniyor",
  "drift.theme.aubergine": "Drift Patlıcan",
  "drift.theme.custom": "Özel",
  "drift.theme.dark": "Drift Koyu",
  "drift.theme.forest": "Drift Orman",
  "drift.theme.graphite": "Drift Grafit",
  "drift.theme.light": "Drift Açık",
  "drift.theme.midnight": "Drift Gece Yarısı",
  "drift.theme.paper": "Drift Kağıt",
  "drift.theme.slate": "Drift Kayrak",
  "drift.thread.backToParent": "Oluşturulduğu konuya geri dön",
  "drift.thread.copyShareLink": "Paylaşım bağlantısını kopyala: {{url}}",
  "drift.thread.move": "Taşı",
  "drift.thread.moveToWorkspace": "Çalışma alanına taşı",
  "drift.thread.noOtherWorkspaces": "Başka çalışma alanı yok",
  "drift.thread.openSpawned": "Oluşturulan konuyu aç",
  "drift.thread.renameHint": "Yeniden adlandırmak için çift tıklayın",
  "drift.thread.shared": "Paylaşıldı",
  "drift.thread.waitingForAnswer": "Yanıt bekleniyor",
  "drift.thread.waitingForPermission": "İzin bekleniyor",
  "drift.thread.working": "Çalışıyor",
  "drift.tool.called": "Çağrıldı",
  "drift.tool.fetch": "Getir",
  "drift.tool.asyncQuestion": "Asenkron soru",
  "drift.tool.spawn": "Oluştur",
  ...
  "drift.workspace.changeImage": "Görseli değiştir...",
  "drift.workspace.confirmRemove": "Onaylamak için tekrar tıklayın",
  "drift.workspace.move": "Taşı...",
  "drift.workspace.remove": "Kaldır",
  "drift.workspace.removeHint": "Konular 7 gün saklanır; geri yüklemek için aynı klasörü yeniden ekleyin.",
  "drift.workspace.useInitials": "Baş harfleri kullan",
}
