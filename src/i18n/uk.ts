...
export const drift = {
  ...
  "drift.about.row.website.description": "Завантаження, примітки до випусків і медуза, що натхнула цю.",
  "drift.about.credits.engine": "Drift працює на OpenCode. Найважчу частину тут виконує рушій, і цей застосунок існує лише тому, що та робота достатньо добра, щоб на ній будувати. Щира повага розробникам OpenCode і всім, хто до нього долучається.",
  "drift.about.credits.ui": "Drift не є критикою рушія, це лише різниця у смаку: мені просто не подобається новий інтерфейс, тому Drift зберігає тихішу й щільнішу оболонку навколо того самого рушія.",
  ...
  "drift.composer.fileTooLarge": "Розмір {{filename}} перевищує 10 MB",
