...
export const drift = {
  ...
  "drift.preview.mode.all": "Усі",
  "drift.preview.mode.none": "Жодні",
  "drift.preview.mode.custom": "Вибірково",
  "drift.preview.type.markdown": "Файли Markdown",
  "drift.preview.type.pdf": "Документи PDF",
  "drift.preview.type.image": "Зображення",
  "drift.preview.type.text": "Текст і код",
  "drift.preview.type.table": "Таблиці (CSV/TSV)",
  "drift.preview.type.audio": "Аудіо",
  "drift.preview.type.video": "Відео",
  "drift.preview.title": "Попередній перегляд файлу",
  "drift.preview.htmlRendered": "Перегляд",
  "drift.preview.htmlSource": "Код HTML",
  "drift.preview.htmlStatic": "Статичний перегляд. Скрипти, посилання та зовнішні ресурси вимкнено.",
  "drift.preview.loading": "Завантаження попереднього перегляду...",
  "drift.preview.error": "Не вдалося завантажити попередній перегляд.",
  "drift.preview.openEditor": "Відкрити в редакторі",
  "drift.preview.retry": "Повторити",
  "drift.preview.previous": "Попередня сторінка",
  "drift.preview.next": "Наступна сторінка",
  "drift.preview.page": "Сторінка {{page}} з {{pages}}",
  "drift.preview.zoomIn": "Збільшити",
  "drift.preview.zoomOut": "Зменшити",
  "drift.preview.unsupported": "Попередній перегляд цього типу файлів не підтримується.",
  "drift.preview.tooLarge": "Цей файл завеликий для попереднього перегляду.",
  "drift.preview.unavailable": "Попередній перегляд файлу недоступний.",
  ...
  "drift.settings.shellTimeout.preset15": "15 хвилин",
  "drift.settings.shellTimeout.preset30": "30 хвилин",
  "drift.settings.shellTimeout.custom": "Власний",
  "drift.settings.shellTimeout.customMinutes": "Власна кількість хвилин",
  "drift.settings.shellTimeout.customDescription": "Введіть ціле число від 1 до 1440 хвилин.",
  "drift.settings.shellTimeout.invalid": "Введіть ціле число від 1 до 1440.",
  "drift.shell.timeout.limit": "Ліміт {{duration}}",
  "drift.shell.timeout.expired": "Час вичерпано через {{duration}}",
  "drift.agent.build": "Збірка",
  "drift.agent.plan": "Планування",
  "drift.agent.general": "Загальний",
  ...
  "drift.settings.summaries.collapsible.description": "Ховати підсумки стиснення рушія за розгортаним роздільником.",
  "drift.settings.summaries.collapsed.title": "Згортати підсумки за замовчуванням",
  "drift.settings.summaries.collapsed.description": "Спочатку показувати підсумки стиснення згорнутими.",
  "drift.settings.customPalette": "Власна палітра",
  "drift.settings.typography": "Типографіка",
  "drift.settings.customCss": "Власний CSS",
  "drift.settings.customCss.description": "Застосовується локально після вбудованих стилів Drift. Обмеження: 20 КБ.",
  "drift.sidebar.workspaces": "Робочі простори",
  "drift.sidebar.archived": "Архівовані елементи",
  "drift.sidebar.addWorkspace": "Додати робочий простір",
  "drift.sidebar.empty": "Додайте робочий простір, щоб почати.",
  "drift.sidebar.resize": "Змінити розмір бічної панелі",
  "drift.workspace.showThreads": "Показати гілки",
  ...
  "drift.composer.connecting": "Підключення до рушія...",
  "drift.composer.thinkingLevel": "Рівень міркування",
  "drift.permissions.autoGlobal": "Дозволи автоматично приймаються всюди",
  "drift.permissions.autoThread": "Дозволи автоматично приймаються для цієї гілки",
  "drift.prompt.steer": "Спрямувати",
  "drift.titlebar.minimize": "Згорнути",
  ...
  "drift.about.starting": "(запуск...)",
  "drift.about.group.build": "Збірка",
  "drift.about.group.links": "Посилання",
  ...
  "drift.about.updates.available": "Доступні",
  "drift.about.updates.unavailable": "Локальна збірка",
  "drift.about.row.website.title": "Сайт",
  "drift.about.row.website.description": "Завантаження та примітки до випусків.",
  "drift.about.credits.engine": "Drift працює на OpenCode. Найважчу частину тут виконує рушій, і цей застосунок існує лише завдяки цій чудовій роботі. Щира повага розробникам OpenCode і всім, хто до нього долучається.",
  "drift.archive.deletesInDays": "Видалення через {{days}}d",
  ...
  "drift.attachment.image": "зображення",
  "drift.attachment.viewImage": "Переглянути зображення",
  ...
  "drift.attachment.pages": "{{count}} сторінок",
  "drift.attachment.processing": "Читання...",
  "drift.attachment.table": "{{rows}} рядків x {{columns}} стовпців",
  "drift.chat.empty.noWorkspace": "Додайте або виберіть робочий простір ліворуч, щоб почати.",
  "drift.chat.empty.promptHint": "Почніть вводити нижче. Enter надсилає, Shift+Enter переносить рядок.",
  "drift.chat.empty.threadHint": "Гілки розташовані ліворуч. Жодних вкладок. Ніколи.",
  "drift.chat.retry.inSeconds": "Повторна спроба через {{seconds}}s",
  "drift.chat.retry.info": "{{retry}} - спроба #{{attempt}}",
  "drift.chat.retry.now": "Повторна спроба",
  "drift.chat.retry.providerRejected": "Провайдер не прийняв запит",
  "drift.chat.thinking": "Міркування",
  "drift.color.accent": "Акцент",
  "drift.color.background": "Тло",
  "drift.color.surface": "Поверхня",
  "drift.color.text": "Текст",
  "drift.composer.anotherThread": "інша гілка",
  "drift.composer.dropFiles": "Перетягніть файли, щоб прикріпити їх",
  "drift.composer.fileReadFailed": "Не вдалося прочитати {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} не є коректним текстом UTF-8",
  "drift.composer.fileTooLarge": "{{filename}} перевищує ліміт {{limit}} для файлів {{kind}}",
  "drift.composer.fileUnsupported": "{{filename}} — непідтримуваний архів або двійковий файл",
  "drift.composer.folderUnsupported": "Папки не можна прикріпити; перетягніть окремі файли",
  "drift.composer.modelUnsupported": "{{model}} не приймає вкладення {{kind}} ({{filename}})",
  ...
  "drift.count.entry.other": "{{count}} записів",
  "drift.count.file.one": "{{count}} файл",
  "drift.count.file.other": "{{count}} файлів",
  "drift.count.line.one": "{{count}} рядок",
  "drift.count.line.other": "{{count}} рядків",
  "drift.count.match.one": "{{count}} збіг",
  "drift.count.match.other": "{{count}} збігів",
  "drift.count.result.one": "{{count}} результат",
  "drift.count.result.other": "{{count}} результатів",
  "drift.count.tool.one": "{{count}} інструмент",
  "drift.count.tool.other": "{{count}} інструментів",
  "drift.debug.context": "Контекст",
  "drift.file.created": "Створено",
  "drift.file.deleted": "Видалено",
  "drift.file.moved": "Переміщено",
  ...
  "drift.mcp.authenticate": "Автентифікація",
  ...
  "drift.message.copy": "Копіювати повідомлення",
  "drift.message.copyResponse": "Копіювати відповідь",
  ...
  "drift.provider.finishInBrowser": "Завершіть вхід у браузері.",
  "drift.provider.savedUnavailable": "Облікові дані збережено, але {{provider}} не став доступним.",
  "drift.provider.signInStartFailed": "Не вдалося розпочати вхід.",
  "drift.provider.signInStartFailedFor": "Не вдалося розпочати вхід через {{provider}}.",
  "drift.provider.signInWith": "Увійти через {{method}}",
  ...
  "drift.question.answerLater": "Відповісти пізніше",
  ...
  "drift.question.number": "Запитання {{number}}",
  "drift.question.selectMultiple": "Виберіть усі відповідні варіанти",
  "drift.question.selectOne": "Виберіть одну відповідь",
  "drift.reasoning.thinking": "Міркування",
  "drift.reasoning.thought": "Думка",
  "drift.reasoning.level.none": "Немає",
  "drift.reasoning.level.minimal": "Мінімальний",
  "drift.reasoning.level.low": "Низький",
  "drift.reasoning.level.medium": "Середній",
  "drift.reasoning.level.high": "Високий",
  "drift.reasoning.level.xhigh": "Дуже високий",
  "drift.reasoning.level.max": "Максимальний",
  "drift.settings.customPalette.colorDescription": "Задайте колір {{color}}.",
  "drift.settings.customPalette.hexValue": "Шістнадцяткове значення кольору {{color}}",
  "drift.settings.providers.notConnected": "Не підключено",
  ...
  "drift.shortcuts.zoomOut": "Зменшити масштаб",
  "drift.shortcuts.zoomReset": "Скинути масштаб",
  "drift.sidebar.moveSessionFailed": "Не вдалося перемістити сесію",
  "drift.sidebar.moveWorkspaceFailed": "Не вдалося перемістити робочий простір",
  "drift.sidebar.movingSession": "Переміщення сесії до {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "Переміщення сесій {{workspace}}...",
  "drift.sidebar.offline": "не в мережі",
  "drift.sidebar.pathAlreadySaved": "{{path}} уже збережено як {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "Не вдалося зберегти новий шлях робочого простору: {{error}}",
  "drift.sidebar.workspaceMovePartial": "Робочий простір переміщено лише частково: {{error}}",
  "drift.slash.mcp": "Керувати серверами MCP",
  "drift.slash.workspaceCommand": "команда робочого простору",
  "drift.sound.group.alerts": "Сповіщення",
  "drift.sound.group.failure": "Помилка",
  "drift.sound.group.information": "Інформація",
  "drift.sound.group.mechanical": "Механічні",
  "drift.sound.group.success": "Успіх",
  "drift.status.waitingForPermission": "Очікування дозволу",
  "drift.theme.aubergine": "Drift Баклажан",
  "drift.theme.custom": "Власна",
  "drift.theme.dark": "Drift Темна",
  "drift.theme.forest": "Drift Ліс",
  "drift.theme.graphite": "Drift Графіт",
  "drift.theme.light": "Drift Світла",
  "drift.theme.midnight": "Drift Опівніч",
  "drift.theme.paper": "Drift Папір",
  "drift.theme.slate": "Drift Сланець",
  "drift.thread.backToParent": "Назад до гілки, з якої створено цю",
  "drift.thread.copyShareLink": "Копіювати посилання для поширення: {{url}}",
  "drift.thread.move": "Перемістити",
  "drift.thread.moveToWorkspace": "Перемістити до робочого простору",
  "drift.thread.noOtherWorkspaces": "Інших робочих просторів немає",
  "drift.thread.openSpawned": "Відкрити створену гілку",
  "drift.thread.renameHint": "Двічі клацніть, щоб перейменувати",
  "drift.thread.shared": "Опубліковано",
  "drift.thread.waitingForAnswer": "Очікування відповіді",
  "drift.thread.waitingForPermission": "Очікування дозволу",
  "drift.thread.working": "Працює",
  "drift.tool.called": "Викликано",
  "drift.tool.fetch": "Отримати",
  "drift.tool.asyncQuestion": "Асинхронне запитання",
  "drift.tool.spawn": "Створити",
  ...
  "drift.workspace.changeImage": "Змінити зображення...",
  "drift.workspace.confirmRemove": "Натисніть ще раз для підтвердження",
  "drift.workspace.move": "Перемістити...",
  "drift.workspace.remove": "Видалити",
  "drift.workspace.removeHint": "Гілки зберігаються 7 днів; додайте ту саму папку знову, щоб відновити їх.",
  "drift.workspace.useInitials": "Використовувати ініціали",
}
