...
export const drift = {
  ...
  "drift.preview.mode.all": "全部",
  "drift.preview.mode.none": "无",
  "drift.preview.mode.custom": "自定义",
  "drift.preview.type.markdown": "Markdown 文件",
  "drift.preview.type.pdf": "PDF 文档",
  "drift.preview.type.image": "图片",
  "drift.preview.type.text": "文本和代码",
  "drift.preview.type.table": "表格（CSV/TSV）",
  "drift.preview.type.audio": "音频",
  "drift.preview.type.video": "视频",
  "drift.preview.title": "文件预览",
  "drift.preview.htmlRendered": "预览",
  "drift.preview.htmlSource": "HTML 源码",
  "drift.preview.htmlStatic": "静态预览。脚本、链接和外部资源已禁用。",
  "drift.preview.loading": "正在加载预览...",
  "drift.preview.error": "无法加载预览。",
  "drift.preview.openEditor": "在编辑器中打开",
  "drift.preview.retry": "重试",
  "drift.preview.previous": "上一页",
  "drift.preview.next": "下一页",
  "drift.preview.page": "第 {{page}} 页，共 {{pages}} 页",
  "drift.preview.zoomIn": "放大",
  "drift.preview.zoomOut": "缩小",
  "drift.preview.unsupported": "无法预览此文件类型。",
  "drift.preview.tooLarge": "此文件过大，无法预览。",
  "drift.preview.unavailable": "文件预览不可用。",
  ...
  "drift.settings.shellTimeout.preset1": "1 分钟",
  "drift.settings.shellTimeout.preset5": "5 分钟",
  "drift.settings.shellTimeout.preset15": "15 分钟",
  "drift.settings.shellTimeout.preset30": "30 分钟",
  "drift.settings.shellTimeout.custom": "自定义",
  "drift.settings.shellTimeout.customMinutes": "自定义分钟数",
  "drift.settings.shellTimeout.customDescription": "请输入 1 到 1,440 之间的整数分钟数。",
  "drift.settings.shellTimeout.invalid": "请输入 1 到 1,440 之间的整数。",
  "drift.shell.timeout.limit": "限制 {{duration}}",
  "drift.shell.timeout.expired": "{{duration}} 后超时",
  "drift.agent.build": "构建",
  "drift.agent.plan": "规划",
  ...
  "drift.settings.responseAnimation.speed.title": "显示速度",
  "drift.settings.responseAnimation.speed.description": "选择助手实时文本在屏幕上显示的速度。",
  "drift.settings.responseAnimation.speed.value": "每秒 {{speed}} 个字符",
  ...
  "drift.settings.summaries.collapsible.description": "将引擎压缩摘要收起到可展开的分隔线后。",
  "drift.settings.summaries.collapsed.title": "默认折叠摘要",
  "drift.settings.summaries.collapsed.description": "初始折叠压缩摘要。",
  "drift.settings.customPalette": "自定义调色板",
  "drift.settings.typography": "字体排版",
  "drift.settings.customCss": "自定义 CSS",
  "drift.settings.customCss.description": "在 Drift 内置样式后于本地应用。上限为 20 KB。",
  "drift.sidebar.workspaces": "工作区",
  "drift.sidebar.archived": "已归档项目",
  "drift.sidebar.addWorkspace": "添加工作区",
  "drift.sidebar.empty": "添加工作区以开始使用。",
  "drift.sidebar.resize": "调整侧边栏大小",
  "drift.workspace.showThreads": "显示会话",
  ...
  "drift.composer.connecting": "正在连接引擎...",
  "drift.composer.thinkingLevel": "思考级别",
  "drift.permissions.autoGlobal": "正在全局自动接受权限请求",
  "drift.permissions.autoThread": "正在为此会话自动接受权限请求",
  "drift.prompt.steer": "引导",
  "drift.titlebar.minimize": "最小化",
  "drift.titlebar.restore": "还原",
  "drift.titlebar.maximize": "最大化",
  "drift.about.description": "Drift，一款内嵌 OpenCode 的桌面智能体。",
  "drift.settings.sound.chooseCustom": "选择自定义声音",
  "drift.about.engine": "OpenCode {{version}}",
  "drift.about.failed": "（失败）",
  "drift.about.starting": "（正在启动...）",
  "drift.about.group.build": "构建",
  "drift.about.group.links": "链接",
  ...
  "drift.about.updates.available": "可用",
  "drift.about.updates.unavailable": "本地构建",
  "drift.about.row.website.title": "网站",
  "drift.about.row.website.description": "下载与发布说明。",
  "drift.about.credits.engine": "Drift 运行在 OpenCode 之上。最难的部分由引擎完成，这个应用的存在完全得益于那份出色的工作。向 OpenCode 的开发者以及所有贡献者致以真诚的敬意。",
  "drift.archive.deletesInDays": "{{days}}d 后删除",
  ...
  "drift.attachment.image": "图像",
  "drift.attachment.viewImage": "查看图像",
  "drift.attachment.kind.audio": "音频",
  "drift.attachment.kind.csv": "表格",
  "drift.attachment.kind.image": "图像",
  "drift.attachment.kind.text": "文本",
  "drift.attachment.kind.video": "视频",
  "drift.attachment.lines": "{{count}} 行",
  "drift.attachment.pages": "{{count}} 页",
  "drift.attachment.processing": "正在读取...",
  "drift.attachment.table": "{{rows}} 行 x {{columns}} 列",
  "drift.chat.empty.noWorkspace": "在左侧添加或选择工作区以开始。",
  "drift.chat.empty.promptHint": "在下方开始输入。Enter 发送，Shift+Enter 换行。",
  "drift.chat.empty.threadHint": "会话位于左侧。没有标签页，绝不使用。",
  "drift.chat.retry.inSeconds": "{{seconds}}s 后重试",
  "drift.chat.retry.info": "{{retry}} - 尝试 #{{attempt}}",
  "drift.chat.retry.now": "正在重试",
  "drift.chat.retry.providerRejected": "提供商未接受请求",
  "drift.chat.thinking": "思考中",
  "drift.color.accent": "强调色",
  "drift.color.background": "背景",
  "drift.color.surface": "表面",
  "drift.color.text": "文本",
  "drift.composer.anotherThread": "另一个会话",
  "drift.composer.dropFiles": "拖放文件以添加附件",
  "drift.composer.fileReadFailed": "无法读取 {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} 不是有效的 UTF-8 文本",
  "drift.composer.fileTooLarge": "{{filename}} 超过 {{kind}} 文件的 {{limit}} 限制",
  "drift.composer.fileUnsupported": "{{filename}} 是不支持的压缩包或二进制文件",
  "drift.composer.folderUnsupported": "无法添加文件夹作为附件，请改为拖放单个文件",
  "drift.composer.modelUnsupported": "{{model}} 不接受 {{kind}} 附件（{{filename}}）",
  "drift.composer.openThread": "打开该会话",
  "drift.composer.pendingInThread": "位于 {{thread}}",
  "drift.context.compacted": "上下文已压缩",
  "drift.context.compacting": "正在压缩上下文",
  "drift.context.pending": "首次回复后显示用量。",
  "drift.context.untilCompaction": "距离压缩",
  "drift.count.entry.one": "{{count}} 个条目",
  "drift.count.entry.other": "{{count}} 个条目",
  "drift.count.file.one": "{{count}} 个文件",
  "drift.count.file.other": "{{count}} 个文件",
  "drift.count.line.one": "{{count}} 行",
  "drift.count.line.other": "{{count}} 行",
  "drift.count.match.one": "{{count}} 个匹配项",
  "drift.count.match.other": "{{count}} 个匹配项",
  "drift.count.result.one": "{{count}} 个结果",
  "drift.count.result.other": "{{count}} 个结果",
  "drift.count.tool.one": "{{count}} 个工具",
  "drift.count.tool.other": "{{count}} 个工具",
  "drift.debug.context": "上下文",
  "drift.file.created": "已创建",
  "drift.file.deleted": "已删除",
  "drift.file.moved": "已移动",
  ...
  "drift.mcp.authenticate": "身份验证",
  "drift.mcp.description": "全局 Drift 服务器，以及当前工作区报告的精确生效定义。",
  ...
  "drift.message.copy": "复制消息",
  "drift.message.copyResponse": "复制回复",
  ...
  "drift.notification.threadFinished": "一个会话已完成工作",
  "drift.provider.browser": "浏览器",
  ...
  "drift.provider.finishInBrowser": "请在浏览器中完成登录。",
  "drift.provider.savedUnavailable": "凭据已保存，但 {{provider}} 未变为可用。",
  "drift.provider.signInStartFailed": "无法启动登录流程。",
  "drift.provider.signInStartFailedFor": "无法启动 {{provider}} 登录流程。",
  "drift.provider.signInWith": "使用 {{method}} 登录",
  "drift.question.custom": "输入自定义答案",
  "drift.question.answered": "已回答",
  "drift.question.unanswered": "无回答",
  "drift.question.answerLater": "稍后回答",
  "drift.question.answerNow": "立即回答",
  "drift.question.asyncHint": "在你做决定时，不依赖此回答的工作可以继续进行。",
  "drift.question.blocking": "等待回答",
  "drift.question.pending": "待处理请求：{{count}}",
  "drift.question.sendFailed": "无法发送你的回复。你填写的答案仍保留在此处。请尝试重新提交。",
  "drift.question.sending": "正在发送...",
  "drift.question.customHint": "添加上方未列出的答案",
  "drift.question.customPlaceholder": "输入自定义答案...",
  "drift.question.number": "问题 {{number}}",
  "drift.question.selectMultiple": "选择所有适用答案",
  "drift.question.selectOne": "选择一个答案",
  "drift.reasoning.thinking": "思考中",
  "drift.reasoning.thought": "思考",
  "drift.reasoning.level.none": "无",
  "drift.reasoning.level.minimal": "最低",
  "drift.reasoning.level.low": "低",
  "drift.reasoning.level.medium": "中",
  "drift.reasoning.level.high": "高",
  "drift.reasoning.level.xhigh": "极高",
  "drift.reasoning.level.max": "最高",
  "drift.settings.customPalette.colorDescription": "设置{{color}}颜色。",
  "drift.settings.customPalette.hexValue": "{{color}}颜色的十六进制值",
  "drift.settings.providers.notConnected": "未连接",
  ...
  "drift.shortcuts.zoomOut": "缩小",
  "drift.shortcuts.zoomReset": "重置缩放",
  "drift.sidebar.moveSessionFailed": "无法移动会话",
  "drift.sidebar.moveWorkspaceFailed": "无法移动工作区",
  "drift.sidebar.movingSession": "正在将会话移至 {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "正在移动 {{workspace}} 的会话...",
  "drift.sidebar.offline": "离线",
  "drift.sidebar.pathAlreadySaved": "{{path}} 已保存为 {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "无法保存新的工作区路径：{{error}}",
  "drift.sidebar.workspaceMovePartial": "工作区仅部分移动：{{error}}",
  "drift.slash.mcp": "管理 MCP 服务器",
  "drift.slash.workspaceCommand": "工作区命令",
  "drift.sound.group.alerts": "警报",
  "drift.sound.group.failure": "失败",
  "drift.sound.group.information": "信息",
  "drift.sound.group.mechanical": "机械",
  "drift.sound.group.success": "成功",
  "drift.status.waitingForPermission": "等待权限",
  "drift.theme.aubergine": "Drift 茄紫",
  "drift.theme.custom": "自定义",
  "drift.theme.dark": "Drift 深色",
  "drift.theme.forest": "Drift 森林",
  "drift.theme.graphite": "Drift 石墨",
  "drift.theme.light": "Drift 浅色",
  "drift.theme.midnight": "Drift 午夜",
  "drift.theme.paper": "Drift 纸张",
  "drift.theme.slate": "Drift 岩灰",
  "drift.thread.backToParent": "返回生成此会话的上级会话",
  "drift.thread.copyShareLink": "复制分享链接：{{url}}",
  "drift.thread.move": "移动",
  "drift.thread.moveToWorkspace": "移至工作区",
  "drift.thread.noOtherWorkspaces": "没有其他工作区",
  "drift.thread.openSpawned": "打开生成的会话",
  "drift.thread.renameHint": "双击重命名",
  "drift.thread.shared": "已分享",
  "drift.thread.waitingForAnswer": "等待回答",
  "drift.thread.waitingForPermission": "等待权限",
  "drift.thread.working": "工作中",
  "drift.tool.called": "已调用",
  "drift.tool.fetch": "获取",
  "drift.tool.asyncQuestion": "异步提问",
  "drift.tool.spawn": "生成",
  "drift.tool.subtask": "子任务",
  "drift.tool.task": "任务",
  "drift.voice.input.description": "选择用于新听写录音的麦克风。",
  "drift.voice.input.missing": "已保存的麦克风不可用。重新连接前将使用系统默认设备。",
  "drift.voice.input.systemDefault": "系统默认",
  "drift.voice.input.title": "输入设备",
  "drift.voice.input.unnamed": "麦克风 {{index}}",
  "drift.workspace.changeImage": "更改图像...",
  "drift.workspace.confirmRemove": "再次点击以确认",
  "drift.workspace.move": "移动...",
  "drift.workspace.remove": "移除",
  "drift.workspace.removeHint": "会话保留 7 天；重新添加同一文件夹即可恢复。",
  "drift.workspace.useInitials": "使用首字母",
}
