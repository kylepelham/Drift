...
export const drift = {
  ...
  "drift.about.row.website.description": "下载、发布说明，以及这只水母的原型。",
  "drift.about.credits.engine": "Drift 运行在 OpenCode 之上。最难的部分由引擎完成，这个应用之所以存在，正是因为那份工作足够好，值得在其上构建。向 OpenCode 的开发者以及所有贡献者致以真诚的敬意。",
  "drift.about.credits.ui": "Drift 并不是对引擎的批评，只是口味不同：我实在不喜欢新的界面，所以 Drift 在同一个引擎外面保留了一层更安静、更紧凑的外壳。",
  ...
  "drift.composer.fileTooLarge": "{{filename}} 超过 10 MB",
