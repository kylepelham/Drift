...
export const drift = {
  ...
  "drift.about.row.website.description": "下載、發行說明，以及這隻水母的原型。",
  "drift.about.credits.engine": "Drift 執行於 OpenCode 之上。最困難的部分由引擎完成，這個應用程式之所以存在，正是因為那份成果好到值得在其上建構。向 OpenCode 的開發者與所有貢獻者致上真誠的敬意。",
  "drift.about.credits.ui": "Drift 並不是對引擎的批評，只是喜好不同：我實在不喜歡新的介面，所以 Drift 在同一個引擎外保留了一層更安靜、更緊湊的外殼。",
  ...
  "drift.composer.fileTooLarge": "{{filename}} 超過 10 MB",
