...
export const drift = {
  ...
  "drift.preview.mode.none": "無",
  "drift.preview.mode.custom": "自訂",
  "drift.preview.type.markdown": "Markdown 檔案",
  "drift.preview.type.pdf": "PDF 文件",
  "drift.preview.type.image": "圖片",
  "drift.preview.type.text": "文字與程式碼",
  "drift.preview.type.table": "表格（CSV/TSV）",
  "drift.preview.type.audio": "音訊",
  "drift.preview.type.video": "影片",
  "drift.preview.title": "檔案預覽",
  "drift.preview.htmlRendered": "預覽",
  "drift.preview.htmlSource": "HTML 原始碼",
  "drift.preview.htmlStatic": "靜態預覽。指令碼、連結和外部資源已停用。",
  "drift.preview.loading": "正在載入預覽...",
  "drift.preview.error": "無法載入預覽。",
  "drift.preview.openEditor": "在編輯器中開啟",
  "drift.preview.retry": "重試",
  "drift.preview.previous": "上一頁",
  "drift.preview.next": "下一頁",
  "drift.preview.page": "第 {{page}} 頁，共 {{pages}} 頁",
  "drift.preview.zoomIn": "放大",
  "drift.preview.zoomOut": "縮小",
  "drift.preview.unsupported": "無法預覽此檔案類型。",
  "drift.preview.tooLarge": "此檔案過大，無法預覽。",
  "drift.preview.unavailable": "檔案預覽無法使用。",
  ...
  "drift.settings.shellTimeout.preset1": "1 分鐘",
  "drift.settings.shellTimeout.preset5": "5 分鐘",
  "drift.settings.shellTimeout.preset15": "15 分鐘",
  "drift.settings.shellTimeout.preset30": "30 分鐘",
  "drift.settings.shellTimeout.custom": "自訂",
  "drift.settings.shellTimeout.customMinutes": "自訂分鐘數",
  "drift.settings.shellTimeout.customDescription": "請輸入 1 到 1,440 之間的整數分鐘數。",
  "drift.settings.shellTimeout.invalid": "請輸入 1 到 1,440 之間的整數。",
  "drift.shell.timeout.limit": "限制 {{duration}}",
  "drift.shell.timeout.expired": "{{duration}} 後逾時",
  ...
  "drift.settings.responseAnimation.speed.title": "顯示速度",
  "drift.settings.responseAnimation.speed.description": "選擇助理即時文字在畫面上顯示的速度。",
  "drift.settings.responseAnimation.speed.value": "每秒 {{speed}} 個字元",
  ...
  "drift.settings.summaries.collapsible.description": "將引擎壓縮摘要收合至可展開的分隔線後。",
  "drift.settings.summaries.collapsed.title": "預設摺疊摘要",
  "drift.settings.summaries.collapsed.description": "初始時收合壓縮摘要。",
  "drift.settings.customPalette": "自訂調色盤",
  "drift.settings.typography": "字體排版",
  "drift.settings.customCss": "自訂 CSS",
  "drift.settings.customCss.description": "在 Drift 內建樣式後於本機套用。上限為 20 KB。",
  "drift.sidebar.workspaces": "工作區",
  "drift.sidebar.archived": "封存項目",
  "drift.sidebar.addWorkspace": "新增工作區",
  "drift.sidebar.empty": "新增工作區以開始使用。",
  "drift.sidebar.resize": "調整側邊欄大小",
  "drift.workspace.showThreads": "顯示對話",
  ...
  "drift.composer.connecting": "正在連線至引擎...",
  "drift.composer.thinkingLevel": "思考層級",
  "drift.permissions.autoGlobal": "正在全域自動接受權限要求",
  "drift.permissions.autoThread": "正在為此對話自動接受權限要求",
  "drift.prompt.steer": "引導",
  ...
  "drift.about.starting": "（正在啟動...）",
  "drift.about.group.build": "建置",
  "drift.about.group.links": "連結",
  ...
  "drift.about.updates.unavailable": "本機建置",
  "drift.about.row.website.title": "網站",
  "drift.about.row.website.description": "下載與發行說明。",
  "drift.about.credits.engine": "Drift 執行於 OpenCode 之上。最困難的部分由引擎完成，這個應用程式的存在完全歸功於那份出色的成果。向 OpenCode 的開發者與所有貢獻者致上真誠的敬意。",
  "drift.archive.deletesInDays": "{{days}}d 後刪除",
  ...
  "drift.attachment.image": "圖片",
  "drift.attachment.viewImage": "檢視圖片",
  ...
  "drift.attachment.pages": "{{count}} 頁",
  "drift.attachment.processing": "正在讀取...",
  "drift.attachment.table": "{{rows}} 行 x {{columns}} 欄",
  "drift.chat.empty.noWorkspace": "在左側新增或選擇工作區以開始。",
  "drift.chat.empty.promptHint": "在下方開始輸入。Enter 傳送，Shift+Enter 換行。",
  "drift.chat.empty.threadHint": "對話位於左側。沒有分頁，永遠不會有。",
  "drift.chat.retry.inSeconds": "{{seconds}}s 後重試",
  "drift.chat.retry.info": "{{retry}} - 嘗試 #{{attempt}}",
  "drift.chat.retry.now": "正在重試",
  "drift.chat.retry.providerRejected": "提供者未接受要求",
  "drift.chat.thinking": "思考中",
  "drift.color.accent": "強調色",
  "drift.color.background": "背景",
  "drift.color.surface": "表面",
  "drift.color.text": "文字",
  "drift.composer.anotherThread": "另一個對話",
  "drift.composer.dropFiles": "拖放檔案以加入附件",
  "drift.composer.fileReadFailed": "無法讀取 {{filename}}",
  "drift.composer.fileInvalidUtf8": "{{filename}} 不是有效的 UTF-8 文字",
  "drift.composer.fileTooLarge": "{{filename}} 超過 {{kind}} 檔案的 {{limit}} 限制",
  "drift.composer.fileUnsupported": "{{filename}} 是不支援的壓縮檔或二進位檔案",
  "drift.composer.folderUnsupported": "無法加入資料夾作為附件，請改為拖放個別檔案",
  ...
  "drift.count.entry.other": "{{count}} 個項目",
  "drift.count.file.one": "{{count}} 個檔案",
  "drift.count.file.other": "{{count}} 個檔案",
  "drift.count.line.one": "{{count}} 行",
  "drift.count.line.other": "{{count}} 行",
  "drift.count.match.one": "{{count}} 個符合項目",
  "drift.count.match.other": "{{count}} 個符合項目",
  "drift.count.result.one": "{{count}} 個結果",
  "drift.count.result.other": "{{count}} 個結果",
  "drift.count.tool.one": "{{count}} 個工具",
  "drift.count.tool.other": "{{count}} 個工具",
  "drift.debug.context": "上下文",
  "drift.file.created": "已建立",
  "drift.file.deleted": "已刪除",
  "drift.file.moved": "已移動",
  ...
  "drift.message.copy": "複製訊息",
  "drift.message.copyResponse": "複製回覆",
  ...
  "drift.provider.finishInBrowser": "請在瀏覽器中完成登入。",
  "drift.provider.savedUnavailable": "憑證已儲存，但 {{provider}} 未變為可用。",
  "drift.provider.signInStartFailed": "無法啟動登入流程。",
  "drift.provider.signInStartFailedFor": "無法啟動 {{provider}} 登入流程。",
  "drift.provider.signInWith": "使用 {{method}} 登入",
  "drift.question.custom": "輸入自訂答案",
  "drift.question.answered": "已回答",
  "drift.question.unanswered": "無回答",
  "drift.question.answerLater": "稍後回答",
  "drift.question.answerNow": "立即回答",
  "drift.question.asyncHint": "在你做決定時，不依賴此回答的工作可以繼續進行。",
  "drift.question.blocking": "等待回答",
  "drift.question.pending": "待處理請求：{{count}}",
  "drift.question.sendFailed": "無法傳送你的回覆。你填寫的答案仍保留在此處。請嘗試重新提交。",
  "drift.question.sending": "正在傳送...",
  "drift.question.customHint": "新增上方未列出的答案",
  "drift.question.customPlaceholder": "輸入自訂答案...",
  "drift.question.number": "問題 {{number}}",
  "drift.question.selectMultiple": "選擇所有適用的答案",
  "drift.question.selectOne": "選擇一個答案",
  "drift.reasoning.thinking": "思考中",
  "drift.reasoning.thought": "思考",
  "drift.reasoning.level.none": "無",
  "drift.reasoning.level.minimal": "最低",
  "drift.reasoning.level.low": "低",
  "drift.reasoning.level.medium": "中",
  "drift.reasoning.level.high": "高",
  "drift.reasoning.level.xhigh": "極高",
  "drift.reasoning.level.max": "最高",
  "drift.settings.customPalette.colorDescription": "設定{{color}}顏色。",
  "drift.settings.customPalette.hexValue": "{{color}}顏色的十六進位值",
  "drift.settings.providers.notConnected": "未連線",
  ...
  "drift.shortcuts.zoomOut": "縮小",
  "drift.shortcuts.zoomReset": "重設縮放",
  "drift.sidebar.moveSessionFailed": "無法移動工作階段",
  "drift.sidebar.moveWorkspaceFailed": "無法移動工作區",
  "drift.sidebar.movingSession": "正在將工作階段移至 {{workspace}}...",
  "drift.sidebar.movingWorkspaceSessions": "正在移動 {{workspace}} 的工作階段...",
  "drift.sidebar.offline": "離線",
  "drift.sidebar.pathAlreadySaved": "{{path}} 已儲存為 {{workspace}}",
  "drift.sidebar.saveWorkspacePathFailed": "無法儲存新的工作區路徑：{{error}}",
  "drift.sidebar.workspaceMovePartial": "工作區只完成部分移動：{{error}}",
  "drift.slash.mcp": "管理 MCP 伺服器",
  "drift.slash.workspaceCommand": "工作區命令",
  "drift.sound.group.alerts": "警報",
  "drift.sound.group.failure": "失敗",
  "drift.sound.group.information": "資訊",
  "drift.sound.group.mechanical": "機械",
  "drift.sound.group.success": "成功",
  "drift.status.waitingForPermission": "等待權限",
  "drift.theme.aubergine": "Drift 茄紫",
  "drift.theme.custom": "自訂",
  "drift.theme.dark": "Drift 深色",
  "drift.theme.forest": "Drift 森林",
  "drift.theme.graphite": "Drift 石墨",
  "drift.theme.light": "Drift 淺色",
  "drift.theme.midnight": "Drift 午夜",
  "drift.theme.paper": "Drift 紙張",
  "drift.theme.slate": "Drift 岩灰",
  "drift.thread.backToParent": "返回產生此對話的上層對話",
  "drift.thread.copyShareLink": "複製分享連結：{{url}}",
  "drift.thread.move": "移動",
  "drift.thread.moveToWorkspace": "移至工作區",
  "drift.thread.noOtherWorkspaces": "沒有其他工作區",
  "drift.thread.openSpawned": "開啟產生的對話",
  "drift.thread.renameHint": "按兩下以重新命名",
  "drift.thread.shared": "已分享",
  "drift.thread.waitingForAnswer": "等待回答",
  "drift.thread.waitingForPermission": "等待權限",
  "drift.thread.working": "工作中",
  "drift.tool.called": "已呼叫",
  "drift.tool.fetch": "擷取",
  "drift.tool.asyncQuestion": "非同步提問",
  "drift.tool.spawn": "產生",
  "drift.tool.subtask": "子任務",
  "drift.tool.task": "任務",
  "drift.voice.input.description": "選擇用於新聽寫錄音的麥克風。",
  "drift.voice.input.missing": "已儲存的麥克風無法使用。重新連接前將使用系統預設裝置。",
  "drift.voice.input.systemDefault": "系統預設",
  "drift.voice.input.title": "輸入裝置",
  "drift.voice.input.unnamed": "麥克風 {{index}}",
  "drift.workspace.changeImage": "變更圖片...",
  "drift.workspace.confirmRemove": "再次點擊以確認",
  "drift.workspace.move": "移動...",
  "drift.workspace.remove": "移除",
  "drift.workspace.removeHint": "對話會保留 7 天；重新新增相同資料夾即可還原。",
  "drift.workspace.useInitials": "使用縮寫",
}
